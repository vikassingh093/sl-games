...
var FingerprintJS = function(e) {
    ...
    function C() {
        var e = window,
            t = navigator;
        return b(["msWriteProfilerMark" in e, "MSStream" in e, "msLaunchUri" in t, "msSaveBlob" in t]) >= 3 && !k()
    }
                ...
                switch (r.label) {
                    ...
                    case 4:
                        return r.trys.push([4, , 10, 11]), [4, new Promise((function(e, r) {
                            u.onload = e, u.onerror = r;
                            var a = u.style;
                            a.setProperty("display", "block", "important"), a.position = "absolute", a.top = "0", a.left = "0", a.visibility = "hidden", t && "srcdoc" in u ? u.srcdoc = t : u.src = "about:blank", n.body.appendChild(u);
                            var o = function() {
                                var t;
                                "complete" === (null === (t = u.contentWindow) || void 0 === t ? void 0 : t.document.readyState) ? e(): setTimeout(o, 10)
                            };
                            o()
                        }))];
                    case 5:
                        r.sent(), r.label = 6;
                    case 6:
                        return (null === (i = u.contentWindow) || void 0 === i ? void 0 : i.document.body) ? [3, 8] : [4, o(a)];
                    case 7:
                        return r.sent(), [3, 6];
                    case 8:
    ...
    function B(e, t) {
        ...
        return t.fillText(n, 2, 15), t.fillStyle = "rgba(102, 204, 0, 0.2)", t.font = "18pt Arial", t.fillText(n, 4, 45), O(e)
    }
    ...
    function F(e, t) {
        ...
        return t.fillStyle = "#f9c", t.arc(60, 60, 60, 0, 2 * Math.PI, !0), t.arc(60, 60, 20, 0, 2 * Math.PI, !0), t.fill("evenodd"), O(e)
    }
    ...
    function j() {
        ...
        return function() {
                if (void 0 === G) {
                    var e = function() {
                        var t = U();
                        W(t) ? G = setTimeout(e, 2500) : (R = t, G = void 0)
                    };
                    e()
                }
            }(),
            function() {
                return n(e, void 0, void 0, (function() {
                    ...
                    return r(this, (function(t) {
                        switch (t.label) {
                            case 0:
                                return W(e = U()) ? R ? [2, a(R)] : _() ? [4, (n = document, (n.exitFullscreen || n.msExitFullscreen || n.mozCancelFullScreen || n.webkitExitFullscreen).call(n))] : [3, 2] : [3, 2];
                            case 1:
    ...
    function H(e) {
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                    case 0:
                        for (n = document, a = n.createElement("div"), i = new Array(e.length), c = {}, J(a), l = 0; l < e.length; ++l) u = D(e[l]), J(s = n.createElement("div")), s.appendChild(u), a.appendChild(s), i[l] = u;
                        r.label = 1;
                    case 1:
    ...
    var Se = {
        ...
        domBlockers: function(e) {
            ...
            return n(this, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                        case 0:
                            return S() || P() ? [4, H((a = []).concat.apply(a, q.map((function(e) {
                                return N[e]
                            }))))] : [2, void 0];
                        case 1:
                            return e = r.sent(), t && function(e) {
                                for (var t = "DOM blockers debug:\n```", n = 0, r = q; n < r.length; n++) {
                                    var a = r[n];
                                    t += "\n" + a + ":";
                                    for (var o = 0, i = N[a]; o < i.length; o++) {
                                        var c = i[o];
                                        t += "\n  " + c + " " + (e[c] ? "🚫" : "➡️")
                                    }
                                }
            ...
            return function(e, t) {
                ...
                return E((function(n, r) {
                    var o = r.document,
                        i = o.body,
                        c = i.style;
                    c.width = t + "px", c.webkitTextSizeAdjust = c.textSizeAdjust = "none", A() ? i.style.zoom = "" + 1 / r.devicePixelRatio : S() && (i.style.zoom = "reset");
                ...
                for (var n = {}, r = {}, a = 0, o = Object.keys(Ae); a < o.length; a++) {
                    var i = o[a],
                        c = Ae[i],
                        u = c[0],
                        s = void 0 === u ? {} : u,
                ...
                for (var g = 0, b = Object.keys(Ae); g < b.length; g++) {
        ...
        languages: function() {
            ...
            if (void 0 !== r && n.push([r]), Array.isArray(t.languages)) A() && b([!("MediaSettingsRange" in (e = window)), "RTCEncodedAudioFrame" in e, "" + e.Intl == "[object Intl]", "" + e.Reflect == "[object Reflect]"]) >= 3 || n.push(t.languages);
        ...
        platform: function() {
            ...
            return "MacIntel" === e && S() && !x() ? function() {
    ...
    var Ee = {
        ...
        De = v;
    return e.componentsToDebugString = xe, e.default = Ee, e.getFullscreenElement = _, e.getScreenFrame = j, e.hashComponents = Me, e.isAndroid = P, e.isChromium = A, e.isDesktopSafari = x, e.isEdgeHTML = C, e.isGecko = M, e.isTrident = k, e.isWebKit = S, e.load = Te, e.loadSources = y, e.murmurX64Hash128 = De, e.prepareForSources = _e, e.sources = Se, e
}({});