...
$jscomp.scope = {}, $jscomp.arrayIteratorImpl = function(t) {
    ...
    function(t) {
        ...
        o.e = function(t) {
            ...
            if (0 !== n)
                if (n) e.push(n[2]);
                    ...
                    s.charset = "utf-8", s.timeout = 120, o.nc && s.setAttribute("nonce", o.nc), s.src = o.p + "games/FruitsFuryNG/app/fruitsFury.13/" + ({
                        0: "game",
                        2: "vendors~vendor"
                    }[t] || t) + ".js";
                    var c = Error(),
        ...
        window.WEBPACK = !0, window.WEBPACK_VERSION = 1, window.GAMECODE = "261", window.MODE = "production", window.gameVersion = "(build 13 commit f777f5586273afd3381533b35acbeea2b0a059ad)", window.loadPackedVendorBundles = function() {
