$.Class("PlatformSettings", 
{
	...
	currencies: [
		...
		{name:'GYD', noCoins: 'yes'},
		{name:'UGX', noCoins: 'yes'},
		{name:'BYR', noCoins: 'yes'},
		{name:'AMD', noCoins: 'yes'},
		{name:'KES', displayBanknotesOnly: 'yes'},
		{name:'MKD', displayBanknotesOnly: 'yes'},
        {name:'RSD', displayBanknotesOnly: 'yes'},
