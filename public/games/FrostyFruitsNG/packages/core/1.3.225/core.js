...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(e, t, n) {
...
function(e) {
    ...
    n(194),
    n(209),
    window.nge._versions = window.nge._versions || {},
    window.nge._versions.core = JSON.stringify("1.3.225") || "local"
}
, function(e, t) {
...
, function(e, t) {
    nge.Cfg.Resolutions = Class.extend((function() {
        ...
        this.orientations = function() {
            for (var e = [], t = 0; t < this.contents.length; t++)
                -1 === e.indexOf(this.contents[t].orientation) && e.push(this.contents[t].orientation);
            return e
        }
        ,
        this.orientationsStrings = function() {
            for (var e = this.orientations(), t = 0; t < e.length; t++)
                e[t] = nge.Cfg.Main.orientations[e[t]];
            return e
        }
        ,
...
, function(e, t) {
    nge.Com.Base = Class.extend((function() {
        ...
        this.preloadDefault = function(t, n) {
            ...
            if (i || (i = this.getInstance(t, !1, n)),
            (e[t] = i) && (i.styles && (window.mt.data.styles = nge.Lib.Helper.objectApply(window.mt.data.styles, i.styles)),
            i.assets && i.assets.contents && 0 < i.assets.contents.length && 0 === window.mt.data.assets.contents.filter((function(e) {
                return e.name === o + "Com"
            }
            ...
            i.objects && i.objects.contents && 0 < i.objects.contents.length)) {
                var a;
                if (t = window.mt.data.objects,
                (s = mt.findItemInTemplate("name", s + "State", mt.data.objects)) && (a = mt.findItemInTemplate("name", o + "Container", s)),
                a && (t = a),
                t.contents || (t.contents = []),
                mt.findItemInTemplate("name", o + "Com", t))
                    return !1;
                t.contents.push({
        ...
        this.createDefault = function(t) {
            ...
            t || (t = "Tpl");
            var i = this.comName;
            if (!mt.findItemInTemplate("name", i + "Com", mt.data.objects))
                return !1;
            (t = e[t]) && t.objects && t.objects.contents && 0 < t.objects.contents.length && (t = nge.statesManager.getCurrentName(),
            mt.findItemInTemplate("name", t + "State", mt.data.objects),
            (t = mt.findItemInTemplate("name", t + "State", mt.data.objects)) && (n = mt.findItemInTemplate("name", i + "Container", t)),
            n || nge.objects.create(i + "Com"))
        }
        ,
        this.animateDefault = function() {
            ...
            if (e && e.firstCreation) {
                ...
                var o = new $.Deferred;
                n.push(o.promise()),
                i || (nge.observer.fire("Com.Base.animateDefault.start"),
                nge.localData.set("Com.Base.animateDefault.promisesArr", n),
...
, function(e, t) {
    nge.Com.AutoSpinButton.Controller = nge.Com.Base.extend((function() {
        ...
        this._autoSpinButtonDisable = function() {
            ...
            t ? (e.disable(3),
            nge.find("^btn_autospin_text1").removeClass("disableText"),
            nge.find("^btn_autospin_text2").removeClass("disableText")) : n ? (e.disable(5),
            nge.find("^btn_autospin_text1").removeClass("disableText"),
            nge.find("^btn_autospin_text2").removeClass("disableText")) : (e.disable(4),
            nge.find("^btn_autospin_text1").addClass("disableText"),
            nge.find("^btn_autospin_text2").addClass("disableText"))
        }
        ,
        ...
        this._checkFreeGame = function() {
            ...
            if (e || n)
                return !1;
            e = nge.localData.get("freeGame.inProgress"),
            n = nge.find("^autospinTextContainer");
            var i = nge.find("^autospinSpinsLeftText");
            e && 0 < nge.localData.get("freeGame.amount") ? (n.visible = !1,
            i.text = nge.localData.get("freeGame.amount"),
            i.alpha = 1) : (n.visible = !0,
            i.alpha = 0,
            t._autoSpinButtonEnable())
        }
        ,
        this._subscribe = function() {
            nge.observer.add("autospinButton.enable", t._autoSpinButtonEnable),
            nge.observer.add("autospinButton.disable", t._autoSpinButtonDisable),
            nge.observer.add("slotMachine.spinComplete", t._spinCompleteHandler),
            nge.observer.add("freeGames.show", t._spinCompleteHandler)
        }
    }
    ))
}
...
, function(e, t) {
    nge.Com.Autospin.Controller = nge.Com.Base.extend((function() {
        ...
        this.create = function() {
            ...
            nge.localData.get("autospin.paused") && n._autospinStart(),
        ...
        this._close = function() {
            return nge.find("^autospinPopupContainer").visible = !1,
        ...
        this._switchCheckbox = function(e, t) {
            ...
            i._onOverFrame = 2,
            s.fill = "white",
            o.text = nge.localData.get("autospin.checkbox_" + t + ".value"),
            o.alpha = 1)) : (nge.localData.set("autospin.checkbox_" + t + ".checked", !1),
            n.alpha = 0,
            i && (i.frame = 3,
            i.input.enabled = !1,
            s.fill = "#26a5b8",
        ...
        this._autospinStart = function() {
            if (nge.localData.get("autospin.paused"))
                nge.localData.set("autospin.paused", !1);
            else {
                var e = nge.localData.get("balance");
                nge.localData.set("autospin.startBalance", e),
                nge.localData.set("autospin.totalWin", 0),
                e = nge.localData.get("autospin.spins"),
                nge.localData.set("autospin.spinsLeft", e)
            }
            nge.localData.set("autospin.stopRequest", !1),
            ...
            e = nge.find("^autospinTextContainer");
            var t = nge.find("^autospinSpinsLeftText");
            e.visible = !1,
            t.text = nge.localData.get("autospin.spinsLeft"),
            t.alpha = 1
        }
        ,
        this._autospinHandleResponse = function(e) {
            ...
            nge.localData.set("autospin.spinsLeft", t),
            o.text = t;
            var s = (o = e.slotWin.totalWin) + nge.localData.get("autospin.totalWin");
            nge.localData.set("autospin.currentWin", o),
            nge.localData.set("autospin.totalWin", s),
            i = e.slotWin.linePickBonus,
            0 >= t && n._autoSpinStopRequest(),
            (e = nge.localData.get("autospin.checkbox_1")).checked && o > e.value && n._autoSpinStopRequest()
        }
        ,
        ...
        this._spinCompleteResponse = function() {
            if (!nge.localData.get("autospin.inProgress"))
                return !1;
            nge.localData.get("autospin.stopRequest") && n._finishAutoSpin(),
            i && 0 < i.length && (nge.localData.get("autospin.checkbox_0").checked && "FreeSpinReady" === i[0].bonusName ? (this._autoSpinStopRequest(),
            n._finishAutoSpin(),
            nge.observer.fire("spinButton.disable")) : (nge.localData.set("autospin.paused", !0),
            nge.localData.set("autospin.inProgress", !1))),
            e = !0
        }
        ,
        this._autospinBalanceUpdate = function() {
            ...
            if (!e || !t)
                return !1;
            e = !1,
            t = nge.localData.get("autospin.startBalance");
            var s = nge.localData.get("autospin.checkbox_2")
              , a = nge.localData.get("autospin.checkbox_3");
            s.checked && i.totalAmount - t.totalAmount > s.value ? (log("stopping autospin as win is bigger than specified"),
            n._finishAutoSpin()) : a.checked && t.totalAmount - i.totalAmount > a.value ? (log("stopping autospin as loose is bigger than specified"),
            n._finishAutoSpin()) : i.totalAmount < o ? (n._finishAutoSpin(),
        ...
        ,
        this._subscribe = function() {
            nge.observer.add("autospin.show", n._show),
            nge.observer.add("autospin.close", n._close),
            n.customSubscribe()
        }
        ,
        this.customSubscribe = function() {
            nge.observer.add("autoSpinCheckbox.press", n._updateCheckboxes, "change_checkboxes"),
            nge.observer.add("autoSpinSpins.press", n._updateSpins, "change_spins"),
            nge.observer.add("autospin.opened", n._updateAll, "open_autospin"),
            nge.observer.add("autospin.start", n._autospinStart, "start_autospin"),
            nge.observer.add("slotMachine.spinResponse", n._autospinHandleResponse, "response_autospin"),
            nge.observer.add("slotMachine.spinComplete", n._spinCompleteResponse),
            nge.observer.add("balance.amount", n._autospinBalanceUpdate, "complete_autospin"),
            nge.observer.add("freespin.end", n._checkAutospin),
            nge.observer.add("autospin.stopRequest", n._autoSpinStopRequest),
            nge.observer.add("autoSpinMoney.press", (function(t) {
            ...
            var e = function(e) {
                ...
                var n = nge.find("^textMoney_" + t);
                n.text = nge.Lib.Validator.moneyWithPeriod(e.target.value),
                nge.localData.set("autospin.checkbox_" + t + ".value", n.text)
            };
            return !0
        }
    }
...
, function(e, t) {
    nge.Com.Autospin.Tpl = function() {
        for (var e = [], t = 0, n = nge.localData.get("slotMachine.gameParameters.freeSpins"), i = 0; 4 > i; i++)
            nge.localData.set("autospin.checkbox_" + i + ".checked", 0 === i),
            0 < i && nge.localData.set("autospin.checkbox_" + i + ".value", "5.00");
        for (nge.localData.set("autospin.spins", 10),
        i = 10; 50 >= i; i += 10)
            e.push({
                x: 68 + t,
                y: 17,
...
, function(e, t) {
    nge.Com.Balance.Controller = nge.Com.Base.extend((function() {
        ...
        this.create = function() {
            ...
            return n && t._drawText(n),
            e || t._subscribe(),
            !0
        }
        ,
        this._change = function(e) {
            return "object" == typeof e && (t._drawText(e),
            nge.localData.set("balance.totalAmount", e.totalAmount),
            !0)
        }
        ,
...
, function(e, t) {
    nge.Com.Bet.Controller = nge.Com.Base.extend((function() {
        ...
        this.create = function() {
            ...
            return nge.localData.set("maxBetValue", n[n.length - 1]),
            t._setDefault(),
            e || t._subscribe(),
            e = !0
        }
        ...
        this._minus = function(e) {
            ...
            return !!n && (n = i.indexOf(n),
            i[--n] || (n = e ? 0 : i.length - 1),
            n = i[n],
            t.setVal(n),
            !0)
        }
        ...
        this.setVal = function(e) {
            ...
            for (t in n)
                n[t].text = e;
            nge.localData.set("bet.value", e),
            nge.observer.fire("bet.change", e)
        }
        ,
        ...
        ,
        this._subscribe = function() {
            nge.observer.add("brain.openGameSuccess", t._setDefault),
            nge.observer.add("bet.down", t._minus),
            nge.observer.add("bet.up", t._plus),
            nge.observer.add("bet.downNC", t._minusNC),
            nge.observer.add("bet.upNC", t._plusNC),
            nge.observer.add("bet.set", t.setVal),
            nge.observer.add("bet.update", t._setDefault),
            nge.observer.add("maxbet.go", t._setMax),
            t.customSubscribe()
        }
    }
    ))
...
, function(e, t) {
    nge.Com.BigWin.Controller = nge.Com.Base.extend((function() {
        var e, t, n, i, o = nge.localData.get("currency"), s = !1, a = 1, r = ["_rotateSun"], l = [["_popupDisplay"], ["_bigWinTxt120"], ["_bigWinTxt100", "_showSun", "_showDots"], ["_amountShow", "_amountUpdate", "_starsShow"], ["_setAmount", "_popupHide"], ["_animationFinish"]], c = 0, u = [], g = 0;
        this.create = function() {
            return e = this,
        ...
        ,
        this._subscribe = function() {
            nge.observer.add("bigWin", e._showBigWin),
            nge.observer.add("jackPot", e._showJackPot)
        }
        ,
        ...
        this._popupDisplay = function() {
            ...
            t.visible = !0,
            t.alpha = 1,
            i.x = nge.game.world.width / 2,
            i.y = nge.game.world.height / 2,
            i.scale.x = .01,
            i.scale.y = .01,
            i.visible = !0,
            n.text = 0,
            (t = nge.tween.add(i)).to({
                x: 0,
                y: 0,
                scaleX: 1,
                scaleY: 1
            }, 500, nge.Lib.Tween.Easing.Linear.None, !1, 0),
            t.onComplete.add(e._checkNextStep, this),
            t.start()
        }
        ,
        ...
        this._showDots = function() {
            ...
            n.onComplete.add(e._checkNextStep, this),
            n.start(),
            t = 0; 33 > t; t++)
                n = nge.find("#money_dot_big_" + t),
                (n = nge.tween.add(n)).to({
                    scaleX: 1.5 / a,
                    scaleY: 1.5 / a
        ...
        this._amountUpdate = function() {
            ...
            t.onUpdateCallback((function(t, n, i) {
        ...
        this._starsShow = function() {
            ...
            t("star_right_top", 100),
            t("star_left_center", 450),
            t("star_right_center", 350),
            t("star_left_bottom", 800),
            t("star_right_bottom", 950)
        }
        ,
        ...
        this._popupHide = function() {
            ...
            t.onComplete.addOnce(e._checkNextStep, this),
            t.start()
        }
        ,
...
, function(e, t) {
    nge.Com.Buttons.Controller = nge.Com.Base.extend((function() {
        ...
        this.create = function() {
            ...
            e._cfg = n.get(),
            (n = nge.localData.get("brain.restoreGame")) && n.lastResponse && "FreeSpinReady" === n.lastResponse.state && (e._paytableButtonDisable(),
            e._settingsButtonDisable(),
            e._euroButtonDisable()),
            t || e._subscribe(),
            t = !0
        }
        ,
        ...
        ,
        this._subscribe = function() {
            nge.observer.add("paytableButton.disable", e._paytableButtonDisable),
            nge.observer.add("paytableButton.enable", e._paytableButtonEnable),
            nge.observer.add("settingsButton.disable", e._settingsButtonDisable),
            nge.observer.add("settingsButton.enable", e._settingsButtonEnable),
            nge.observer.add("euroButton.disable", e._euroButtonDisable),
            nge.observer.add("euroButton.enable", e._euroButtonEnable)
        }
    }
    ))
}
...
, function(e, t) {
    nge.Com.ClearButton.Controller = nge.Com.Base.extend((function() {
        ...
        ,
        this._subscribe = function() {
            nge.observer.add("clearButton.enable", e._enable),
            nge.observer.add("clearButton.disable", e._disable)
        }
    }
    ))
}
    ...
    nge.Com.Coins.Controller = nge.Com.Base.extend((function() {
        ...
        this._setDefault = function() {
            ...
            for (var n = e.length, i = 0; i < n; i++)
                e[i] = parseFloat(e[i]);
            return nge.localData.set("coins.cfg", e),
            (n = nge.localData.get("coins.value")) || (n = parseFloat(nge.localData.get("coins.defaultCoin"))),
            n || (n = e[0]),
            t._setVal(n),
            !0
        }
        ...
        this._setVal = function(e) {
            ...
            for (t in n)
                n[t].text = parseFloat(e).toFixed(2);
            nge.localData.set("coins.value", parseFloat(e)),
            nge.observer.fire("coins.change", e)
        }
        ,
        this._subscribe = function() {
            nge.observer.add("brain.openGameSuccess", t._setDefault),
            nge.observer.add("coins.down", t._minus),
            nge.observer.add("coins.up", t._plus),
            nge.observer.add("coins.downNC", t._minusNC),
            nge.observer.add("coins.upNC", t._plusNC),
            nge.observer.add("coins.set", t._setVal),
            nge.observer.add("coins.update", t._setDefault)
        }
    }
    ))
}
...
, function(e, t) {
    nge.Com.Debug.Controller = nge.Com.Base.extend((function() {
        ...
        var e, t = !1, n = !0, i = !1;
        this.preload = function() {
            return "production" !== nge.Cfg.Main.mode && (this.preloadDefault(),
        ...
        this.create = function() {
            return e = this,
            "production" !== nge.Cfg.Main.mode && (this.createDefault(),
            i = nge.findOne("^debugCom"),
            nge.Lib.Helper.logicBlocksDo(this, "create"),
            t || (nge.Lib.Helper.logicBlocksDo(this, "subscribe"),
            e._subscribe(),
            t = !0),
            !0)
        }
        ...
        this.update = function() {
            if ("production" === nge.Cfg.Main.mode)
                return !1;
...
, function(e, t) {
    nge.Com.Debug.Observer = Class.extend((function() {
        var e = this
          ...
          , n = {};
        this.create = function() {
            return nge.localData.get("debug.observer.created") ? e.show(!1) : (i(),
            nge.localData.set("debug.observer.created", !0)),
            l(),
            nge.observer.debugFire = a,
            !0
        }
        ,
        this.show = function(e) {
            t = void 0 !== e ? e : !t,
            e = $(".debugObserverEditor"),
            t ? e.show() : e.hide()
        }
        ;
        var i = function() {
        ...
        this.add = function(e, t) {
            if (!e)
                return alert("no event name"),
                !1;
            if (n[e])
                return alert("event name exist"),
                !1;
            var i = u
              , o = c(e);
            return i = nge.Lib.Helper.strReplace("{className}", o, i),
            i = nge.Lib.Helper.strReplace("{color}", t, i),
            i = nge.Lib.Helper.strReplace("{name}", e, i),
            $(".list-observers").append(i),
            $(".eventName").val(""),
            n[e] = t,
            s(),
            !0
        ...
        var s = function() {
          ...
          , l = function() {
            nge.observer.add("sendSocket", (function(e) {
                e = JSON.stringify(e),
                e = "> sendSocket " + nge.Lib.Time.HHMMSS() + " " + e;
                var t = nge.Lib.Helper.getObjSize(n);
                log("%c" + e, !!t && "background: #222; color: #bada55")
            }
            ), "debug.sendSocket", !0),
            nge.observer.add("getSocket", (function(e) {
                if (-1 !== e.indexOf("JackpotResponse"))
                    return !1;
                var t = !!nge.Lib.Helper.getObjSize(n) && "background: #222; color: #bada55";
                e = "< getSocket " + nge.Lib.Time.HHMMSS() + " " + e,
                log("%c" + e, t)
            }
            ), "debug.getSocket", !0)
        }
          , c = function(e) {
            return e = nge.Lib.Helper.strReplace(".", "", "observer_" + e),
            e = nge.Lib.Helper.strReplace("'", "", e),
            e = nge.Lib.Helper.strReplace('"', "", e),
            nge.Lib.Helper.strReplace("*", "", e)
        };
...
, function(e, t) {
    nge.Com.Debug.Plugin = Class.extend((function() {
        ...
        this.create = function() {
            ...
            if (Phaser && Phaser.Plugin && Phaser.Plugin.Debug && Phaser.Plugin.GameGui)
                return t || (nge.game.plugins.add(Phaser.Plugin.Debug),
                nge.game.plugins.add(Phaser.Plugin.GameGui, {
                    autoPlace: !0,
                    width: 200
                }).gui.closed = !0,
                nge.localData.set("debug.plugin.created", !0)),
                e.show(!1),
                !0
        }
        ,
...
, function(e, t) {
    nge.Com.Debug.RenderStat = Class.extend((function() {
        ...
        this._fillRenderStat = function(e, n) {
            if (e.mt && e.mt.data)
                if (e.mt.data.type === mt.objects.TEXT)
                    e.visible && (n.pxText += Math.abs(e.width * e.height),
                    n.nText++);
                else if (e.mt.data.type === mt.objects.BITMAP_TEXT)
                    e.visible && (n.pxText += Math.abs(e.width * e.height),
                    n.nText++);
                else if (e.mt.data.type === mt.objects.IMAGE && "_slotMachineBlur" !== e.mt.data.class || e.mt.data.type === mt.objects.GRAPHICS || e.mt.data.type === mt.objects.ANIMATION)
                    e.visible && (n.pxSprite += Math.abs(e.width * e.height),
                    n.nSprite++,
                    e.vertexData && (n.nVertices += e.vertexData.length / 2));
                else if (e.mt.data.type !== mt.objects.MASK)
                    if (e.mt.data.type === mt.objects.BUTTON)
                        e.visible && (n.pxSprite += Math.abs(e.width * e.height),
                        n.nSprite++,
                        e.vertexData && (n.nVertices += e.vertexData.length / 2));
                    else if (e.mt.data.type === mt.objects.NINE_SLICE)
                        e.visible && (n.pxSprite += Math.abs(e.width * e.height),
                        n.nSprite++,
                        e.vertices && (n.nVertices += e.vertices.length));
                            ...
                            for (var i = 0; i < e.length; i++) {
                                ...
                                if (o.visible) {
                                    ...
                                    for (var s = 0; s < o.length; s++) {
                                        var a = o[s];
                                        a.visible && (n.pxSprite += Math.abs(a.width * a.height),
                                        n.nSprite++)
                                    }
                                }
                            }
                        ...
                        e.mt.data.type === mt.objects.GROUP ? e.visible && (n.containers++,
                        e.children.forEach((function(e) {
                            t._fillRenderStat(e, n)
                        }
                        ))) : e.mt.data.type === mt.objects.EMITTER && e.visible && (n.containers++,
                        e.children.forEach((function(e) {
                            e.visible && (n.pxSprite += Math.abs(e.width * e.height),
                            n.nSprite++,
                            e.vertexData && (n.nVertices += e.vertexData.length / 2))
...
, function(e, t) {
    nge.Com.Debug.Versions = Class.extend((function() {
        this.create = function() {
            var e, t = nge.find("^debugVersions"), n = "", i = nge.versions();
            for (e in i)
                n += e + ": " + i[e] + "\n";
            t.attr("text", n)
        }
...
, function(e, t) {
    nge.Com.Demo.Controller = function() {
        this.create = function() {
            return nge.rafSetTimeout(this.gotoPlay, 1e3),
        ...
        this.gotoPlay = function() {
            return nge.observer.fire("window.resize"),
...
, function(e, t) {
    nge.Com.Freespin.Controller = nge.Com.Base.extend((function() {
        var e, t, n, i, o = 0, s = !1;
        this._pauseMode = this._canSpin = !1,
        this._restoringFlag = !1,
        this.create = function() {
            return (t = this)._pauseMode = !1,
            n = nge.findOne("^autospinSpinsLeftText"),
            i = nge.findOne("^autospinSpinsTotal"),
            e || t._subscribe(),
        ...
        this.freespinStart = function(e) {
            ...
            !nge.localData.get("freespin.spinsTotalResetFlag") && o && a || (a = 0,
            nge.localData.set("freespin.spinsTotalResetFlag", !1)),
            a += e,
            nge.localData.getAll(),
            t.setSpinType(),
            nge.localData.set("freespin.inProgress", !0),
            nge.localData.set("freespin.lastSpin", !1),
            t._restoringFlag || (nge.localData.set("freespin.spinsTotal", a),
            nge.localData.set("freespin.spinsLeft", parseInt(nge.localData.get("freespin.spinsLeft"), 10) || 0 + e)),
            t._spinCommand(),
        ...
        this._spinHandleResponse = function(e) {
            if (!nge.localData.get("freespin.inProgress"))
                return !1;
            n && (n.text = nge.localData.get("freespin.spinsLeft") - 1),
            nge.localData.set("freespin.spinsLeft", parseInt(e.freeSpinRemain))
        }
        ,
        this.finishFreespin = function() {
            s = !1,
            o = 0,
            nge.localData.get("freespin.inProgress") && (nge.localData.set("spin.type", "SpinRequest"),
            nge.localData.set("freespin.spinsTotalResetFlag", !0),
            nge.localData.set("freespin.inProgress", !1),
            n && (n.visible = !1)),
        ...
        this._spinCompleteResponse = function() {
            ...
            n && (n.text = e),
            0 === e ? t.finishFreespin() : 0 < e && (t._canSpin = !0)
        }
        ,
        ...
        this._spinRestore = function(e) {
            if ("FreeSpins" !== e.state && "FreeReSpins" !== e.state)
                return !1;
            var n = 0;
            if (e.freeSpinRemain)
                var i = e.freeSpinRemain;
            ...
            return e.freeSpinsTotal && (n = parseInt(e.freeSpinsTotal, 10)),
            nge.localData.set("freespin.spinsLeft", i),
            nge.localData.set("freespin.spinsTotal", n),
            t._restoringFlag = !0,
            nge.observer.fire("freespin.start", i, 1300),
            !0
        }
        ,
        ...
        ,
        this._subscribe = function() {
            return nge.observer.add("freespin.start", t.freespinStart),
            nge.observer.add("slotMachine.spinResponse", t._spinHandleResponse),
            nge.observer.add("slotMachine.spinComplete", t._spinCompleteResponse),
            nge.observer.add("freespin.restore", t._spinRestore),
            nge.observer.add("win", t._winHandler),
            nge.observer.add("spinAndWinComplete", t._winlinesCompleteHandler),
            nge.observer.add("freespin.pause", t._pause),
            nge.observer.add("freespin.resume", t._resume),
            !0
        }
    }
    ))
...
, function(e, t) {
    nge.Com.FreeGamePopup.Controller = nge.Com.Base.extend((function() {
        ...
        this._show = function() {
            ...
            if (!n || "FreeSpinResponse" === e)
                return t._hide(),
                !1;
            nge.find("#freeGamePopup").visible = !0,
            nge.find("^winUserCodeText").text = n.amount,
            nge.find("^freeGameCoinValue").text = nge.localData.get("currency") + n.coin,
            nge.find("^freeGameCoinsNumberValue").text = n.coinsPerBet,
            nge.find("^freeGameLinesValue").text = n.lines,
            nge.find("^freeGameExpValue").text = n.freeGameExpiration,
        ...
        ,
        this._subscribe = function() {
            nge.observer.add("freeGamePopup.hide", t._hide),
            nge.observer.add("freeGames.show", t._show),
            nge.observer.add("freeGamePopup.close", t._close),
            nge.observer.add("freespin.end", t._show),
            nge.observer.add("freespin.start", t._hide),
            nge.observer.add("freespin.restore", t._hide)
        }
    }
    ))
}
...
, function(e, t) {
    nge.Com.FreeGameCounter.Controller = nge.Com.Base.extend((function() {
        ...
        this._check = function() {
            nge.localData.get("freeGame.inProgress") ? (nge.find("^freeGameCounterContainer").visible = !0,
            nge.find("^counterButtonText").text = nge.localData.get("freeGame.totalAmount")) : nge.find("^freeGameCounterContainer").visible = !1
        }
        ,
        this._changeNumberCounter = function() {
            if (!nge.localData.get("freeGame") || 0 >= nge.localData.get("freeGame.amount"))
                return nge.find("^freeGameCounterContainer").visible = !1;
            nge.find("^counterButtonText").text = nge.localData.get("freeGame.amount")
        }
        ,
        this._subscribe = function() {
            nge.observer.add("kenoMachine.animationEnd", t._changeNumberCounter, !1, !0),
            nge.observer.add("scratchMachine.scratchComplete", t._changeNumberCounter, !1, !0)
        }
    }
    ))
}
...
, function(e, t) {
    nge.Com.FreeGameSummaryPopup.Controller = nge.Com.Base.extend((function() {
        ...
        this._show = function() {
            ...
            nge.find("^winUserCodeTextSumMoney").text = nge.localData.get("currency") + nge.Lib.Validator.floatMoney(e, !0),
        ...
        ,
        this._subscribe = function() {
            nge.observer.add("freeGameSumPopup.show", t._show),
            nge.observer.add("freeGameSumPopup.close", t._close)
        }
    }
    ))
}
...
, function(e, t) {
    nge.Com.Gamble.Controller = nge.Com.Base.extend((function() {
        var e, t, n, i = "", o = 0, s = ["black", "red"];
        this.create = function() {
            e = this,
            o = 2 * nge.localData.get("slotMachine.slotWin.totalWin");
            var n = "YOU CAN WIN x2: " + nge.Lib.Validator.floatMoney(o, !0) + nge.localData.get("currency");
            return nge.localData.set("infoPanel.text", n),
            t || e._subscribe(),
            t = !0
        }
        ,
        ...
        this._loadNewCardTexture = function(e) {
            ...
            t.image("card", nge.assets.getImagesPath() + e),
            t.onLoadComplete.addOnce((function() {
                var e = nge.find("^card")
        ...
        this.complete = function() {
            ...
            nge.rafSetTimeout((function() {
                n ? (nge.find("^winCont").visible = !0,
                nge.find("^winUserCodeText").text = e,
                nge.observer.fire("gamble.win")) : (nge.find("^loseCont").visible = !0,
                nge.observer.fire("gamble.lose")),
                self._loadNewCardTexture("gamble/cards/card.png")
            }
            ), 2e3),
            nge.rafSetTimeout((function() {
                self._loadNewCardTexture("gamble/cards/card.png"),
        ...
        ,
        this._subscribe = function() {
            nge.observer.add("gamble.showCard", e._actionRequest),
            nge.observer.add("gamble.response", e._show)
        }
    }
    ))
}
...
, function(e, t) {
    nge.Com.GambleButton.Controller = nge.Com.Base.extend((function() {
        ...
        this.create = function() {
            this.createDefault(),
            (n = this)._isTotalWin() && n._gambleButtonEnable(),
            e || n._subscribe(),
            e = !0
        }
        ,
        this._gambleButtonEnable = function() {
            if (nge.localData.get("livingLargeBonusGameEnd"))
                return nge.localData.set("livingLargeBonusGameEnd", !1),
                !1;
        ...
        this._handleSpin = function() {
            n._isTotalWin() && (i = !1,
            n._gambleButtonEnable())
        }
        ,
        this._disableWithoutAnimation = function() {
            n._changeNeedAnimate(),
            nge.find("^gambleButtonContainer").visible = !1,
            i = !0
        }
        ,
        this._subscribe = function() {
            nge.observer.add("slotMachine.spinComplete", n._handleSpin),
            nge.observer.add("slotMachine.spinStart", n._gambleButtonDisable),
            nge.observer.add("bigWin", n._disableWithoutAnimation),
            nge.observer.add("freespin.end", n._disableWithoutAnimation),
            nge.observer.add("brain.bonusGameEnd", n._changeNeedAnimate, !1, !0),
            nge.observer.add("gamble.actionRequest", n._changeNeedAnimate, !1, !0)
        }
    }
    ))
}
...
, function(e, t) {
    nge.Com.HistoryDataCollector.Controller = nge.Com.Base.extend((function() {
        ...
        this._historyResponse = function(e) {
            ...
            n.response.isHistory = !0,
            nge.localData.set("brain.restoreGame.lastResponse", n.response),
            n.response.spinResult && (e = nge.Lib.Helper.rowsToColumns(n.response.spinResult.rows),
            nge.localData.set("slotMachine.initialSymbols", e)),
            "ScratchResponse" === n.response["@type"] && (e = nge.Lib.Helper.rowsToColumns(n.response.scratchResult.rows),
            nge.localData.set("slotMachine.initialSymbols", e)),
            nge.localData.set("poker.lastResponse", n.response),
...
, function(e, t) {
    nge.Com.InfoPanel.Controller = nge.Com.Base.extend((function() {
        ...
        ,
        this._show = function(t) {
            nge.localData.set("infoPanel.text", t),
            e.text = t
        }
        ,
        this._subscribe = function() {
...
, function(e, t) {
    nge.Com.Jackpot.Controller = nge.Com.Base.extend((function() {
        ...
        this._changeJackpot = function(e) {
            ...
            e = nge.Lib.Validator.floatMoney(e.amount, !0) + "€",
            nge.find("^jackpotContainerContent").visible = !0,
            "paytable" === t && (nge.find("^jackpotContainerContent").visible = !1),
            nge.find("^jackpotAmountText").text = e,
            nge.find("^topTextWin2").text = e
        }
        ,
        this._subscribe = function() {
...
, function(e, t) {
    nge.Com.LayersSwitcher.Controller = nge.Com.Base.extend((function() {
        ...
        this.create = function() {
            ...
            i._findSelectors(),
            i._show(n.cfg.defaultLayer),
            e || i._subscribe(),
            n.cfg.autoSwitch) {
                var o = function() {
                    nge.rafSetTimeout(o, n.cfg.autoSwitchDelay);
                    var e = Object.keys(n.cfg.layers).length - 1;
                    e = nge.Lib.Helper.getRandomInt(0, e),
                    e = Object.keys(n.cfg.layers[e]),
                    nge.observer.fire("layersSwitcher.show", e)
                };
                nge.rafSetTimeout(o, n.cfg.autoSwitchDelay)
            }
        }
        ...
        this._show = function(e) {
            n.next.name = e.split(" ")[0],
            n.next.name === n.current.name ? console.warn("LayersSwitcher: trying to change to the same layer", n.current.name) : (n.next.layer = n.cfg.layers[n.next.name],
            n.next.layer ? (i._changeListVisibility(n.cfg.allContainers, !1),
            i._changeListVisibility(n.next.layer.static, !0),
            i._animate((function() {
        ...
        this._getCfg = function() {
            ...
            if (!e || !e.scenes)
                return console.error("nge.Com.LayersSwitcher.Controller no state cfg", e),
                !1;
            var t = nge.statesManager.getCurrentName();
        ...
        this._changeListVisibility = function(e, t) {
            if (e)
                for (var i = 0; i < e.length; i++)
                    n.objects[e[i]] || console.error("nge.Com.LayersSwitcher.Controller error: no key", e[i]),
                    n.objects[e[i]].visible = t
        }
        ,
        this._subscribe = function() {
            nge.observer.add("layersSwitcher.show", i._show),
            e = !0
        }
    }
    ))
...
, function(e, t) {
    nge.Com.LayersSwitcher.Helper = Class.extend((function() {
        function e(e, t) {
            return (t = t.objects[e] || nge.findOne("^" + e)) || console.error("Cant't find element ", e),
            t
        }
        function t(e, t, n) {
            if (e)
                for (var i = 0; i < e.length; i++)
                    t.objects[e[i]] || console.error("nge.Com.LayersSwitcher.Controller error: no key", e[i]),
                    t.objects[e[i]].visible = n
        }
        this.singleton = !0,
        this.animationTypes = {
            darkLayer: function(e, t) {
                var n = e.objects[e.cfg.allContainers[0]].parent
                  ...
                  , o = e.current;
                e = e.next.layer,
                o.layer && o.layer.darkLayer && ((o = nge.localData.get("layersSwitcher.animations.darkLayer.image")).parent.remove(o),
                o.destroy()),
                e && e.darkLayer && (o = i.generateImage(0, n),
                t && t(),
                nge.localData.set("layersSwitcher.animations.darkLayer.image", o))
            },
            fromDark: function(e, t) {
                var n = e.objects[e.cfg.allContainers[0]].parent
                  , i = nge.Com.LayersSwitcher.Capture;
                (e = e.next.layer) && e.fromDark && (n = i.generateImage(0, n),
                i.animate(n, 1e3, {
                    alpha: 0
                }, (function() {
                    t && t()
            ...
            capture: function(n, i) {
                ...
                a.layer && a.layer.capture && function(t) {
                    ...
                    a ? s.animate(a, 500, {
                        ...
                        t.overlay && (t.overlay.forEach((function(t) {
                            (t = e(t, n)).primalParent !== o && (o.remove(t),
                            t.primalParent.add(t))
                        }
                        )),
                ...
                r && r.capture && function(i) {
                    o.children.forEach((function(e) {
                        e.primalZ = e.z
                    }
                    )),
                    t(n.cfg.allContainers, n, !1),
                    t(n.current.layer.static, n, !0);
                    var a = s.getTexture(i.exclude);
                    a = s.getImage(a, o),
                    t(n.cfg.allContainers, n, !1),
                    t(n.next.layer.static, n, !0),
                    i.overlay && i.overlay.forEach((function(t) {
                        (t = e(t, n)) && (t.primalZ = t.z,
                        t.primalParent = t.parent,
                        o !== t.parent && (t.parent.remove(t),
                        o.add(t)),
                        o.bringToTop(t))
                    }
                    )),
                    a.visible = !0,
                    nge.localData.set("layersSwitcher.animations.capture.captureImage", a)
                }(r.capture)
            },
            bounce: function(t, n) {
                var i = function(e, t, n, i) {
                    ...
                    o && o[n] && o[n].stop(!0);
                    for (var s, a, r = 0, l = 0 < t ? 750 : 500, c = .5 * (1 - t), u = .5 * (1 + t), g = 0; g < e.children.length; g++)
                        e.getChildAt(g).hasClass("cover") && (r = g,
                        (a = e.getChildAt(g)).alpha = 0 < t ? 0 : .7,
                        e.parent.addChildAt(a, e.parent.getChildIndex(e)),
                        nge.tween.add(a).to({
                            alpha: 0 < t ? .7 : 0
                    ...
                    e.scale.x = e.scale.y = c,
                    (s = nge.tween.add(e.scale)).to({
                        x: u,
                        y: u
                    }, l, 0 < t ? nge.Lib.Tween.Easing.Elastic.Out : nge.Lib.Tween.Easing.Back.In, !1),
                    s.onUpdateCallback((function() {
                        e.centerX = e.original.x,
                        e.centerY = e.original.y
                    }
                    ), this),
                    s.onComplete.add((function() {
                        if (e.scale.x = e.scale.y = 1,
                        e.centerX = e.original.x,
                        e.centerY = e.original.y,
                        a && e.addChildAt(a, r),
                        s = null,
                        delete o[n],
                        nge.localData.set("layersSwitcher.animations.bounce.tweens", o),
                        i)
                            return i()
                    }
                    ), this),
            ...
            fakeLoaderOn: function(e, n) {
                var i = e.next.layer;
                if (i && i.fakeLoaderOn) {
                    i = i.fakeLoaderOn.showDuration || 500,
                    t(e.cfg.allContainers, e, !1),
                    t(e.current.layer.static, e, !0);
                    var o = nge.findOne("^loadingBarContainer");
                    o || (o = nge.objects.create("loadingBarContainer")),
                    o.alpha = 0,
            ...
            fakeLoaderOff: function(e, t) {
                ...
                if (n && n.fakeLoaderOff) {
                    ...
                    o || (o = nge.objects.create("loadingBarContainer")),
                    o.alpha = 1,
                    (n = nge.find("^loadingBarFill")) && (n.visible = !0),
                    nge.rafSetTimeout((function() {
                        nge.tween.add(o).to({
                            alpha: 0
                        }, i, null, !0).onComplete.addOnce((function() {
...
, function(e, t) {
    nge.Com.LayersSwitcher.Capture = {
        getTexture: function(e) {
            var t, n;
            if (nge.observer.fire("capture.started"),
            e)
                for (t = 0; t < e.length; t++)
                    (n = nge.findOne("^" + e[t])) ? n.visible = !1 : console.error("Can't exclude object with name \"" + e[t] + "\". Maybe it doesn't exist");
            nge.game.paused = !0;
            ...
            if ((t = nge.objects.create(new nge.Mlm.Objects.Graphics({}))).beginFill(nge.game.stage.backgroundColor),
            t.lineStyle(1, nge.game.stage.backgroundColor, 1),
            t.drawRect(0, 0, nge.game.width, nge.game.height),
            t.endFill(),
            i.renderXY(t, 0, 0),
            t.clear(),
            i.renderXY(nge.game.world, -nge.game.camera.x, -nge.game.camera.y),
            nge.game.paused = !1,
            e)
                for (t = 0; t < e.length; t++)
                    (n = nge.findOne("^" + e[t])) && (n.visible = !0);
            return nge.observer.fire("capture.ended"),
            i
        },
        generateImage: function(e, t) {
            var n = nge.objects.create(new nge.Mlm.Objects.Graphics({}));
            return n.beginFill(e),
            n.drawRect(0, 0, 1, 1),
            n.endFill(),
            (e = nge.objects.create(new nge.Mlm.Objects.Image({
                assetKey: "1px_empty"
            }))).loadTexture(n.generateTexture()),
            e.width = nge.game.width / nge.game.world.scale.x,
            e.height = nge.game.height / nge.game.world.scale.y,
            e.visible = !0,
            (t = t || nge.game.world).add(e),
            t.bringToTop(e),
            e
        },
        getImage: function(e, t) {
            ...
            n.width = nge.game.width / nge.game.world.scale.x,
            n.height = nge.game.height / nge.game.world.scale.y,
            n.visible = !1,
            (t = t || nge.game.world).add(n),
            t.bringToTop(n),
            n
        },
        ...
        __test: function() {
            ...
            (e = this.getImage(e, nge.game.world)).visible = !0,
            this.animate(e, 2e3, {
                alpha: 0
            }, (function() {}
            ), !0, !1, 0)
...
, function(e, t) {
    nge.Com.Lines.Controller = nge.Com.Base.extend((function() {
        ...
        this.create = function() {
            ...
            return t = 1,
            i && (t = i[i.length - 1]),
            nge.localData.set("maxLinesValue", t),
            n._setDefault(),
            e || n._subscribe(),
            e = !0
        }
        ...
        this._minus = function(e) {
            ...
            return !!t && (t = n.indexOf(t),
            n[--t] || (t = e ? 0 : n.length - 1),
            t = n[t],
            nge.observer.fire("lines.set", t),
            !0)
        }
        ,
        this._plus = function(e) {
        ...
        this._setVal = function(e, t) {
            for (var n in nge.observer.fire("winlines.hideAll"),
            t || (nge.observer.fire("lines.change", e),
            nge.localData.set("winlines.updated", !0)),
            t = nge.findAll(".linesNumber"))
                t[n].text = e;
        ...
        ,
        this._subscribe = function() {
            nge.observer.add("brain.openGameSuccess", n._setDefault),
            nge.observer.add("lines.down", n._minus),
            nge.observer.add("lines.up", n._plus),
            nge.observer.add("lines.downNC", n._minusNC),
            nge.observer.add("lines.upNC", n._plusNC),
            nge.observer.add("lines.set", n._setVal),
            nge.observer.add("lines.update", n._setDefault)
        }
    }
    ))
}
...
, function(e, t) {
    nge.Com.Load.Controller = nge.Com.Base.extend((function() {
        ...
        this._preloadFonts = function() {
            var t, n = nge.assets.getAntiCacheSuffix(), i = e.fonts || {};
            for (t in i)
                nge.wrap.load.font(t, nge.realPathPrefix + i[t] + ".otf" + n)
        }
        ,
...
, function(e, t) {
    nge.Com.LoadAssets.Controller = nge.Com.Base.extend((function() {
        var e, t, n, i, o = !1, s = !1, a = !1;
        this.preload = function() {
            this.preloadDefault(),
            e = this,
            t = nge.App.getInstance("Com.Load.Cfg"),
            e._preloadScrollbars(),
            e._preloadLoader(),
            e._preloadAtlases(),
            e._preloadBitmapFonts()
        }
        ,
        this.create = function() {
            n = nge.Lib.Time.get(),
            ...
            nge.Lib.Checker.delay((function() {
                ...
                return o || (2e4 < e ? (s = !1,
                o = !0) : !0 === nge.localData.get("brain.firstAuthComplete") && (o = s = !0)),
                o && a
            }
            ), (function() {
                nge.rafSetTimeout((function() {
                    s ? (nge.userInfoHTML("Auth Complete"),
                    nge.observer.fire("loadAssets.complete"),
                    nge.statesManager.display(nge.statesManager.getDefaultState())) : (nge.userInfoHTML("Auth Fail. Try again later."),
                    nge.userFatalErrorHTML("Auth Fail", "Try again later."))
                }
                ), 1)
            }
            ), 500, 1e4, !0)
        ...
        this._preloadScrollbars = function() {
            e.preloadDefault(nge.tpl.group("scrollbarVertical")),
            e.preloadDefault(nge.tpl.group("scrollbarHorizontal"))
        }
        ,
        ...
        this._preloadAtlases = function() {
            if (!t || !t.atlasesGroups || !t.atlasesGroups.length)
                return !1;
    ...
    nge.Com.LoadAssets.Tpl = function() {
        ...
        for (var t in customButtons) {
            ...
            if (n.callback) {
                if (n.imageUrl) {
                    var i = {};
                    i.key = t.concat("-blank"),
                    i.fullPath = n.imageUrl,
                    e.assets.contents.push(i)
                }
...
, function(e, t) {
    nge.Com.Maxbet.Controller = nge.Com.Base.extend((function() {
        ...
        this._update = function() {
            ...
            return e !== nge.localData.get("maxLinesValue") || t !== n ? (i._maxbetButtonChange(!1),
            i._spinButtonChange(!1),
            !1) : (i._maxbetButtonChange(!0),
            i._spinButtonChange(!0),
            !0)
        }
        ,
        this._maxbetButtonChange = function(e) {
            if (!t.maxbetButtonChange)
                return !1;
            (n = e) ? i._maxBetButtonDisableMax() : i._maxBetButtonEnable()
        }
        ,
        this._spinButtonChange = function(e) {
            if (!t.spinButtonChange)
                return !1;
            nge.observer.fire("spinButton.maxBet", e)
        }
        ,
        this._maxBetButtonEnable = function() {
            if (nge.localData.get("autospin.inProgress") || nge.localData.get("freespin.inProgress") || nge.localData.get("freeGame.inProgress"))
                return !1;
            n ? i._maxBetButtonDisableMax() : (nge.find("^" + t.maxbetButtonName).enable(),
        ...
        this._maxBetButtonDisable = function() {
            nge.find("^" + t.maxbetButtonName).disable(4),
        ...
        this._maxBetButtonDisableMax = function() {
            if (nge.localData.get("autospin.inProgress") || nge.localData.get("freespin.inProgress") || nge.localData.get("freeGame.inProgress"))
                return !1;
            nge.find("^" + t.maxbetButtonName).disable(3),
            nge.find("^btn_maxbet_text1").removeClass("disableText"),
            nge.find("^btn_maxbet_text2").removeClass("disableText")
        }
        ,
        this._subscribe = function() {
            ...
            nge.observer.add("maxBetButton.enable", i._maxBetButtonEnable),
            nge.observer.add("maxBetButton.disable", i._maxBetButtonDisable),
...
, function(e, t) {
    nge.Com.Paytable.Controller = nge.Com.Base.extend((function() {
        ...
        this.customCreate = function() {
            ...
            e = nge.findOne("^paytableItemsContainer"),
            n.hasOwnProperty("x") && (e.x = n.x),
            n.hasOwnProperty("y") && (e.y = n.y);
            var f = n.horizontal
              , p = n.itemLogoWidth
              , b = n.itemLogoHeight;
            o = n.mw,
            ...
            u = 1;
            var m = i % o;
            for (var h in l = (o * s - m * s) / 2,
            t) {
                var d = t[h].awards
                  , y = nge.objects.create("paytableItemContainer", e);
                y.visible = !0,
                y.id = h + "_itemContainer",
                y.name = h + "_itemContainer",
                y.x = r,
                y.y = c,
                u > i - m && (y.x += l),
                (g = y.create(0, 0, h)).id = h + "_logo",
                g.name = h + "_logo",
                g.width = p,
                g.height = b;
                var _ = 0;
                d.forEach((function(e) {
                    ...
                    t.x = f ? p + 50 : 100,
                    t.y = f ? b / 5 * ((5 - d.length) / 2) : b + 15,
                    t.visible = !0;
                    var n = nge.objects.create("paytableAwardName", t);
                    n.y = _,
                    n.text = e.name,
                    n.visible = !0,
                    (t = nge.objects.create("paytableAwardValue", t)).name = "paytableAwardValue" + e + h,
                    t.y = _,
                    t.text = "- " + e.value,
                    t.visible = !0,
                    _ += 50
        ...
        this._createThumbs = function(t) {
            e = nge.find("#paytableLinesContainer"),
            n.hasOwnProperty("linesContainerX") && (e.x = n.linesContainerX),
            n.hasOwnProperty("linesContainerY") && (e.y = n.linesContainerY);
            for (var i = 0, o = 0, s = 0; s < t.length; s++) {
                t[s].x = s % 3 * (t[s].width + 130) + 130,
                t[s].y = ~~(s / 3) * (t[s].height + 150) + 100,
                t[s].visible = !0;
                var a = nge.objects.create("paytableLinesText");
                a.x = t[s].x + t[s].width / 2,
                a.y = t[s].y - 30,
                a.text = "LINE " + (s + 1),
                a.alpha = 1,
                a.name = "paytableLinesText_" + (s + 1),
                3 <= t.length && ~~(s / 3) == ~~(t.length / 3) && (i || (i = t.length % 3,
                o = (e.width - 130 - (t[s].width + 130) * i) / 2),
                t[s].x += o,
                a.x += o),
                e.addChild(a),
                e.addChild(t[s])
        ...
        ,
        this._subscribe = function() {
            nge.observer.add("tabs.paytablePopupObject.switch", o._showTab),
            nge.observer.add("winlines.thumbsResponse", o._createThumbs)
        }
    }
    ))
}
, function(e, t) {
    nge.Com.Paytable.TplPaytableBonusLinesTabs = function() {
        ...
        }).styles = nge.Lib.Helper.mergeObjs(e.styles, t.styles),
        n && (e.styles = nge.Lib.Helper.mergeObjs(e.styles, n.styles)),
        e
    }
}
, function(e, t) {
...
, function(e, t) {
    nge.Com.PickUpBonusGame.Controller = nge.Com.Base.extend((function() {
        ...
        ,
        this._actionHandler = function(t) {
            if (e.inProgress || -1 !== e.itemsOpened.indexOf(t))
                return !1;
            e.inProgress = !0,
            e.lastPick = t,
            e.itemsOpened.push(t),
            nge.observer.fire("pickUpBonusGame.actionRequest", t)
        }
        ,
        this.openItem = function(t, n) {
            ...
            return i && i.disable(3),
            nge.find("^pickItemContainer" + n.index) && (i = nge.find("^pickItemText" + n.index)) && (i.text = n.value.toString(),
            i.visible = 1),
            e.setWinAmount(t.winAmount),
            e.customOpenItem(t, n),
            e.revealAll(t),
            t.lastPick && e.bonusGameEnd(t),
            e.complete(),
            !0
        }
        ,
        this.bonusGameEnd = function(e) {
            nge.localData.set("lastBonusWin", e.params.lastBonusWinAmount),
        ...
        ,
        this.customOpenItem = function(e, t) {}
        ,
        this.revealAll = function(e) {
            if (e.items)
                for (var t in e.items) {
                    ...
                    (o = nge.find("^pickItemText" + n.index)) || (o = nge.find("^pickItemText" + n.index, i)),
                    o.text = n.value.toString(),
                    o.visible = 1
                }
        }
        ,
        ...
        ,
        this.subscribe = function() {
            nge.observer.add("brain.openPickUpBonusGameSuccess", e._display),
            nge.observer.add("pickUpBonusGame.actionCommand", e._actionHandler),
            nge.observer.add("pickUpBonusGame.actionResponse", e.openItem)
        }
    }
    ))
}
...
, function(e, t) {
    nge.Com.PopUp.View = Class.extend((function() {
        ...
        this.show = function(n) {
            e._chkSelf(this),
            (n = new nge.Com.PopUp.Model(n)).id = "popUpWrapper" + t,
            n.popUpIndex = t,
            n.onCancel = e._createAction(t, n.onCancel),
            n.onSubmit = e._createAction(t, n.onSubmit),
            n = this.getInstance("Tpl", !1, n),
            nge.objects.create(n.objects.contents[0]),
            t++
        }
        ,
...
, function(e, t) {
    nge.Com.RandomButton.Controller = nge.Com.Base.extend((function() {
        ...
        ,
        this._subscribe = function() {
            nge.observer.add("randomButton.enable", e._enable),
            nge.observer.add("randomButton.disable", e._disable)
        }
    }
    ))
}
...
, function(e, t) {
    nge.Com.Respin.Controller = nge.Com.Base.extend((function() {
        var e, t, n = !1, i = !1, o = 0, s = !1;
        this._restoringFlag = !1,
        this.create = function() {
            return e = this,
            t || e._subscribe(),
            nge.localData.set("respin.inProgress", !1),
            nge.localData.set("spin.type", "SpinRequest"),
            t = !0
        }
        ,
        ...
        this.respinStart = function(t) {
            ...
            !nge.localData.get("respin.spinsTotalResetFlag") && n && o || (o = 0,
            nge.localData.set("respin.spinsTotalResetFlag", !1)),
            o += t,
            nge.localData.getAll(),
            e.setSpinTypeRespins(),
            nge.localData.set("respin.inProgress", !0),
            nge.localData.set("respin.lastSpin", !1),
            e._restoringFlag || (nge.localData.set("respin.spinsTotal", o),
            nge.localData.set("respin.spinsLeft", parseInt(nge.localData.get("respin.spinsLeft"), 10) || 0 + t)),
        ...
        ,
        this.spinCommand = this._spinCommand,
        this._spinHandleResponse = function(e) {
        ...
        this.finishRespin = function() {
            i = !1,
            o = 0,
            nge.localData.get("respin.inProgress") && (nge.localData.get("freespin.inProgress") ? nge.localData.set("spin.type", "FreeSpinRequest") : nge.localData.set("spin.type", "SpinRequest"),
            nge.localData.set("respin.spinsTotalResetFlag", !0),
            nge.localData.set("respin.inProgress", !1)),
        ...
        this._spinRestore = function(t) {
            if ("ReSpins" !== t.state && "FreeReSpins" !== t.state)
                return !1;
            var n = 0;
            if (t.reSpinRemain)
                var i = t.reSpinRemain;
            ...
            return t.reSpinsTotal && (n = parseInt(t.reSpinsTotal)),
            nge.localData.set("respin.spinsLeft", i),
            nge.localData.set("respin.spinsTotal", n),
            e._restoringFlag = !0,
            nge.observer.fire("respin.start", i, 1300),
            !0
        }
        ,
        this._winHandler = function(e) {
        ...
        ,
        this._subscribe = function() {
            nge.observer.add("freeReSpins.start", e.freeReSpinsStart),
            nge.observer.add("respin.start", e.respinStart),
            nge.observer.add("slotMachine.spinResponse", e._spinHandleResponse),
            nge.observer.add("slotMachine.spinComplete", e._spinCompleteResponse),
            nge.observer.add("respin.restore", e._spinRestore),
            nge.observer.add("win", e._winHandler),
            nge.observer.add("respin.pause", e._pause),
            nge.observer.add("respin.resume", e._resume)
        }
    }
    ))
}
...
, function(e, t) {
    nge.Com.Settings.Controller = nge.Com.Base.extend((function() {
        ...
        this.create = function() {
            ...
            return n || (n = "high",
            nge.localData.set("settings.imageQuality", n)),
            t._switchSwitch(i),
            t._setQualityButtonsStyle(n),
            e = !0
        }
        ,
        this._subscribe = function() {
            return nge.observer.add("settings.switchSound", t._switchSound),
            nge.observer.add("settings.changeImageQuality", t._changeQuality),
            !0
        }
        ,
        ...
        this._switchSwitch = function(e) {
            nge.localData.set("settings.sounds", e),
            nge.observer.fire("settings.sounds.changed", e);
            var t = nge.find("^switch")
              , n = nge.find("^pick")
              , i = nge.find("^switchText");
            if (!t)
                return !1;
            e ? (t.addClass("activeSwitch"),
            n.addClass("activePick"),
            i.removeClass("offSwitch"),
            i.addClass("onSwitch")) : (t.removeClass("activeSwitch"),
            n.removeClass("activePick"),
            i.removeClass("onSwitch"),
            i.addClass("offSwitch"))
        }
        ,
        this._changeQuality = function(e) {
            nge.localData.set("settings.imageQuality", e),
            t._forceRestartSettings()
        }
        ,
        this._forceRestartSettings = function() {
            var e = nge.statesManager.getCurrentName();
            nge.statesManager.display(e, !1, !0),
        ...
        this._setQualityButtonsStyle = function(e) {
            ...
            case "low":
                ...
                n.removeClass("activeBtn"),
                i.removeClass("activeBtn"),
                o.addClass("activeText"),
                s.removeClass("activeText"),
                a.removeClass("activeText");
                break;
            case "medium":
                t.removeClass("activeBtn"),
                n.addClass("activeBtn"),
                i.removeClass("activeBtn"),
                o.removeClass("activeText"),
                s.addClass("activeText"),
                a.removeClass("activeText");
                break;
            case "high":
                t.removeClass("activeBtn"),
...
, function(e, t) {
    nge.Com.SlotMachine.Cfg = Class.extend((function() {
        ...
        this.set = function(e, t) {
            return !!this.params[e] && (this.params[e] = t,
            !0)
        }
    }
    ))
...
, function(e, t) {
    nge.Com.SlotMachine.Controller = nge.Com.Base.extend((function() {
        ...
        this.preload = function() {
            ...
            return this.preloadDefault(t),
            !0
        }
        ,
        this._getService = function() {
            e._service || (e._service = this.getInstance("Service"),
            e._service.init())
        }
        ,
        this.create = function() {
        ...
        ,
        this._subscribe = function() {
            nge.observer.add("brain.openGameSuccess", e._display),
            nge.observer.add("slotMachine.spinResponse", e._doSpin),
            nge.observer.add("slotMachine.spinCommand", e._spinHandler),
            nge.observer.add("slotMachine.spinRequest.fail", e._spinFailHandler),
            nge.observer.add("slotMachine.stopCommand", e._stopHandler),
            nge.observer.add("slotMachine.lastDataRequest", e._lastDataRequest),
            nge.observer.add("slotMachine.animateSymbol", e._animateSymbol),
            nge.observer.add("slotMachine.animateSymbolUnsafe", e._animateSymbolUnsafe),
            nge.observer.add("slotMachine.currentLineDurationCorrection", e._currentLineDurationCorrection),
            nge.observer.add("slotMachine.stopAnimateSymbol", e._stopAnimateSymbol),
            nge.observer.add("slotMachine.holdSymbol", e._holdSymbol),
            nge.observer.add("slotMachine.unholdSymbol", e._unholdSymbol),
            nge.observer.add("slotMachine.unholdAll", e._unholdAll),
            nge.observer.add("slotMachine.holdReel", e._holdReel),
            nge.observer.add("slotMachine.unholdReel", e._unholdReel),
            nge.observer.add("slotMachine.unholdAllReels", e._unholdAllReels),
            nge.observer.add("slotMachine.resetSpinState", e._reset),
            nge.observer.add("winlines.lineHighlite.start", e._service.winLineStartHandler),
            nge.observer.add("winlines.view.startHideAll", e._service.winLineHideAllHandler),
            nge.observer.add("slotMachine.setSymbol", e._setSymbol),
            nge.observer.add("slotMachine.appendSymbol", e._appendSymbol),
            nge.observer.add("slotMachine.changeSymbolPosition", e._changeSymbolPosition),
            nge.observer.add("slotMachine.normalizeReelsSymbolsPositions", e._normalizeReelsSymbolsPositions),
            nge.observer.add("slotMachine.destroySymbol", e._destroySymbol),
            nge.observer.add("slotMachine.updateBlurs", e._updateBlurs),
            nge.observer.add("slotMachine.setSymbolsBlurKeys", e._setSymbolsBlurKeys),
            nge.observer.add("slotMachine.setLastSymbolsBlurStaticKeys", e._setLastSymbolsBlurStaticKeys),
            nge.observer.add("slotMachine.fakeSpins.start", e._fakeSpinsStart),
            nge.observer.add("slotMachine.spinFailed.noBalance", e._spinFailed),
            nge.observer.add("slotMachine.resetMachine", e._resetMachine),
            nge.observer.add("slotMachine.changeBlursSpeed", e._changeBlursSpeed),
            e.customSubscribe()
        }
    }
    ))
...
, function(e, t) {
    nge.Com.SlotMachine.Helper = Class.extend((function() {
        this.setTextureSize = function(e, t, n) {
            return n || (n = this.getInstance("Cfg").get()),
            nge.assets.getQualityFactor(),
            "auto" === n.imageWidth ? e.width = t.width : "number" == typeof n.imageWidth ? e.width = n.imageWidth : "original" === n.imageWidth && nge.Cfg.Main.imagesQualityObeys && (e.width /= nge.assets.getQualityFactor()),
            "auto" === n.imageHeight ? e.height = t.height : "number" == typeof n.imageHeight ? e.height = n.imageHeight : "original" === n.imageHeight && nge.Cfg.Main.imagesQualityObeys && (e.height /= nge.assets.getQualityFactor()),
            e
        }
        ,
        this.getAnimationFrames = function(e) {
            ...
            (e);
            for (var t = [], n = "", i = 0; i < e.count; i++)
                n = nge.Lib.Helper.LdgZero(i, e.ldg),
                t.push(e.prefix + n + e.suffix);
            return t
        }
    }
    ))
...
, function(e, t) {
    nge.Com.SlotMachine.Pool = nge.Com.Base.extend((function() {
        ...
        this.reset = function() {
            for (var t in e)
                for (var n in e[t])
                    e[t][n].destroy && e[t][n].destroy(!0, !0);
            e = {}
        }
        ,
        this.store = function(t, n) {
            t && nge.Lib.Helper.isNumeric(t) && console.warn("nge.Com.SlotMachine.Pool warning - trying to store numeric element (symbol). It can be universal."),
            t || (t = "universal"),
            e[t] || (e[t] = []),
            e[t].push(n)
        }
        ...
        this.release = function(t) {
            ...
            if (!t || !e[t]) {
                ...
                if (i && (n = e.universal.pop()))
                    return n.setSymbolCfg(i),
                    n
            }
            return e[t] ? 0 < e[t].length ? e[t].pop() : n ? void 0 : (console.error("Unable to find object with name " + t),
            !1) : (console.error("No key in pool: ", t),
            console.warn("Please check slotMachine symbols config"),
            !1)
        }
        ,
        this.status = function() {
            ...
            return console.table && console.table(n),
            !0
        }
    }
    ))
...
, function(e, t) {
    nge.Com.SlotMachine.RecyclerReel = nge.Com.Base.extend((function() {
        ...
        this.init = function(t) {
            for (e._index = t.index,
            e._symbolSize = {
                width: t.symbolSize.width,
                height: t.symbolSize.height
            },
            e._height = t.height * t.symbolSize.height,
            e._container = t.container,
            e._templates = t.templates,
            e._symbols = t.symbols,
            e._blurs = t.blurs,
            e._borderSymbolsCount = t.borderSymbolsCount,
            e._currentBlur = 0,
            e._running = !1,
            e._stopping = !1,
            e._onhold = !1,
            ...
            e._stepDuration = 100,
            e._lastSymbols = [],
            e._hideBorderSymbols = t.hideBorderSymbols,
            e._hideTopBorderSymbolsOnStart = t.hideTopBorderSymbolsOnStart,
            e._hideBottomBorderSymbolsOnStart = t.hideBottomBorderSymbolsOnStart,
            e._offsetY = e._container.y,
            e._normalSpeed = t.speed,
            e._intrigueSpeed = t.intrigueSpeed,
            e._speedUpSpeed = t.speedUpSpeed,
            t = 0; t < e._symbols.length; t++)
                e._symbols[t].setSymbolCfg(e._templates[e._blurs[e._currentBlur++]]),
                e._container.addChild(e._symbols[t].texture),
                e._symbols[t].texture.textureZ = 0;
            e.resetPosition(),
            e.switchBorders(!e._hideBorderSymbols)
        }
        ,
        this.resetPosition = function() {
            e._container.y = e._offsetY;
            for (var t = -e._symbolSize.height / 2 - e._symbolSize.height * (e._borderSymbolsCount - 1), n = 0; n < e._symbols.length; n++)
                e._symbols[n].texture.position.set(e._symbolSize.width / 2, t),
                t += e._symbolSize.height;
            e._container.updateTransform()
        }
        ,
        this.start = function(t) {
            t = void 0 === t ? 1 : t,
            e._running || e._onhold || (e._stopping = !1,
            e._running = !0,
            e._lastSymbols = [],
            e.setCounter(999999),
            e.onStart(e, (function() {
                e._tween = nge.tween.add(e._container, !0),
                e.resetPosition(),
                e.switchBorders(!0),
                e.setSpeed(e._normalSpeed),
                e.step(e._stepDuration, t)
            }
            )))
        }
        ,
        ...
        this.stop = function(t, n) {
            e.isRunning() && (e.setCounter(n),
            e._lastSymbols = t)
        }
        ,
        this.speedUp = function() {
            e._stopping || (e._counter = 0),
            e.setSpeed(e._speedUpSpeed)
        }
        ,
        this.setSpeed = function(t) {
            t = void 0 === t ? e._normalSpeed : t,
            e._tween && (e._tween.timeScale = t),
            e._requiredTimeScale = t
        }
        ,
        ...
        this.setSymbolAt = function(t, n) {
            n = e._templates[n],
            t += e._borderSymbolsCount,
            e._symbols[t].setSymbolCfg(n),
            e._symbols[t].texture.textureZ = n.textureZ ? n.textureZ : 0
        }
        ,
        this.sort = function() {
            for (var t = 0; t < e._symbols.length; t++)
                e._symbols[t].texture.textureZ += t;
            e._container.sort("textureZ")
        }
        ,
        this.destroy = function() {
            e._container.destroy(),
            e._tween && e._tween.stop()
        }
        ,
        this.recycle = function(t) {
            0 < (t = void 0 === t ? 1 : t) ? (e._symbols[e._symbols.length - 1].texture.position.y = e._symbols[0].texture.position.y - e._symbolSize.height,
            e._symbols.unshift(e._symbols.pop())) : 0 > t && (e._symbols[0].texture.position.y = e._symbols[e._symbols.length - 1].texture.position.y + e._symbolSize.height,
            e._symbols.push(e._symbols.shift()))
        }
        ,
        this.step = function(t, n) {
            ...
            e._requiredTimeScale && e._tween.timeScale !== e._requiredTimeScale && (e._tween.timeScale = e._requiredTimeScale,
            delete e._requiredTimeScale),
            e._tween.onComplete.addOnce((function() {
                if (e.recycle(n),
                0 < n) {
                    if (0 < e._counter--)
                        return e.loadUpperSymbol(e.nextBlur()),
                        void e.step(t, n);
                    if (e._stopping = !0,
                    0 < e._lastSymbols.length)
                        return e.loadUpperSymbol(e._lastSymbols.pop()),
                        0 === e._lastSymbols.length && (e._counter = e._borderSymbolsCount - 1),
                        void e.step(t, n);
                    e.loadUpperSymbol(e.nextBlur())
                } else {
                    if (0 < e._counter--)
                        return e.loadLowerSymbol(e.previousBlur()),
                        void e.step(t, n);
                    if (0 < e._lastSymbols.length)
                        return e.loadLowerSymbol(e._lastSymbols.shift()),
                        0 === e._lastSymbols.length && (e._counter = e._borderSymbolsCount - 1),
                        void e.step(t, n);
        ...
        this.previousBlur = function() {
            ...
            return -1 === e._currentBlur && (e._currentBlur = e._blurs.length - 1),
            t
        }
        ,
        this.nextBlur = function() {
            var t = e._blurs[e._currentBlur++];
            return e._currentBlur === e._blurs.length && (e._currentBlur = 0),
            t
        }
        ,
        ...
        this.switchBorders = function(t) {
            t = void 0 !== t && t;
            for (var n = 0; n < e._borderSymbolsCount; n++)
                e._symbols[n].texture.visible = t && !e._hideTopBorderSymbolsOnStart,
                e._symbols[e._symbols.length - (n + 1)].texture.visible = t && !e._hideBottomBorderSymbolsOnStart
        }
    }
    ))
}
, function(e, t) {
    nge.Com.SlotMachine.RecyclerView = Class.extend((function() {
        ...
        ,
        this.destroy = function() {
            for (var t = 0; t < e._reels.length; t++)
                e._reels[t].destroy();
            e._reels = []
        }
        ,
        this.destroyReelsContainer = function() {
            ...
            e._holdedSymbolsContainer && (e._holdedSymbolsContainer.destroy(),
            e._holdedSymbolsContainer = null),
            e._reelsContainer.destroy(),
            e.destroy()
        }
        ,
        this.createSlotMachine = function(t, n, i, o) {
            for (console.color("[RV]createSlotMachine", "#ff0000", "#000000"),
            e._cfg = t,
            e._service = n,
            t = 0; t < e._reels.length; t++)
                e._reels[t].destroy();
            for (e._reels = [],
            t = 0; t < i.get().length; t++)
                e._symbols[i.get()[t].name] = i.get()[t];
            e._helper || (e._helper = e.getInstance("Helper")),
            e._container = nge.find("^" + e._cfg.parentName),
            e._reelsContainer = nge.objects.create(new nge.Mlm.Objects.Folder),
            i = e._container.getData(),
            e._container.add(e._reelsContainer),
            e._setSymbolSize(i),
            e._createMask(i),
            e._createReels(i),
            e._createCovers()
        ...
        this._createBlurs = function(t) {
            for (var n = e._cfg.recyclerView.reelBlursSize || 40, i = [], o = 0; o < e._cfg.mw; o++) {
                for (var s = [], a = 0; a < n; a++)
                    t[o] && Array.isArray(t[o]) ? s.push(t[o][nge.Lib.Random.generate_range(0, t[o].length - 1)]) : s.push(t[nge.Lib.Random.generate_range(0, t.length - 1)]);
                i.push(s)
            }
            return i
        }
        ...
        this._createReels = function(t) {
            ...
            if (!e._cfg.mhv) {
                ...
                for (var i = 0; i < e._cfg.mw; i++)
                    e._cfg.mhv.push(e._cfg.mh)
            }
            for (i = 0; i < e._cfg.mw; i++) {
                e._holdedSymbols.push([]);
                var o = []
                  , s = nge.objects.create(new nge.Mlm.Objects.Folder);
                s.x = i * e._symbolSize.width,
                s.y = 0,
                e._cfg.rowsXoffset && e._cfg.rowsXoffset[i] && (s.x += e._cfg.rowsXoffset[i]),
                e._cfg.rowsYoffset && e._cfg.rowsYoffset[i] && (s.y += e._cfg.rowsYoffset[i]);
                for (var a = 0; a < e._cfg.mhv[i] + 2 * e._cfg.recyclerView.borderSymbolsCount; a++) {
                    var r = e.getInstance("Symbol");
                    r.init(t, e._symbolSize, e._container),
                    r.setView(e),
                    o.push(r)
                }
                ...
                a.onStart = e._onReelStart,
                a.onStop = e._onReelStop,
                e._reelsContainer.add(s),
                e._reels.push(a)
            }
        }
        ,
        this._onReelStart = function(t, n) {
            ...
            e.customReelStartCallback(t, i, n),
            nge.observer.fire("slotMachine.reelAnimationStart", t.getIndex(), i),
            nge.observer.fire("slotMachine.reel_" + t.getIndex() + ".animation.start", i)
        }
        ,
        this._onReelStop = function(t, n) {
            e.customReelStopCallback(t, t.getIndex()),
            nge.observer.fire("slotMachine.reel_" + t.getIndex() + ".animation.stop"),
            nge.observer.fire("slotMachine.reel_" + t.getIndex() + ".animation.stopped"),
            e._checkIntrigue(t.getIndex()),
            t = e._reels.filter((function(e) {
                return e.isOnHold()
            }
            )).length,
            ++e._reelsStoped == e._reels.length - t && nge.rafSetTimeout((function() {
        ...
        this._checkIntrigue = function(t) {
            ...
            if (n && n.status) {
                ...
                if (!e._speedUp && i !== e._reels.length) {
                    ...
                    for (var s = 0; s < e._reels.length; s++)
                        e._reels[s].setSpeed();
                    if (i >= o && i < n)
                        for (t += 1; t < e._reels.length; t++)
                            e._reels[t].setSpeed(e._cfg.recyclerView.reelsIntrigueSpeed)
                }
            }
        }
        ,
        this._createMask = function(t) {
            e._maskContainer = nge.findOne("^" + e._cfg.maskName) || e._reelsContainer,
            t = 0 < e._maskContainer.getData().width && 0 < e._maskContainer.getData().height ? e._maskContainer.getData() : t;
            var n = [];
            if (e._cfg.rowsXoffset || e._cfg.rowsYoffset || e._cfg.mhv)
                for (var i = 0; i < e._cfg.mw; i++) {
                    var o = t.width / e._cfg.mw
                      ...
                      , a = i * o
                      , r = 0;
                    e._cfg.rowsXoffset && e._cfg.rowsXoffset[i] && (a += e._cfg.rowsXoffset[i]),
                    e._cfg.rowsYoffset && e._cfg.rowsYoffset[i] && (r += e._cfg.rowsYoffset[i]),
                    e._cfg.mhv && e._cfg.mhv[i] && (s = t.height * e._cfg.mhv[i] / e._cfg.mh),
                    n.push([a, r, o, s])
                }
            else
                n = [0, 0, parseInt(t.width, 10), parseInt(t.height, 10)];
        ...
        this.setSymbol = function(t) {
            e._reels[t.coords[0]].setSymbolAt(t.coords[1], t.key),
            e._reels[t.coords[0]].sort()
        }
        ,
        this.updateBlurs = function() {
            console.color("[RV]updateBlurs", "#00ff00", "#000000");
            for (var t = e._createBlurs(e._cfg.symbolsBlurKeys), n = 0; n < e._reels.length; n++)
                e._reels[n].setBlurs(t[n])
        }
        ,
        ...
        this.displaySymbols = function(t, n) {
            for (console.color("[RV]displaySymbols: " + JSON.stringify(t), "#00ff00", "#000000"),
            n = 0; n < t.length; n++) {
                for (var i = 0; i < e._cfg.mhv[n]; i++)
                    e._reels[n].setSymbolAt(i, t[n][i]);
                e._reels[n].sort()
            }
        }
        ,
        ...
        this.reelSpins = function(t) {
            t = void 0 === t ? "forward" : t,
            e._spinDirection = t,
            e._requestStartTime = nge.Lib.Time.get(),
            e._speedUp = !1;
            for (var n = e._reelsStoped = 0; n < e._reels.length; n++)
                e._reels[n].start("forward" === t ? 1 : -1)
        }
        ,
        this.setNewReelsCfg = function(t) {
            ...
            for (var o = e.getIntrigueStopCounters(), s = 0; s < n.length; s++)
                n[s] += o[s];
            for (o = n[0],
            s = 0; s < n.length; s++)
                n[s] < o && (o = n[s]);
            for (i = Math.max(0, Math.min(i, o) - e._cfg.recyclerView.reelsMinStopCounter),
            o = 0; o < e._reels.length; o++)
                e._reels[o].stop(t[o].slice(0, e._cfg.mhv[o]), n[o] - i)
        }
        ,
        this.getBaseStopCounters = function() {
            for (var t = e._cfg.recyclerView.reelsStopCounter.slice(), n = 0; n < e._reels.length; n++)
                e._reels[n].isOnHold() && t.splice(n, 0, 0);
            ...
            for (var i = 0; i < t.length; i++)
                if (i >= n.startsFrom && i < n.endsFrom)
                    for (var o = i; o < t.length; o++)
                        t[o] += e._cfg.recyclerView.intrigueAdditionalCounter;
            return t
        }
        ,
        ...
        this._createCovers = function() {
            ...
            for (var n = 0; n < this._cfg.mw; n++) {
                ...
                this._cfg.rowsXoffset && (e = this._cfg.rowsXoffset[n]),
                this._cfg.rowsYoffset && (t = this._cfg.rowsYoffset[n]);
                for (var o = 0; o < i; o++) {
        ...
        this.showAnimationSymbolsCover = function(t) {
            e._covers && e._covers[t.reel] && e._covers[t.reel][t.row] && ((t = e._covers[t.reel][t.row]).visible = !0,
            e._container.bringToTop(t))
        }
        ,
        ...
        this.holdSymbol = function(t, n) {
            ...
            var i = n.getName();
            n = n.texture,
            e._holdedSymbolsContainer || (e._holdedSymbolsContainer = nge.objects.create(nge.Mlm.Objects.Folder({
                name: "holdedSymbolsContainer"
            }), e._container)),
            i = nge.objects.create(nge.Mlm.Objects.Image({
                ...
                anchorX: .5,
                anchorY: .5
            }), e._holdedSymbolsContainer),
            e._holdedSymbols[t.reel][t.row] = i
        }
        ,
        this.unholdSymbol = function(t) {
            console.color("[RV]unholdSymbol", "#00ff00", "#000000"),
            t || console.error("nge.Com.SlotMachine.View.unholdSymbol error: no symbolPosition"),
            e._holdedSymbols[t.reel][t.row] && (e._holdedSymbols[t.reel][t.row].destroy(!0),
            e._holdedSymbols[t.reel][t.row] = null)
        }
        ,
        this.unholdAll = function() {
            for (var t in console.color("[RV]unholdAll", "#00ff00", "#000000"),
            e._holdedSymbols)
                for (var n in e._holdedSymbols[t])
                    e.unholdSymbol({
                        reel: t,
                        row: n
                    })
        ...
        ,
        this.customReelStopCallback = function(e, t) {}
        ,
...
, function(e, t) {
    nge.Com.SlotMachine.Service = Class.extend((function() {
        var e, t, n, i, o, s, a = !1;
        this._cfg = this._view = null,
        this.init = function() {}
        ,
        this.preload = function() {
            return o = (e = this).getInstance("Helper"),
            t = this.getInstance("Cfg").get(),
            e._cfg = t,
            this._getView(),
            i = this.getInstance("Symbols"),
            s = this.getInstance("Tpl"),
            e._symbolsPreload(),
            this._customPreload(),
            s
        }
        ...
        this.create = function(n) {
            return this.reset(),
            e._view.createSlotMachine(t, e, i, n),
            (n = nge.localData.get("slotMachine")) && e.display(n),
            !0
        }
        ,
        this.deactivate = function() {
        ...
        this.display = function(t) {
            return nge.localData.set("slotMachine", t),
            a || (t = e._getInitialSymbols(t),
            e._view.displaySymbols(t.symbols, t.isHistory)),
            !0
        }
        ,
        ...
        this.stopHandler = function() {
            return !!a && (e._view.speedUpReels(),
            !0)
        }
        ,
        this.animateSymbol = function(t, n) {
            return !(a && !n) && (e._view.showAnimationSymbolsCover(t),
            !(!(t = e._view.getSymbolByPosition(t)) || !t.animate) && (t.animate(),
            !0))
        }
        ,
        ...
        this.stopAnimateSymbol = function(t) {
            return !(!(t = e._view.getSymbolByPosition(t)) || !t.cancelAnimation) && (t.cancelAnimation(),
            !0)
        }
        ,
        this.changeBlursSpeed = function(t) {
            return !!a && (e._view.changeBlursSpeed(t),
            !0)
        }
        ,
        ...
        this._doSpin = function(t) {
            return n = t,
            nge.localData.set("slotMachine", t),
            e._view.setNewReelsCfg(t.spinResult.columns),
            !0
        }
        ,
        ...
        this.winLineStartHandler = function(t) {
            if (!t || !t.wonSymbols)
                return !1;
            for (var n, i = t.wonSymbols, o = [], s = 0; s < i.length; s++)
                (n = e._view.getSymbolByPosition({
                    reel: i[s][0],
                    row: i[s][1]
                })) && o.push(n.getName());
        ...
        this._setSpinning = function(e) {
            a = e,
            nge.localData.set("slotMachineSpinning", e)
        }
        ,
        this._symbolsPreload = function() {
            for (var e, n = 0 === t.symbolsBlurKeys.length, a = t.imgPath, r = i.get(), l = 0; l < r.length; l++) {
                if (n && t.symbolsBlurKeys.push(r[l].name),
                s.assets.contents.push({
                    type: mt.assets.IMAGE,
                    block: mt.assets.blocks.STATIC,
                    fullPath: a + r[l].textureUrl,
                    key: r[l].name
                }),
                r[l].animationFramesAuto && (r[l].animationFrames = o.getAnimationFrames(r[l].animationFramesAuto)),
                r[l].animationFrames)
                    for (e = 0; e < r[l].animationFrames.length; e++)
                        s.assets.contents.push({
                            type: mt.assets.IMAGE,
                ...
                if (r[l].animationSprite) {
                    ...
                    if (r[l].multipack)
                        for (var u = 0; u < r[l].multipack; u++)
                            e = r[l].framesInLastSprite && u === r[l].multipack - 1 ? r[l].framesInLastSprite : -1,
                            s.assets.contents.push({
                                type: mt.assets.IMAGE,
                                block: mt.assets.blocks.SYMBOLS_ANIMATION,
        ...
        this._getInitialSymbols = function(e) {
            ...
            return "history" === nge.statesManager.getCurrentName() && n ? (t.symbols = n,
            t.isHistory = !0,
            t) : ((n = !!(e.gameParameters && e.gameParameters.initialSymbols && e.gameParameters.initialSymbols.length) && e.gameParameters.initialSymbols) && (n = nge.Lib.Helper.rowsToColumns(n)),
            !n && e.spinResult && e.spinResult.columns && (n = e.spinResult.columns),
            n || (n = _view.getRandomSymbolsTable()),
            t.symbols = n,
            t)
        }
        ,
...
, function(e, t) {
    nge.Com.SlotMachine.SymbolBase = Class.extend((function() {
        ...
        this._subscribed = this._animationCreated = !1,
        this._spritesList = [],
        this._frames,
        this._name,
        this._repeat,
        this._animateNonStop,
        this._frameTime,
        this._initialScale = {
            x: 1,
            y: 1
        ...
        this.setSymbolBase = function(t) {
            if (e._symbolConfig = t,
            void 0 === e._symbolConfig.animationMainTextureNeed && (e._symbolConfig.animationMainTextureNeed = !0),
            void 0 === e._symbolConfig.animationOnTop && (e._symbolConfig.animationOnTop = !0),
            e._repeat = t.repeat || 1,
            e._frameTime = t.frameTime || 30,
            e._texture)
                e._texture.loadTexture(t.name),
                e._texture.visible = !0,
                e._texture.getData().name = "smSymbol_" + t.name + "_" + e._sid,
                e._texture.getData().class = t.name;
            else {
            ...
            e.texture = e._texture,
            e._textureAnimation = !1,
            e._animationCreated = !1,
            e._originalParams = {
        ...
        this.destroy = function(t) {
            e._unsubscribe(),
            t && (e._texture && e._texture.destroy(),
            e._textureAnimation && e._textureAnimation.destroy())
        }
        ,
        ...
        ,
        this.reset = function() {
            return e._animateNonStop = !1,
            e._tween && (e._tween.stop(),
            e._tween = null,
            delete e._tween,
            e._textureAnimation && e._textureAnimation.loadTexture(e._name)),
            e._animationCheck(),
            !!e._textureAnimation && (e._textureAnimation.alpha = e._originalParams.alpha,
            e._textureAnimation.scale.x = e._originalParams.scale.x,
            e._textureAnimation.scale.y = e._originalParams.scale.y,
            !0)
        }
        ,
        ...
        this.animate = function(t) {
            return e._symbolConfig.animationRelaunchOnWinlinesCycle && e._cancelAnimation(),
            void 0 !== e._texture && void 0 !== e._texture.parent && e._texture && e._texture.parent ? (e._subscribed || e._subscribe(),
            e._animationCreated || e._animationCreate(),
            e._subscribed = !0,
            e._animationCreated = !0,
            e.textureAnimationShow(t),
            e._tween || e._createTween(),
            e._tween.isRunning || e._tween.start(),
            e._symbolConfig.animateAllWinlinesCycle && (e._animateNonStop = !0),
            !0) : (console.warn("nge.Com.SlotMachine.Symbol.animate error", e._symbolConfig),
            !1)
        }
        ,
        this.textureAnimationShow = function(t) {
            e._textureAnimation.x = e._texture.x + e._texture.parent.x,
            e._textureAnimation.y = e._texture.y + e._texture.parent.y,
            e._textureAnimation.visible = !0,
            e._texture.visible = !1,
            !t && e._symbolConfig.animationOnTop && e._smContainer.bringToTop(e._textureAnimation)
        }
        ,
        this.animationCreate = this._animationCreate = function() {
            ...
            if (e._textureAnimation = nge.objects.create(t, e._smContainer, !0),
            e._symbolConfig.animationSprite)
                if (t = e._symbolConfig.animationSpriteExtension || "png",
                e._symbolConfig.multipack)
                    for (var n = 0; n < e._symbolConfig.multipack; n++)
                        e._spritesList.push(nge.wrap.cache.getImage(e._symbolConfig.name + n + "." + t));
                else
                    e._spritesList.push(nge.wrap.cache.getImage(e._symbolConfig.name + "." + t));
            e._createTween()
        }
        ,
        ...
        this._createScaleTween = function() {
            return e._tween = nge.tween.add(e._textureAnimation.scale, !0),
            e._initialScale.x = e._textureAnimation.scale.x,
            e._initialScale.y = e._textureAnimation.scale.y,
            e._tween.to({
        ...
        this._createFramesTween = function(t) {
            var n = e._frameTime
              , i = t.length;
            e._frames = t,
            e._tween = nge.tween.add({
                x: 0
            }, !0),
            e._tween.enableUpdate = !0,
            t = e._repeat;
            for (var o = 0; o < t; o++)
                e._tween.to({
                    x: i
            ...
            return e._tween.onUpdateCallback((function(t, n, i) {
                ...
                e._animateNonStop && e._symbolConfig.animationMainTextureNeed && e._textureAnimation.loadTexture(e._name),
                e._symbolConfig.animateAllWinlinesCycle || e.reset(),
                e._animationEndHandler()
            }
            )),
            !0
        ...
        this._createSpriteTween = function() {
            ...
            for (var i = 0; i < e._spritesList.length; i++) {
                for (var o = 0; o < e._spritesList[i].frameData._self._frames.length; o++) {
                    ...
                    s.spriteName = e._spritesList[i].key,
                    s.startsFrom = n,
                    e._frames.push(s)
                }
            ...
            e._tween.enableUpdate = !0,
            e._symbolConfig.animationMainTextureNeed || (e._textureAnimation.loadTexture(e._frames[0].spriteName),
            e._textureAnimation.frame = 0),
            s = e._repeat,
            i = 0; i < s; i++)
                e._tween.to({
                    x: n
            ...
            return e._tween.onUpdateCallback((function(t, n, i) {
                t = ~~(i.percent * i.vEnd.x),
                e._textureAnimation.loadTexture(e._frames[t].spriteName),
                e._textureAnimation.frame = t - e._frames[t].startsFrom
            }
            )).onComplete.add((function() {
                e._animateNonStop && e._symbolConfig.animationMainTextureNeed && e._textureAnimation.loadTexture(e._name),
                e.reset(),
        ...
        this._hideAnimation = function() {
            e._animateNonStop || (e._texture.visible = !0,
            e._textureAnimation && (e._textureAnimation.visible = !1),
            e.reset(),
            e._subscribed && (e._unsubscribe(),
            e._subscribed = !1))
        }
        ,
        ...
        ,
        this._subscribe = function() {
            nge.observer.add("slotMachine.symbols.cancelAnimation", e._cancelAnimation, "slotMachine.symbol." + e._sid + ".cancel"),
            nge.observer.add("slotMachine.symbols.cancelAnimationLoop", e._cancelAnimationLoop, "slotMachine.symbol." + e._sid + ".cancel"),
            nge.observer.add("winlines.view.startHideAll", e._hideAnimation, "slotMachine.symbol." + e._sid + ".hide"),
            nge.observer.add("winlines.stoppingAnimation.start", e._stopLinesAnimation, "slotMachine.symbol." + e._sid + ".stop")
        }
        ,
        this._unsubscribe = function() {
            nge.observer.remove("slotMachine.symbols.cancelAnimation", !1, "slotMachine.symbol." + e._sid + ".cancel"),
            nge.observer.remove("slotMachine.symbols.cancelAnimationLoop", !1, "slotMachine.symbol." + e._sid + ".cancel"),
            nge.observer.remove("winlines.view.startHideAll", !1, "slotMachine.symbol." + e._sid + ".hide"),
            nge.observer.remove("winlines.stoppingAnimation.start", !1, "slotMachine.symbol." + e._sid + ".stop")
        }
    }
    ))
}
, function(e, t) {
    nge.Com.SlotMachine.Symbol = nge.Com.SlotMachine.SymbolBase.extend((function() {
        ...
        this._sid,
        this.init = function(n, i, o, s) {
            return t._sid = nge.Lib.Helper.getRandomInt(0, 999999),
            e = i,
            t._smContainer = o,
            n && t.setSymbolCfg(n),
            s && (t.animate = function() {}
            ,
            t._subscribe = function() {}
            ),
            !0
        }
        ,
        ...
        ,
        this.setSymbolCfg = function(e) {
            t._symbolConfig = e;
            var o = t.getInstance("Symbol" + e.name);
            if (t._cleanup(),
            o) {
                for (var s in n = nge.Lib.Helper.mergeArrs(Object.keys(o), n),
                o)
                    t[s] && (i[s] = t[s]),
                    t[s] = o[s];
        ...
        this._cleanup = function() {
            t.reset && t.reset(),
            t._clearKeys(),
            t._tween && (t._tween.stop(),
            t._tween = null),
            t._textureAnimation && t._textureAnimation.destroy()
        }
        ,
...
, function(e, t) {
    nge.Com.SlotMachine.View = Class.extend((function() {
        var e, t, n, i, o, s, a, r, l = this, c = 0, u = [], g = [], f = [], p = [], b = [], m = !1, h = !1, d = {}, y = {}, _ = !1, v = !1, x = !1, w = [], C = "forward";
        this._cfg,
        this._pool,
        this._symbolSize,
        this._reelsSymbols,
        ...
        this.createSlotMachine = function(o, s, r, c) {
            ...
            a = s,
            c || (l._clearOldPool(),
            l._pool = l.getInstance("Pool")),
            e = l.getInstance("Helper"),
            t = r,
            l._calcTextureZNeed(),
            l._resetGlobals(o, c),
            o = (n = nge.find("^" + l._cfg.parentName)).getData(),
            i = nge.objects.create(new nge.Mlm.Objects.Folder),
            l._setSymbolSize(o),
            l._maskCreate(),
            n.add(i),
            l._reelsSymbolsCreate(),
            c || (l._symbolsCreate(),
            l._createBlurs(),
            l._createTempBlurs()),
            l._createAnimationSymbolsCovers(),
            !0
        }
        ,
        ...
        this._calcTextureZNeed = function() {
            for (var e = t.get(), n = 0; n < e.length; n++)
                e[n].textureZ && (x = !0)
        }
        ,
        this.setSymbol = function(e) {
            ...
            l._storeSymbol(n, t),
            e = l._pool.release(e),
            l._reelsSymbols[n][t] = e,
            l._setDefaultCoords(e.texture, {
                row: t
            }),
            o[n].addChild(e.texture),
            l._displaySymbolCallback(e, o[n]),
            x) {
        ...
        this.displaySymbols = function(e, t) {
            if (!n)
                return !1;
            l._storeSymbols(),
            l._customClearSymbols();
            for (var i = 0; i < l._cfg.mw; i++) {
                o[i].removeChildren();
                for (var s = l._getMH(i), a = 0; a < s; a++) {
                    var r = l._pool.release(e[i][a]);
                    if (l._reelsSymbols[i][a] = r,
                    l._setDefaultCoords(r.texture, {
                        row: a
                    }),
                    o[i].addChild(r.texture),
                    l._displaySymbolCallback(r, o[i], t),
                    x) {
        ...
        this.reelSpins = function(e) {
            ...
            for (var t = 0, n = 0; n < l._cfg.mw; n++)
                if (y[n])
                    0 === n && (e = !0),
                    l._cfg.blursShiftOnReelsHold || t++;
                else {
                    var i = o[n]
                      , s = "blur-" + t
                      , a = l._pool.release(s);
                    a._sysSmName = s,
                    l._appendBlur(i, n, a),
                    l._startReelTween(i, n, a, t),
                    t++
                }
            return e && l._reelAnimationComplete(!1, 0),
            !0
        }
        ,
        ...
        ,
        this.speedUpReels = function() {
            for (var e in l._speedReelsCustom = [],
            g) {
                var t = g[e];
        ...
        this.changeBlursSpeed = function(e) {
            for (var t in g) {
                var n = g[t]
                  , i = e[t] ? e[t] : e;
                n.timeScale && (n.timeScale = i),
                l._speedReelsCustom[t] = i
            }
        }
        ,
        this.showAnimationSymbolsCover = function(e) {
            var t;
            if (u && u[e.reel] && (t = u[e.reel][e.row]),
            !t)
                return !1;
            t.visible = !0,
            n.bringToTop(t)
        ...
        this.holdSymbol = function(e, t) {
            ...
            i = nge.objects.create(i, _),
            d[e.reel][e.row] = i
        }
        ,
        this.unholdSymbol = function(e) {
            e || console.error("nge.Com.SlotMachine.View.unholdSymbol error: no symbolPosition"),
            d[e.reel] || (d[e.reel] = {}),
            l._destroyHold(e.row, e.reel)
        }
        ,
        this.unholdAll = function() {
            for (var e in d)
        ...
        ,
        this.destroySymbol = function(e, t) {
            if (!l._reelsSymbols[e.reel][e.row])
                return console.error("nge.Com.SlotMachine.View destroySymbol error: no symbol in this position"),
                !1;
            var n = function() {
                l._storeSymbol(e.reel, e.row),
                nge.observer.fire("slotMachine.destroySymbolComplete", e)
            };
            return t || (t = n),
            t(l._reelsSymbols[e.reel][e.row], e, n)
        }
        ,
        this.normalizeReelsSymbolsPositions = function(e) {
        ...
        ,
        this.changeSymbolPosition = function(e, t, n, i) {
            if (!l._reelsSymbols[e.reel][e.row] || l._reelsSymbols[t.reel][t.row])
                return console.error("nge.Com.SlotMachine.View changeSymbolPosition error: wrong incoming data"),
                !1;
            var o = l._reelsSymbols[e.reel][e.row];
            l._reelsSymbols[t.reel][t.row] = o,
            l._setDefaultCoords(o.texture, t),
            delete l._reelsSymbols[e.reel][e.row];
            var s = function() {
                n && n(),
                nge.observer.fire("slotMachine.changeSymbolPositionComplete", e)
            };
            return i || (i = s),
            i(o, e, t, s)
        }
        ...
        this.appendSymbol = function(e, t, n) {
            if (l._reelsSymbols[e.reel][e.row])
                return console.error("nge.Com.SlotMachine.View appendSymbol error: symbol already exists in this position"),
                !1;
            var i = o[e.reel];
            if (t = l._pool.release(t),
            l._reelsSymbols[e.reel][e.row] = t,
            l._setDefaultCoords(t.texture, e),
            i.addChild(t.texture),
            x) {
                var s = t.getConfig().textureZ ? t.getConfig().textureZ : 0;
                t.texture.z = s,
                t.texture.z += .01 * e.row,
                i.sort()
            }
            return i = function() {
        ...
        this._setDefaultCoords = function(e, t) {
            e.y = (t.row + .5) * l._symbolSize.height,
            e.x = l._symbolSize.width / 2
        }
        ,
        this._destroyHold = function(e, t) {
            d[t][e] && (d[t][e].destroy(!0),
            d[t][e] = null)
        }
        ,
        this._getMH = function(e) {
            var t = l._cfg.mh;
            return l._cfg.mhv && (t = l._cfg.mhv[e]),
            t
        }
        ,
        this._createAnimationSymbolsCovers = function() {
            for (var e = 0, t = 0, i = 0; i < l._cfg.mw; i++) {
                u[i] = [];
                var o = l._getMH(i);
                l._cfg.rowsXoffset && (e = l._cfg.rowsXoffset[i]),
                l._cfg.rowsYoffset && (t = l._cfg.rowsYoffset[i]);
                for (var s = 0; s < o; s++) {
        ...
        this._resetGlobals = function(e, t) {
            ...
            c = 0,
            v = h = !1,
            l._pool && !t && l._pool.reset()
        }
        ,
        this._storeSymbols = function() {
            if (!l._reelsSymbols || !l._reelsSymbols.length)
                return !1;
            for (var e = 0; e < l._reelsSymbols.length; e++)
                for (var t = 0; t < l._reelsSymbols[e].length; t++)
                    l._storeSymbol(e, t);
            return !0
        }
        ,
        this._storeSymbol = function(e, t) {
            if (!(l._reelsSymbols && l._reelsSymbols.length && l._reelsSymbols[e] && l._reelsSymbols[e][t]))
                return !1;
            o[e].remove(l._reelsSymbols[e][t].texture),
            l._reelsSymbols[e][t].reset(),
            l._pool.store(!1, l._reelsSymbols[e][t]),
            l._reelsSymbols[e][t] = null
        }
        ,
        this._maskCreate = function() {
            ...
            t || (t = i),
            e = t && 0 < t.getData().width && 0 < t.getData().height ? t.getData() : e;
            var o = [];
            if (l._cfg.rowsXoffset || l._cfg.rowsYoffset || l._cfg.mhv)
                for (var s = 0; s < l._cfg.mw; s++) {
                    var a = e.width / l._cfg.mw
                      ...
                      , c = s * a
                      , u = 0;
                    l._cfg.rowsXoffset && l._cfg.rowsXoffset[s] && (c += l._cfg.rowsXoffset[s]),
                    l._cfg.rowsYoffset && l._cfg.rowsYoffset[s] && (u += l._cfg.rowsYoffset[s]),
                    l._cfg.mhv && l._cfg.mhv[s] && (r = e.height * l._cfg.mhv[s] / l._cfg.mh),
                    o.push([c, u, a, r])
                }
            else
                o = [0, 0, e.width, e.height];
        ...
        this._reelsSymbolsCreate = function() {
            for (var e, t = i.parent.getData(), n = 0; n < l._cfg.mw; n++)
                (e = nge.objects.create(new nge.Mlm.Objects.Folder)).width = l._symbolSize.width,
                e.height = t.height,
                e.x = n * l._symbolSize.width,
                e.y = 0,
                l._cfg.rowsXoffset && l._cfg.rowsXoffset[n] && (e.x += l._cfg.rowsXoffset[n]),
                l._cfg.rowsYoffset && l._cfg.rowsYoffset[n] && (e.y += l._cfg.rowsYoffset[n]),
                i.add(e),
                o.push(e),
                l._reelsSymbols.push([]),
                s.push([])
        }
        ,
        ...
        this._createTempBlurs = function() {
            for (var e = l._cfg.symbolsBlurKeys, t = 0; t < 3 * l._cfg.mw; t++)
                l._cfg.symbolsBlurKeys && l._cfg.symbolsBlurKeys[t] && "object" == typeof l._cfg.symbolsBlurKeys[t] && (e = l._cfg.symbolsBlurKeys[t]),
                l._createTempBlur(e)
        }
        ,
        this._createTempBlur = function(e, t) {
            t = t || "blurTemp",
            (e = l._createBlur(l._cfg.mh, e)).key = t,
            l._pool.store(t, e)
        }
        ,
        this._createBlurs = function() {
            for (var e, t = l._cfg.symbolsBlurKeys, n = l._cfg.lastSymbolsBlurStaticKeys, i = 0; i < l._cfg.mw; i++)
                l._cfg.symbolsBlurKeys && l._cfg.symbolsBlurKeys[i] && "object" == typeof l._cfg.symbolsBlurKeys[i] && (t = l._cfg.symbolsBlurKeys[i]),
                l._cfg.lastSymbolsBlurStaticKeys && void 0 !== l._cfg.lastSymbolsBlurStaticKeys[i] && (n = l._cfg.lastSymbolsBlurStaticKeys[i]),
                l._pool.check("blur-" + i) && l._destroyBlur("blur-" + i),
                e = l._createBlur("number" == typeof l._cfg.th ? l._cfg.th : l._cfg.th[i], t, n),
                l._pool.store("blur-" + i, e)
        }
        ,
        this._destroyBlur = function(e) {
            return (e = l._pool.release(e)).texture.destroy(!0, !0),
            e.destroy(!0, !0),
            e.key = !1,
            e.game = !1,
            !0
        ...
        this._getBlurKeys = function(e, t) {
            for (var n = [], i = !1, o = function(e) {
                if (0 === t.length)
                    return console.error("nge.Com.SlotMachine.View _createBlur getBlurRandomKey error: symbolsKeys.length = 0"),
                    !1;
                if (1 === t.length)
                    return t[0];
        ...
        this._createBlur = function(n, i, o) {
            ...
            for (var g = 0; g < n; g++) {
                ...
                e.setTextureSize(p, l._symbolSize, l._cfg),
                p.width > u && (u = p.width),
                p.position.y = (g + .5) * l._symbolSize.height,
                p.anchor.x = 0,
                p.anchor.y = .5,
                p.alpha = s;
                var b = t.get();
                ...
                p.z = (b.textureZ ? b.textureZ : 0) + .01 * g),
                c[g] = p
            }
            for (g = 0; g < n; g++)
                (p = c[g]).position.x = (u - p.width) / 2,
                a.addChild(p);
            return x && a.sort(),
            a.scale.x = 1 / r.worldScale.x,
            a.scale.y = 1 / r.worldScale.y,
            o = nge.objects.generateTexture(a),
            (n = nge.objects.create(new nge.Mlm.Objects.Image({
                assetKey: "1px_empty",
                class: "_slotMachineBlur"
            }), null, !0, !0)).loadTexture(o),
            n.scale.set(1, 1),
            n.x = l._symbolSize.width / 2,
            n.anchor.x = .5,
            a.destroy({
                children: !0,
                texture: !1,
        ...
        this._getReelOffsetY = function(e) {
            var t = 0;
            return l._cfg.rowsYoffset && l._cfg.rowsYoffset[e] && (t = l._cfg.rowsYoffset[e]),
            t
        }
        ,
        this._startReelTween = function(e, t, n, i) {
            ...
            return i && "linear" === s.animationType ? (s = (n.height + l._symbolSize.height * o) / (u - c),
            f[t] = s,
            b.to({
                y: m
            ...
            0 < s.blur ? b.to({
                y: m
            }, r, nge.Lib.Tween.Easing.Linear.None, !1) : e.y = m),
            i ? (b.onStart.addOnce((function() {
                nge.observer.fire("slotMachine.reelAnimationStart", t, a),
                nge.observer.fire("slotMachine.reel_" + t + ".animation.start", a)
            }
            )),
            ...
            b.onComplete.addOnce((function(i, o, s, a) {
                l._reelAnimationStepEnd(e, t, n)
            }
            ), this),
            b.start()) : l._reelAnimationComplete(e, t, n),
            !0
        }
        ,
        this._appendBlur = function(e, t, n) {
            ...
            n.y = "forward" === C ? -n.height : i * l._symbolSize.height + o,
            e.addChild(n),
            p[t] = n
        }
        ,
        this._reelAnimationStepEnd = function(e, t, n) {
            ...
            if (r && i && i.status && !i.done) {
                ...
                var o = 1;
                for (n = i.startsFrom; n < l._cfg.mw; n++)
                    h[n] += 5 * o,
                    o++;
                v = !0
            }
            if (o = nge.localData.get("slotMachineAdditionalBlurs"),
            r && o)
                for (n = 0; n < o.length; n++)
                    o[n] && (h[n] += o[n]),
                    0 > h[n] && (h[n] = 0);
            if (nge.localData.set("slotMachineAdditionalBlurs", !1),
            r && (m || 0 >= h[t]))
                return l._reelSpinsFinish(t),
                !1;
            if (0 === t && 0 === h[0])
                for (n = 0; n < l._cfg.mw; n++)
                    h[n]++;
            if (h[t]--,
            !m && v && !l._speedReelsCustom[t] && g[t - 1] && !g[t - 1].isRunning)
                for (o = i.endsFrom ? i.endsFrom : l._cfg.mw,
                n = i.startsFrom; n < o; n++)
                    i = l._cfg.intrigueSpeedReelsFactor,
                    l._speedReelsCustom[n] = i,
                    g[n] && (g[n].timeScale = i);
            if (b[t] || (b[t] = []),
            n = nge.localData.get("slotMachineAdditionalBlursKeys"),
            i = "blurTemp",
            r && n && n[t] && n[t][h[t]] && (i = n[t][h[t]]),
            !(i = l._pool.release(i)))
                return !1;
            for (o = 1 / 0,
            ...
            i.y = "forward" === C ? o.y - n : o.y + o.height,
            e.addChild(i),
            2 < b[t].length && (n = b[t].shift(),
            e.removeChild(n),
            l._pool.store(n.key ? n.key : "blurTemp", n)),
            p[t] && e.y >= p[t].height + i.height && l._storingMainBlur(e, t),
            l._storeOldSymbols(e, t),
            n = l._getReelOffsetY(t),
            i = l._getMH(t),
            l._newSymbolsAnimate(e, t, l._reelAnimationStepEnd, "forward" === C ? n : e.y - l._symbolSize.height * i + n)
        }
        ,
        this._reelAnimationComplete = function(e, t) {
            if (nge.observer.fire("slotMachine.reel_" + t + ".animation.stop"),
            e) {
                if (l._storeOldSymbols(e, t),
                l._reelsSymbols[t] = s[t],
                l._storingMainBlur(e, t),
                b[t]) {
                    for (var n = 0; n < b[t].length; n++) {
                        var i = b[t][n];
                        e.removeChild(i),
                        l._pool.store(i.key ? i.key : "blurTemp", i)
                    }
                    b[t] = []
                }
                for (n = 0,
                l._cfg.rowsYoffset && l._cfg.rowsYoffset[t] && (n = l._cfg.rowsYoffset[t]),
                e.y = n,
                n = 0; n < l._reelsSymbols[t].length; n++)
                    l._setDefaultCoords(l._reelsSymbols[t][n].texture, {
                        row: n
                    })
            }
            l._reelStopCallback(e, t),
            nge.observer.fire("slotMachine.reel_" + t + ".animation.stopped"),
            y[t + 1] && l._reelAnimationComplete(!1, t + 1)
        }
        ,
        ...
        this.customReelStopCallback = function(e, t) {}
        ,
        this._increaseReelsY = function(e, t) {
            t = e.y;
        ...
        this._storeOldSymbols = function(e, t) {
            for (var n, i = 0; i < l._reelsSymbols[t].length; i++)
                n = l._reelsSymbols[t][i],
                e.removeChild(n.texture),
                l._pool.store(!1, n);
        ...
        this._reelStopCallback = function(e, t) {
            c++,
            l.customReelStopCallback(e, t),
            c === l._reelsSymbols.length && (g = [],
            c = 0,
            v = h = !1,
            nge.rafSetTimeout((function() {
        ...
        this._reelSpinsFinish = function(e) {
            var t = o[e];
            return l._appendNewSymbols(t, e, r[e]),
            l._newSymbolsAnimate(t, e, l._reelAnimationComplete),
            l.reelSpinsFinishTweenOnUpdateCallback && g[e].onUpdateCallback(l.reelSpinsFinishTweenOnUpdateCallback, this),
            !0
        }
        ,
        this.reelSpinsFinishTweenOnUpdateCallback = this.reelSpinsStartTweenOnUpdateCallback = !1,
        this._appendNewSymbols = function(e, t, n) {
            var i = 0
              , o = e.children[e.children.length - 1];
            0 < e.children.length && (i = e.children[e.children.length - 1].y),
            s[t] = [];
            for (var a = l._getMH(t), r = 0; r < a; r++) {
                var c = l._pool.release(n[r]);
                if (s[t].push(c),
                c.texture.y = "forward" === C ? (r + .5 - a) * l._symbolSize.height + i : (r + .5) * l._symbolSize.height + i + o.height,
                c.texture.x = l._symbolSize.width / 2,
                e.addChild(c.texture),
                x) {
        ...
        this._newSymbolsAnimate = function(e, t, n, i) {
            ...
            var a = 1;
            l._speedReelsCustom[t] ? a = l._speedReelsCustom[t] : m && (a = l._cfg.speedUpReelsFactor),
            "custom" === l._cfg.tweenType ? s = g[t] : (s = nge.tween.add(e),
            g[t] = s),
            "linear" === o.animationType ? s.to({
                y: i
            }, Math.abs(i - e.y) / f[t], nge.Lib.Tween.Easing.Linear.None, !0) : 0 < w[t] ? s.to({
                y: i
            }, w[t], nge.Lib.Tween.Easing.Quartic.Out, !0) : e.y = i,
...
, function(e, t) {
    nge.Com.SpinButton.Controller = nge.Com.Base.extend((function() {
        ...
        this.create = function() {
            ...
            this.createDefault(),
            e || o._subscribe(),
            t = nge.find("^spinButton"),
            n = nge.find("^stopButton"),
            i = nge.find("^freeSpinButton");
            var s = nge.localData.get("brain.restoreGame");
            return s && s.lastResponse && "FreeSpinReady" === s.lastResponse.state && o._spinButtonDisable(),
            e = !0
        }
        ,
        this._spinRegular = function() {
            ...
            i.visible = !1,
            t.visible = !0,
            o.addClass("spinTextSpin"),
            o.removeClass("spinTextFree"),
            o.removeClass("disableText"),
            e ? (o.visible = !1,
            nge.find("^freeGameButtonTextFree").visible = !0,
            nge.find("^freeGameButtonTextFree").addClass("spinTextSpin"),
            nge.find("^freeGameButtonTextFree").removeClass("spinTextFree"),
            nge.find("^freeGameButtonTextFree").removeClass("disableText"),
            nge.find("^freeGameButtonTextGame").visible = !0,
            nge.find("^freeGameButtonTextGame").addClass("spinTextSpin"),
            nge.find("^freeGameButtonTextGame").removeClass("spinTextFree"),
            nge.find("^freeGameButtonTextGame").removeClass("disableText")) : (o.visible = !0,
            nge.find("^freeGameButtonTextFree").visible = !1,
            nge.find("^freeGameButtonTextGame").visible = !1)
        }
        ,
        ...
        this._spinButtonEnable = function() {
            ...
            nge.find("^freeGameButtonTextFree").removeClass("disableText"),
            nge.find("^freeGameButtonTextGame").visible = !0,
            nge.find("^freeGameButtonTextGame").removeClass("disableText")) : (e.visible = !0,
            nge.find("^freeGameButtonTextFree").visible = !1,
            nge.find("^freeGameButtonTextGame").visible = !1)
        }
        ,
        this._spinButtonDisable = function() {
            ...
            e && e.disable(3),
            (e = nge.find("^spinButtonText")).addClass("disableText"),
            nge.localData.get("freeGame.inProgress") ? (e.visible = !1,
            nge.find("^freeGameButtonTextFree").visible = !0,
            nge.find("^freeGameButtonTextFree").addClass("disableText"),
            nge.find("^freeGameButtonTextGame").visible = !0,
            nge.find("^freeGameButtonTextGame").addClass("disableText")) : (e.visible = !0,
            nge.find("^freeGameButtonTextFree").visible = !1,
            nge.find("^freeGameButtonTextGame").visible = !1)
        }
        ,
        this._spinButtonMaxBet = function(e) {
            ...
            t.key = e ? "/btn_spin_maxbet.png" : "/btn_spin_regular.png",
            t.frame = 2,
            t.frame = 1,
            nge.assets.applyQuality(t)
        }
        ,
        this._subscribe = function() {
            nge.observer.add("spinButton.regular", o._spinRegular),
            nge.observer.add("spinButton.autospin", o._spinAutospin),
            nge.observer.add("spinButton.freespin", o._spinFreespin),
            nge.observer.add("spinButton.enable", o._spinButtonEnable),
            nge.observer.add("spinButton.disable", o._spinButtonDisable),
            nge.observer.add("spinButton.maxBet", o._spinButtonMaxBet),
            nge.observer.add("autospin.end", o._spinRegular),
            nge.observer.add("autospin.stopRequest", o._showSpinButton),
            nge.observer.add("freespin.end", o._spinRegular),
            nge.observer.add("slotMachine.spinCommand", o._spinButtonDisable),
            nge.observer.add("slotMachine.spinComplete", o._spinButtonEnable)
        }
    }
    ))
}
...
, function(e, t) {
    nge.Com.SummaryPopup.Controller = nge.Com.Base.extend((function() {
        ...
        this.create = function() {
            ...
            e = nge.Lib.Validator.floatMoney(e, !0) + nge.localData.get("currency"),
...
, function(e, t) {
    nge.Com.TotalBet.Controller = nge.Com.Base.extend((function() {
        ...
        this._update = function() {
            ...
            return !(!e || !t || void 0 === n) && (e = e * t * n * i,
            nge.localData.set("totalBet.value", e),
            t = nge.find(".totalBetNumber"),
            n = nge.localData.get("pokerMachine.gameParameters.handsQty"),
            t && (t.text = e.toFixed(2)),
            t && n && (t.text = nge.Lib.Validator.convertToFloat(e * n)),
            nge.observer.fire("totalBet.change"),
            !0)
        }
        ,
        this._subscribe = function() {
            nge.observer.add("brain.openGameSuccess", t._update),
            nge.observer.add("bet.change", t._update),
            nge.observer.add("lines.change", t._update),
            nge.observer.add("coins.change", t._update),
            nge.observer.add("totalBet.update", t._update)
        }
    }
    ))
}
...
, function(e, t) {
    nge.Com.Tutorial.Controller = nge.Com.Base.extend((function() {
        ...
        ,
        this._subscribe = function() {
            nge.observer.add("welcomePopup.hidden", n._showTutorial),
            nge.observer.add("tutorial.next", n._next),
            nge.observer.add("tutorial.back", n._back),
            nge.observer.add("tutorial.close", n._close)
        }
    }
    ))
}
...
, function(e, t) {
    nge.Com.Tutorial.View = Class.extend((function() {
        var e, t, n, i, o = this, s = 0, a = nge.game.world.width - 20, r = nge.game.world.height - 20, l = [{
        ...
        this.show = function() {
            e = nge.findOne(".tutorial-box"),
            t = nge.findOne(".tutorial-arrow"),
            n = nge.findOne("^tutorialNext"),
            i = nge.findOne("^tutorialBack");
            var a = nge.findOne("^tutorialClose")
              , r = nge.findOne("^btn_close");
            a.x = r.x,
            a.y = r.y,
            a.anchor.x = r.anchor.x,
            a.anchor.y = r.anchor.y,
        ...
        this._updateSteps = function() {
            for (var e = 0; e < l.length; e++)
                l[e].target = nge.findOne(l[e].targetSelector)
        }
        ,
        this._showStep = function(e) {
            ...
            if (!t.target)
                ...
                !1;
            var n = o._objClone(t);
            return o._createTooltip(t, n),
            nge.findOne("^tutorial").visible = !0,
            o._updateNavButtons(e),
            !1
        }
        ,
        ...
        this._createTooltip = function(e, t) {
            o._updateTextContainer(e),
            o._textContainerPositioning(e, t),
            o._arrowPositioning(e, t)
        }
        ,
        this._updateTextContainer = function(e) {
            var t = nge.findOne(".tutorial-box .tutorial-text");
            t.text = e.text,
            (e = nge.findOne(".tutorial-box .px-middle")).width = t.width,
            e.height = 110 > t.height ? 110 : t.height,
            (t = nge.findOne(".tutorial-box .px-top")).width = e.width + 1,
            t.height = 16,
            nge.findOne(".tutorial-box .corner-right-top").x = e.width + 32,
            (t = nge.findOne(".tutorial-box .px-left")).height = e.height + 1,
            t.width = 16,
            (t = nge.findOne(".tutorial-box .px-right")).height = e.height + 2,
            t.width = 16,
            t.x = e.width + 16,
            nge.findOne(".tutorial-box .corner-left-bottom").y = e.height + 32,
            (t = nge.findOne(".tutorial-box .px-bottom")).y = e.y + e.height - 3,
            t.width = e.width + 2,
            t.height = 19,
            (t = nge.findOne(".tutorial-box .corner-right-bottom")).x = 32 + e.width,
            t.y = 32 + e.height
        }
        ,
        this._textContainerPositioning = function(n, i) {
            var s = n.targetShift && n.targetShift.y ? n.targetShift.y : 0;
            switch (e.x = i.x + (n.targetShift && n.targetShift.x ? n.targetShift.x : 0),
            e.y = i.y + s,
            n.arrowPosition) {
            case "top":
                e.x += i.width / 2 - e.width / 2,
                e.y += i.height + t.height - 2,
                o._checkMinMax(e, "x");
                break;
            case "bottom":
                e.x += i.width / 2 - e.width / 2,
                e.y -= e.height + t.height - 2,
                o._checkMinMax(e, "x");
                break;
            case "left":
                e.x += i.width + t.height - 2,
                e.y += i.height / 2 - e.height / 2,
                o._checkMinMax(e, "y");
                break;
            case "right":
                e.x -= e.width + t.height - 2,
                e.y += i.height / 2 - e.height / 2,
                o._checkMinMax(e, "y")
            }
            return !1
        ...
        this._objClone = function(e) {
            ...
            return t.x = e.worldTransform.tx / e.worldTransform.a,
            t.y = e.worldTransform.ty / e.worldTransform.d,
            n && (t.x /= nge.assets.getQualityFactor(),
            t.y /= nge.assets.getQualityFactor()),
            n = e.generateTexture(),
            t.x += e._bounds.x,
            t.y += e._bounds.y,
            t.setTexture(n),
...
, function(e, t) {
    nge.Com.WelcomePopup.Controller = nge.Com.Base.extend((function() {
        ...
        this._dontShow = function() {
            ...
            e.removeClass("regular").removeClass("active"),
            n ? e.addClass("active") : e.addClass("regular"),
            nge.observer.fire("welcomePopup.showTutorial", !n)
        }
        ,
        this._play = function() {
        ...
        ,
        this._subscribe = function() {
            nge.observer.add("welcomePopup.show", t._show),
            nge.observer.add("welcomePopup.dontShow", t._dontShow),
            nge.observer.add("welcomePopup.play", t._play)
        }
    }
    ))
}
...
, function(e, t) {
    nge.Com.WinInfo.Controller = nge.Com.Base.extend((function() {
        ...
        ,
        this._subscribe = function() {
            return nge.observer.add("win", t._winHandler),
            nge.observer.add("loose", t._winHandler),
            t.customSubscribe(),
            !0
        }
        ,
        this._winHandler = function(e) {
            ...
            t && (t.text = nge.localData.get("currency") + nge.Lib.Validator.convertToFloat(e.winAmount)),
            (t = nge.find("^winInfoWinFactorValue")) && (t.text = nge.Lib.Validator.convertToFloat(e.winMultiplier))
        }
    }
    ))
}
...
, function(e, t) {
    nge.Com.Winlines.Cfg = Class.extend((function() {
        this.showLinesOnWin = this.buildWinLines = this.singleton = !0,
        ...
        this.thumbsOn = this.numbersCustomY = this.numbersCustomDecoration = !1,
        this.thumbs = {
            width: 380,
            height: 230,
            columns: null,
...
, function(e, t) {
    nge.Com.Winlines.Controller = nge.Com.Base.extend((function() {
        ...
        this.preload = function() {
            return i = this,
            this.preloadDefault(),
            t = this.getInstance("Cfg", "slotMachine").get(),
            i._view || (i._view = this.getInstance("View")),
            i._service || (i._service = this.getInstance("Service")),
            i._service.preload(i._view),
            !0
        }
        ,
        this.create = function() {
            ...
            n || i._subscribe(),
            i._service.create(t),
            this.getInstance("Cfg").thumbsOn && (e || (e = this.getInstance("ThumbsService")),
            e.create(i._view)),
        ...
        this._setWinlines = function(e) {
            _normalizeRowsIndexes(e),
            i._view.buildWinLines(e)
        }
        ,
        this._show = function(e) {
            i._view.show(e)
        ...
        ,
        this._subscribe = function() {
            return nge.observer.add("Transport.close", i._pauseLinesAnimation),
            nge.observer.add("winlines.set", i._setWinlines),
            nge.observer.add("winlines.show", i._show),
            nge.observer.add("winlines.hide", i._hide),
            nge.observer.add("winlines.hideAll", i._hideAll),
            nge.observer.add("slotMachine.spinResponse", i._setNewQuery),
            nge.observer.add("winlines.setNewQuery", i._setNewQuery),
            nge.observer.add("winlines.animateAll", i._animateAll),
            nge.observer.add("winlines.animateByOne", i._animateByOne),
            nge.observer.add("winlines.thumbsRequest", i._getThumbs),
            nge.observer.add("winlines.sendLineToBack", i._sendLineToBack),
            nge.observer.add("lines.change", i._linesChangeHandler),
            nge.observer.add("slotMachine.spinStart", i._stopLinesAnimation),
            nge.observer.add("winlines.pauseAnimation", i._stopLinesAnimation),
            nge.observer.add("winlines.stopAnimation", i._stopLinesAnimationWithClearQuery),
            nge.observer.add("winlines.setCurrentLineDuration", i._setCurrentLineDuration),
            nge.observer.add("winlines.setCurrentLineDurationFirstTime", i._setCurrentLineDurationFirstTime),
            i.customSubscribe(),
            !0
        }
        ,
...
, function(e, t) {
    nge.Com.Winlines.Service = Class.extend((function() {
        ...
        this.preload = function(t) {
            return e = t,
            (t = this.getInstance("Cfg")).numbersCustomDecoration && nge.game.load.image(t.numbersCustomDecoration, t.numbersCustomDecoration),
            !0
        }
        ,
        this.create = function() {
            return e.create(),
            e.normalizeRowsIndexes(),
            !0
        }
    }
    ))
...
, function(e, t) {
    nge.Com.Winlines.ThumbsService = Class.extend((function() {
        ...
        this.create = function(e) {
            return t = this.getInstance("Cfg"),
            i = nge.localData.get("winlines"),
            o = this.getInstance("ThumbsView"),
            n = this.getInstance("Cfg", "slotMachine").get(),
            s._createThumbs(e),
            !0
        }
        ,
        this.getThumbs = function() {
            return e || s._createThumbs(),
            e
        }
        ,
        this._createThumbs = function(a) {
            e && 0 < e.length && s._destroyThumbs(),
            e = [];
            ...
            l = 0; l < i.length; l++) {
                var c = i[l];
                o.drawThumb(r, a, c),
                (c = nge.objects.create(new nge.Mlm.Objects.Image({
                    assetKey: "1px_empty"
                }))).loadTexture(c.generateTexture()),
                e.push(c)
            }
        }
        ,
...
, function(e, t) {
    nge.Com.Winlines.ThumbsView = Class.extend((function() {
        ...
        this.drawThumb = function(n, i, o) {
            return e = i,
            i = nge.objects.create(new nge.Mlm.Objects.Graphics, null),
            t._drawGrid(i, n),
            t._drawLineThumb(i, n, o),
            i
        }
        ,
        this._drawGrid = function(e, t) {
            e.beginFill(t.cellStrokeColor, 1),
            e.drawRoundedRect(0, 0, t.width, t.height, 14),
            e.endFill();
            for (var n = 0; n < t.columns; n++)
                for (var i = 0; i < t.rows; i++)
                    e.beginFill(t.cellBgColor, 1),
                    e.drawRoundedRect(t.cellBorderSize + (t.symbolWidth + t.cellBorderSize) * n, t.cellBorderSize + (t.symbolHeight + t.cellBorderSize) * i, t.symbolWidth, t.symbolHeight, 14),
                    e.endFill();
            return e
        }
        ,
        this._drawLineThumb = function(e, n, i) {
            return n.lineStrokeSize && n.lineStrokeColor && t._draw(e, i, n, 2 * n.lineStrokeSize + n.lineSize, n.lineStrokeColor),
            t._draw(e, i, n, n.lineSize, n.lineColor),
            e
        }
        ,
        this._draw = function(t, n, i, o, s) {
            for (var a, r, l, c, u = 0; u < n.length - 1; u++)
                0 === u ? (a = i.symbolWidth * u + i.symbolWidth / 2 + i.cellBorderSize * (u + 1),
                r = i.symbolHeight * (n[u] - i.rowsIndexesNormalizeValue) + i.symbolHeight / 2 + i.cellBorderSize * (n[u] + 1 - i.rowsIndexesNormalizeValue),
                l = i.symbolWidth * (u + 1) + i.symbolWidth / 2 + i.cellBorderSize * (u + 2),
                c = i.symbolHeight * (n[u + 1] - i.rowsIndexesNormalizeValue) + i.symbolHeight / 2 + i.cellBorderSize * (n[u + 1] + 1 - i.rowsIndexesNormalizeValue),
                e.drawConnector(t, a, r, o, s, 1)) : (l = i.symbolWidth * (u + 1) + i.symbolWidth / 2 + i.cellBorderSize * (u + 2),
                c = i.symbolHeight * (n[u + 1] - i.rowsIndexesNormalizeValue) + i.symbolHeight / 2 + i.cellBorderSize * (n[u + 1] + 1 - i.rowsIndexesNormalizeValue)),
                e.drawSegment(t, a, r, l, c, o, s, 1),
...
, function(e, t) {
    nge.Com.Winlines.View = Class.extend((function() {
        this._cfg;
        var e, t, n, i, o, s, a, r, l, c, u, g = this, f = [], p = 0, b = [], m = !1, h = !1, d = !0;
        this.create = function() {
            return t = nge.localData.get("winlines"),
            n = [],
            f = [],
            g._cfg = this.getInstance("Cfg"),
            p = nge.localData.get("lines.value") || 0,
            e = this.getInstance("Cfg", "slotMachine").get(),
            this.buildWinLines(),
            !0
        }
        ,
        this.normalizeRowsIndexes = function() {
            if (!1 !== g._cfg.rowsIndexesNormalizeValue && (m = g._cfg.rowsIndexesNormalizeValue),
            !1 !== m)
                return m;
            if (!t)
                return !1;
            for (var e = 0; e < t.length; e++)
                for (var n = 0, i = t[e].length; n < i; n++)
                    m = m > t[e][n] ? t[e][n] : m;
            return m
        }
        ,
        this.buildWinLines = function() {
            if (n && n.length)
                return !1;
            if (g._cfg.buildWinLines && (!t || !t.length))
                return console.error("lines is undefined ", t),
                !1;
            if (!(i = nge.findOne("^" + (g._cfg.customParentName ? g._cfg.customParentName : e.parentName))))
                return !1;
            ...
            g._cfg.buildWinLines)
                for (var u = 0; u < t.length; u++) {
                    ...
                    if (g._cfg.shadow) {
                        ...
                        b = ++m + 4,
                        g._drawLine(t[u], u, c, m, "0x000000", .2)
                    }
                    g._cfg.stroke && (g._drawLine(t[u], u, c, g._cfg.stroke.weight + g._cfg.lineWeight, g._cfg.stroke.colors[u], g._cfg.stroke.alpha),
                    b = b || g._cfg.stroke.weight + g._cfg.lineWeight),
                    g._drawLine(t[u], u, c, g._cfg.lineWeight, g._cfg.lineColors[u]),
                    b = b || g._cfg.lineWeight,
                    b = g._cutLine(t[u], u, c, b),
                    (m = nge.objects.create(new nge.Mlm.Objects.Folder({
                        name: "winline_" + u
                    }))).visible = !1,
                    m.add(b),
                    n.push(m),
                    g._cfg.cacheLineObjectsAsBitmap && (b.cacheAsBitmap = !0),
                    r.add(m),
                    g._cfg.numbers && (m = g._createLineNumber(u),
                    o.add(m),
                    f.push(m),
                    u < p && g._highlightLineNumber(u)),
                    nge.localData.get("winlines.updated") && u < p && this.show(u)
                }
            nge.localData.set("winlines.items", n),
            nge.localData.set("winlines.updated", !1),
            nge.observer.fire("winlines.buildWinLines.finish")
        }
        ,
        this._cutLine = function(e, t, n, o) {
            var r, l = nge.objects.create(new nge.Mlm.Objects.Folder({})), c = s, u = a, f = g._cfg.tailSize || c / 2, p = function(e, t, s, a, r) {
                r = e - o / 2;
                var c = (t < a ? t : a) - o / 2;
                e = s - e + o,
                t = Math.abs(a - t) + o,
                a = n.getImageData(r + i.x, c, e, t),
                (s = document.createElement("canvas")).width = e,
                s.height = t,
                s.getContext("2d").putImageData(a, 0, 0),
                (t = new PIXI.Sprite(PIXI.Texture.fromCanvas(s))).x = r,
                t.y = c,
                l.addChild(t)
            ...
            for (t = 0,
            r = e.length; t < r; t++)
                0 === t ? p(d = c / 2 - f, y = e[0] * u + u / 2 + b, m = c / 2, h = y, !0) : p(d, y, m = t * c + c / 2, h = e[t] * u + u / 2 + b),
                d = m,
                y = h;
            return p(d, y, m + f, h),
            l
        ...
        ,
        this.show = function(e) {
            if (!n[e] || nge.localData.get("slotMachineSpinning"))
                return !1;
            n[e].visible = !0,
            i.bringToTop(n[e])
        }
        ...
        this.highlightLines = function(e) {
            ...
            for (var n = 0; n < e; n++)
                n < e && this.show(n);
            -1 !== t && nge.rafSetTimeout(g._linesHideCheck, t)
        }
        ,
        this.highlightNumbers = function(e) {
            for (var t = 0; t < e; t++)
                g._highlightLineNumber(t)
        }
        ,
        ...
        this.setNewQuery = function(e) {
            if (b = [],
            e && e.slotWin && e.slotWin.lineWinAmounts)
                for (var t = 0; t < e.slotWin.lineWinAmounts.length; t++)
                    b.push(e.slotWin.lineWinAmounts[t]);
            return e && e.slotWin && e.slotWin.jackpotWin && b.push(e.slotWin.jackpotWin),
            !0
        }
        ,
        this.animateAll = function() {
            return 0 < g._cfg.animationAllDelay ? nge.rafSetTimeout(g._animateAll, g._cfg.animationAllDelay) : g._animateAll(),
            !0
        }
        ,
        ...
        this.animateByOne = function() {
            if (!b[r] || nge.localData.get("slotMachineSpinning"))
                return !1;
            nge.observer.fire("winlines.lineHighlite.start", b[r]),
            nge.rafClearTimeout(l);
            var e = nge.localData.get("autospin.inProgress")
              , t = nge.localData.get("freespin.inProgress");
            if (g._cfg.fastAutoMode && (e || t))
                return !1;
            this.hideAll(),
            void 0 !== b[r].selectedLine && g._cfg.showLinesOnWin && this.show(b[r].selectedLine),
            nge.observer.fire("winlines.lineHighlite.start.previousHided", b[r]),
            g._animateSymbols(b[r].wonSymbols),
            h = !1,
            l = nge.rafSetTimeout(g._animationOneByOneCallback, g._cfg.animationOneByOneDuration),
            u = "OneByOne",
            nge.observer.fire("winlines.lineHighlite.startComplete", b[r])
        }
        ,
        ...
        this.setCurrentLineDuration = function(e, t) {
            ...
            l && (h = !0,
            nge.rafClearTimeout(l),
            l = nge.rafSetTimeout("All" === u ? g._animationAllCallback : g._animationOneByOneCallback, e))
        }
        ,
        this.stopLinesAnimation = function(e) {
            l && nge.rafClearTimeout(l),
            e && (b = []),
            d = !0
        }
        ,
        this.drawSegment = function(e, t, n, i, o, s, a, r) {
            ...
            e.lineTo(i, o),
            e.lineWidth = s,
            e.strokeStyle = "#" + nge.Lib.Helper.strReplace("0x", "", a),
            e.stroke()
        }
        ,
        ...
        this._animationOneByOneCallback = function() {
            ...
            0 < e ? nge.rafSetTimeout((function() {
                g.animateByOne()
            }
            ), e) : g.animateByOne()
        }
        ,
        this._animateAll = function() {
            if (!b || 0 === b.length || nge.localData.get("slotMachineSpinning"))
                return !1;
            if (l && nge.rafClearTimeout(l),
            d = !1,
            g._cfg.animateAllSymbols)
                for (var e in b)
                    g._animateSymbols(b[e].wonSymbols);
            0 === g._cfg.animationAllDuration && g._animateAllDone(),
            r = 0,
            h = !1,
            l = nge.rafSetTimeout(g._animationAllCallback, g._cfg.animationAllDuration),
            u = "All";
            for (var t = 0; t < b.length; t++)
                (e = b[t]) && void 0 !== e.selectedLine && (0 >= g._cfg.animationAllDelayPerLine ? nge.observer.fire("winlines.show", e.selectedLine) : function(e) {
                    nge.rafSetTimeout((function() {
        ...
        this._drawLine = function(e, t, n, i, o, r) {
            r = void 0 === r ? 1 : r;
            var l, c = s, u = a, f = g._cfg.tailSize || c / 2, p = function(e, t, s, a, l) {
                l && g.drawConnector(n, e, t, i, o, r),
                g.drawSegment(n, e, t, s, a, i, o, r),
                g.drawConnector(n, s, a, i, o, r)
            }, b = g._cfg.globalOffset + g._cfg.lineOffsets[t];
        ...
        this._createLineNumber = function(e) {
            ...
            return "right" !== l && "both" !== l || (f = c * s + s / 2 + o + g._cfg.offsetFromLine,
            p = !1 === r ? t[e][c] * a + a / 2 + i : r,
            g._cfg.numbersCustomDecoration && ((b = new Phaser.Image(nge.game,f,p,new PIXI.Texture(PIXI.BaseTextureCache[g._cfg.numbersCustomDecoration]))).anchor.x = .5,
            b.anchor.y = .5,
            u.add(b)),
            nge.objects.create(new nge.Mlm.Objects.Text({
                x: f,
        ...
        this._animateSymbols = function(e) {
            for (var t = 0; t < e.length; t++)
                e[t] && nge.observer.fire("slotMachine.animateSymbol", {
                    reel: e[t][0],
                    row: e[t][1]
                });
...
, function(e, t) {
    nge.Lib.Console = {
        color: function(e, t, n) {
            t || (t = "#000"),
            n || (n = "#fff"),
            window.log("%c " + e, "background: " + n + "; color: " + t)
        },
        log: function(e, t) {
            var n = "#212121"
              , i = "#b0bec5"
            ...
            o.hasOwnProperty(t) && (n = o[t].clr,
            i = o[t].bgc),
            window.log("%c" + e, "color:" + n + "; font-weight:bold; background-color: " + i + "; padding: 3px 6px; border-radius: 2px;")
        }
    },
...
, function(e, t, n) {
    (function(e) {
        nge.Lib.Device = function() {
            ...
            this.canvas = this.windowsPhone = this.windows = this.macOS = this.linux = this.chromeOS = this.android = this.crosswalk = this.ejecta = this.electron = this.nodeWebkit = this.node = this.cordova = this.cocoonJSApp = this.cocoonJS = this.iOS = this.desktop = this.initialized = !1,
            this.canvasBitBltShift = null,
            this.vibration = this.typedArray = this.pointerLock = this.css3D = this.worker = this.localStorage = this.fileSystem = this.file = this.webGL = !1,
            this.getUserMedia = !0,
            ...
            this.iPad = this.iPhone4 = this.iPhone = this.hlsVideo = this.vp9Video = this.webmVideo = this.mp4Video = this.h264Video = this.oggVideo = this.webm = this.m4a = this.wav = this.mp3 = this.opus = this.ogg = this.webAudio = this.audioData = this.silk = this.webApp = this.safari = this.opera = this.midori = this.mobileSafari = !1,
            this.pixelRatio = 0,
        ...
        ,
        nge.Lib.Device = new nge.Lib.Device,
        nge.Lib.Device.whenReady = function(e, t, n) {
            var i = this._readyCheck;
            this.deviceReadyAt || !i ? e.call(t, this) : i._monitor || n ? (i._queue = i._queue || [],
            i._queue.push([e, t])) : (i._monitor = i.bind(this),
            i._queue = i._queue || [],
            i._queue.push([e, t]),
            e = void 0 !== window.cordova,
            t = navigator.isCocoonJS,
            "complete" === document.readyState || "interactive" === document.readyState ? window.setTimeout(i._monitor, 0) : e && !t ? document.addEventListener("deviceready", i._monitor, !1) : (document.addEventListener("DOMContentLoaded", i._monitor, !1),
            window.addEventListener("load", i._monitor, !1)))
        }
        ,
        ...
        nge.Lib.Device._initialize = function() {
            ...
            !function() {
                ...
                /Playstation Vita/.test(e) ? t.vita = !0 : /Kindle/.test(e) || /\bKF[A-Z][A-Z]+/.test(e) || /Silk.*Mobile Safari/.test(e) ? t.kindle = !0 : /Android/.test(e) ? t.android = !0 : /CrOS/.test(e) ? t.chromeOS = !0 : /iP[ao]d|iPhone/i.test(e) ? t.iOS = !0 : /Linux/.test(e) ? t.linux = !0 : /Mac OS/.test(e) ? t.macOS = !0 : /Windows/.test(e) && (t.windows = !0),
                (/Windows Phone/i.test(e) || /IEMobile/i.test(e)) && (t.android = !1,
                t.iOS = !1,
                t.macOS = !1,
                t.windows = !0,
                t.windowsPhone = !0);
                var n = /Silk/.test(e);
                (t.windows || t.macOS || t.linux && !n || t.chromeOS) && (t.desktop = !0),
                (t.windowsPhone || /Windows NT/i.test(e) && /Touch/i.test(e)) && (t.desktop = !1)
            }(),
            function() {
                t.audioData = !!window.Audio,
                t.webAudio = !(!window.AudioContext && !window.webkitAudioContext);
                var e = document.createElement("audio");
                try {
                    e.canPlayType && (e.canPlayType('audio/ogg; codecs="vorbis"').replace(/^no$/, "") && (t.ogg = !0),
                    (e.canPlayType('audio/ogg; codecs="opus"').replace(/^no$/, "") || e.canPlayType("audio/opus;").replace(/^no$/, "")) && (t.opus = !0),
                    e.canPlayType("audio/mpeg;").replace(/^no$/, "") && (t.mp3 = !0),
                    e.canPlayType('audio/wav; codecs="1"').replace(/^no$/, "") && (t.wav = !0),
                    (e.canPlayType("audio/x-m4a;") || e.canPlayType("audio/aac;").replace(/^no$/, "")) && (t.m4a = !0),
                    e.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/, "") && (t.webm = !0))
                } catch (e) {}
            }(),
            function() {
                var e = document.createElement("video");
                try {
                    e.canPlayType && (e.canPlayType('video/ogg; codecs="theora"').replace(/^no$/, "") && (t.oggVideo = !0),
                    e.canPlayType('video/mp4; codecs="avc1.42E01E"').replace(/^no$/, "") && (t.h264Video = !0,
                    t.mp4Video = !0),
                    e.canPlayType('video/webm; codecs="vp8, vorbis"').replace(/^no$/, "") && (t.webmVideo = !0),
                    e.canPlayType('video/webm; codecs="vp9"').replace(/^no$/, "") && (t.vp9Video = !0),
                    e.canPlayType('application/x-mpegURL; codecs="avc1.42E01E"').replace(/^no$/, "") && (t.hlsVideo = !0))
                } catch (e) {}
            }(),
            function() {
                var n = navigator.userAgent;
                if (/Arora/.test(n) ? t.arora = !0 : /Chrome\/(\d+)/.test(n) && !t.windowsPhone ? (t.chrome = !0,
                t.chromeVersion = parseInt(RegExp.$1, 10)) : /Epiphany/.test(n) ? t.epiphany = !0 : /Firefox\D+(\d+)/.test(n) ? (t.firefox = !0,
                t.firefoxVersion = parseInt(RegExp.$1, 10)) : /AppleWebKit/.test(n) && t.iOS ? t.mobileSafari = !0 : /MSIE (\d+\.\d+);/.test(n) ? (t.ie = !0,
                t.ieVersion = parseInt(RegExp.$1, 10)) : /Midori/.test(n) ? t.midori = !0 : /Opera/.test(n) ? t.opera = !0 : /Safari/.test(n) && !t.windowsPhone ? t.safari = !0 : /Trident\/(\d+\.\d+)(.*)rv:(\d+\.\d+)/.test(n) && (t.ie = !0,
                t.trident = !0,
                t.tridentVersion = parseInt(RegExp.$1, 10),
                t.ieVersion = parseInt(RegExp.$3, 10)),
                /Silk/.test(n) && (t.silk = !0),
                navigator.standalone && (t.webApp = !0),
                void 0 !== window.cordova && (t.cordova = !0),
                void 0 !== e && (t.node = !0),
                t.node && "object" == typeof e.versions && (t.nodeWebkit = !!e.versions["node-webkit"],
                t.electron = !!e.versions.electron),
                navigator.isCocoonJS && (t.cocoonJS = !0),
                t.cocoonJS)
                    try {
                ...
                void 0 !== window.ejecta && (t.ejecta = !0),
                /Crosswalk/.test(n) && (t.crosswalk = !0)
            }(),
            function() {
                ...
                for (var i in document.body.insertBefore(e, null),
                n)
                    if (void 0 !== e.style[i]) {
                ...
                t.css3D = void 0 !== o && 0 < o.length && "none" !== o
            }(),
            t.pixelRatio = window.devicePixelRatio || 1,
            t.iPhone = -1 != navigator.userAgent.toLowerCase().indexOf("iphone"),
            t.iPhone4 = 2 == t.pixelRatio && t.iPhone,
            t.iPad = -1 != navigator.userAgent.toLowerCase().indexOf("ipad"),
            t.typedArray = "undefined" != typeof Int8Array,
            "undefined" != typeof ArrayBuffer && "undefined" != typeof Uint8Array && "undefined" != typeof Uint32Array && (t.littleEndian = function() {
                var e = new ArrayBuffer(4)
                  , t = new Uint8Array(e);
                return e = new Uint32Array(e),
                t[0] = 161,
                t[1] = 178,
                t[2] = 195,
                t[3] = 212,
                3569595041 == e[0] || 2712847316 != e[0] && null
            }(),
            t.LITTLE_ENDIAN = t.littleEndian),
            t.support32bit = "undefined" != typeof ArrayBuffer && "undefined" != typeof Uint8ClampedArray && "undefined" != typeof Int32Array && null !== t.littleEndian && function() {
            ...
            navigator.vibrate && (t.vibration = !0),
            function() {
                ...
                t.file = !!(window.File && window.FileReader && window.FileList && window.Blob),
                t.fileSystem = !!window.requestFileSystem;
                try {
                ...
                t.webGL = n,
                t.webGL = !!t.webGL,
                t.worker = !!window.Worker,
                t.pointerLock = "pointerLockElement"in document || "mozPointerLockElement"in document || "webkitPointerLockElement"in document,
                t.quirksMode = "CSS1Compat" !== document.compatMode,
                navigator.getUserMedia = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia || navigator.oGetUserMedia,
                window.URL = window.URL || window.webkitURL || window.mozURL || window.msURL,
                t.getUserMedia = t.getUserMedia && !!navigator.getUserMedia && !!window.URL,
                t.firefox && 21 > t.firefoxVersion && (t.getUserMedia = !1),
                !t.iOS && (t.ie || t.firefox || t.chrome) && (t.canvasBitBltShift = !0),
                (t.safari || t.mobileSafari) && (t.canvasBitBltShift = !1)
            }(),
            function() {
                for (var e = "requestFullscreen requestFullScreen webkitRequestFullscreen webkitRequestFullScreen msRequestFullscreen msRequestFullScreen mozRequestFullScreen mozRequestFullscreen".split(" "), n = document.createElement("div"), i = 0; i < e.length; i++)
                    if (n[e[i]]) {
                        t.fullscreen = !0,
                        t.requestFullscreen = e[i];
                        break
                    }
                if (e = "cancelFullScreen exitFullscreen webkitCancelFullScreen webkitExitFullscreen msCancelFullScreen msExitFullscreen mozCancelFullScreen mozExitFullscreen".split(" "),
                t.fullscreen)
            ...
            ("ontouchstart"in document.documentElement || window.navigator.maxTouchPoints && 1 <= window.navigator.maxTouchPoints) && (t.touch = !0),
            (window.navigator.msPointerEnabled || window.navigator.pointerEnabled) && (t.mspointer = !0),
            t.cocoonJS || ("onwheel"in window || t.ie && "WheelEvent"in window ? t.wheelEvent = "wheel" : "onmousewheel"in window ? t.wheelEvent = "mousewheel" : t.firefox && "MouseScrollEvent"in window && (t.wheelEvent = "DOMMouseScroll"))
        }
        ,
...
, function(e, t) {
    ...
    nge.Lib.Helper = {
        typeCheck: function() {
            var e, t = {}, n = "String Number Boolean Array Object Function RegExp Date Error".split(" ");
            for (e = n.length; e--; )
                t["is" + n[e]] = function(e) {
                    return function(t) {
        ...
        validate: function(e, t, n, i) {
            ...
            return t && !o.isString(t) || t && !o["is" + t] || void 0 !== i && !o.isBoolean(i) ? (s("validate call error, ", arguments),
            !1) : t && !o["is" + t](e) ? (s("Type error:", e, "is not a " + t),
            !1) : void 0 === n || e instanceof n || (s("Constructor error:", e, "is not a instance of", n),
            !1)
        },
        ...
        permute: function(e) {
            function t(e, t) {
                ...
                for (n = e.length; 0 <= n; n--)
                    i.push([].concat(e.slice(0, n), [t], e.slice(n, void 0)));
                return i
            }
            var n, i = e.length, o = [[e[0]]];
            for (n = 1; n < i; n++) {
                var s = e[n]
                  , a = o;
                o = [],
        ...
        decbin: function(e) {
            if (nge.Lib.Helper.validate(e, "Number"))
                return 0 > e && (e = 4294967295 + e + 1),
                parseInt(e, 10).toString(2)
        },
        strrev: function(e) {
        ...
        str_pad: function(e, t, n, i) {
            ...
            return "STR_PAD_LEFT" !== i && "STR_PAD_RIGHT" !== i && "STR_PAD_BOTH" !== i && (i = "STR_PAD_RIGHT"),
            0 < (o = t - e.length) && ("STR_PAD_LEFT" === i ? e = s(n, o) + e : "STR_PAD_RIGHT" === i ? e += s(n, o) : "STR_PAD_BOTH" === i && (e = ((o = s(n, Math.ceil(o / 2))) + e + o).substr(0, t))),
            e
        },
        ...
        mergeObjs: function(e, t, n) {
            for (var i in n = n || nge.Lib.Helper.jsObjClone(e),
            t)
                n[i] = t[i];
            return n
        },
        mergeObjsRecursive: function(e, t) {
            ...
            for (n in t)
                i[n] = "object" == typeof t[n] && "object" == typeof e[n] ? nge.Lib.Helper.mergeObjsRecursive(e[n], t[n]) : t[n];
            return i
        },
        ...
        recursiveSet: function(e, t, n) {
            ...
            var i = e.shift();
            return 0 < e.length ? (n[i] || (n[i] = {}),
            nge.Lib.Helper.recursiveSet(e, t, n[i])) : n[i] = t,
            !0
        },
        recursiveGet: function(e, t, n) {
            if (void 0 === t)
                return n;
            for (var i in "string" == typeof e && (e = e.split(".")),
            e) {
                var o = e[i];
                if (void 0 === t[o])
                    return n;
        ...
        localizeDate: function(e) {
            var t = new Date;
            return e.setHours(e.getHours() - t.getTimezoneOffset() / 60),
            e
        },
        ...
        setCookie: function(e, t, n) {
            var i = new Date;
            return i.setDate(i.getDate() + n),
            t = escape(t) + (null === n ? "" : "; expires=" + i.toUTCString()),
            document.cookie = e + "=" + t,
            !0
        },
        ...
        deleteCookie: function(e, t, n) {
            return this.getCookie(e) && (document.cookie = e + "=" + (t ? ";path=" + t : "") + (n ? ";domain=" + n : "") + ";expires=Thu, 01 Jan 1970 00:00:01 GMT"),
            !0
        },
        browserDetect: function() {
            ...
            return "Chrome" === t[1] && null !== (n = e.match(/\b(OPR|Edge)\/(\d+)/)) ? n.slice(1).join(" ").replace("OPR", "Opera") : (t = t[2] ? [t[1], t[2]] : [navigator.appName, navigator.appVersion, "-?"],
        ...
        getOsAndVersion: function() {
            var e, t = navigator.appVersion, n = navigator.userAgent, i = "-", o = [{
                s: "Windows 10",
            ...
            switch (o = "-",
            /Windows/.test(i) && (o = /Windows (.*)/.exec(i)[1],
            i = "Windows"),
            i) {
            case "Mac OS X":
        ...
        occur: function(e, t) {
            t = "#" + t + "#";
            for (var n = (e = "#" + e.join("#,#") + "#").indexOf(t), i = 0; -1 !== n; i++)
        ...
        createPng: function(e, t, n, i, o, s, a) {
            ...
            c.globalAlpha = parseInt(s) % 256 / 256,
            c.fillStyle = n,
            c.fillRect(0, 0, e, t),
            c.stroke(),
            e = function(e, t) {
        ...
        getAngleBy3Points: function(e, t, n) {
            ...
            return e = nge.Lib.Helper.getLengthBy2Points(e, t),
            t = nge.Lib.Helper.getLengthBy2Points(t, n),
            0 !== e && 0 !== t && (i = Math.acos((e * e + t * t - o * o) / (2 * e * t))),
            i
        },
        ...
        chkArraysPartialEntry: function(e, t) {
            ...
            for (var n = (t = t.sort()).length - 1, i = e.length - 1; 0 <= i; i--)
                if (JSON.stringify(e[i]) === JSON.stringify(t[n]) && n--,
                -1 === n)
                    return !0;
            return !1
        },
        ...
        logicBlocksDo: function() {
            ...
            if (!t._logicBlocksInstances)
                for (var i in t._logicBlocksInstances = {},
                t._logicBlocks) {
            ...
            for (o in i = [],
            t._logicBlocksInstances)
                t._logicBlocksInstances[o][n] && (s = t._logicBlocksInstances[o][n].apply(this, e),
                i.push(s));
            return i
        },
        ...
        objFindEl: function(e, t) {
            if (t = nge.Lib.Helper.objFind(e, t))
                return e[t]
        },
            ...
            var l = -1 === e.indexOf(".")
              ...
              , u = function(i, g) {
                ...
                for (f = 0; f < i.length; f++) {
                    ...
                    if (p[n] && 0 < p[n].length && (b = u(p[n], g)) && (a && (p[n] = c(p[n])),
                    s))
                        return b
                }
                return !1
        ...
        waitForWebfonts: function(e, t) {
            for (var n = function(e) {
                ...
                nge.Lib.Checker.delay((function() {
                    return !n || n.offsetWidth !== i && (n.parentNode.removeChild(n),
                    n = null,
                    !0)
                }
                ), (function() {
        ...
        isFontAvailable: function() {
            var e = function() {
                var e, t = document.body, n = document.createElement("span");
                n.innerHTML = Array(100).join("wi"),
                n.style.cssText = ["position:absolute", "width:auto", "font-size:128px", "left:-99999px"].join(" !important;");
                var i = function(i) {
                    return n.style.fontFamily = i,
                    t.appendChild(n),
                    e = n.clientWidth,
                    t.removeChild(n),
                    e
        ...
        loadJsCssFile: function(e, t, n) {
            if ("js" === t) {
                ...
                "css" === t && ((i = document.createElement("link")).setAttribute("rel", "stylesheet"),
                i.setAttribute("type", "text/css"),
                i.setAttribute("href", e));
            i && n && (i.onload = i.onreadystatechange = n),
            void 0 !== i && document.getElementsByTagName("head")[0].appendChild(i)
        },
        getMaxZIndex: function() {
            return Math.max.apply(null, $.map($("body *"), (function(e, t) {
                if ("static" !== $(e).css("position"))
...
, function(e, t) {
    nge.Lib.I18n = function(e) {
        ...
        ;
        var o = function(e) {
            if (e || (e = nge.Cfg.Main.project),
            nge.Cfg.Main.lang === n && i === e)
                return !1;
            ...
            n = nge.Cfg.Main.lang,
            i = nge.Cfg.Main.project
        }
          , s = function(e, t) {
            $.getJSON(nge.realPathPrefix + e, (function(e) {
                nge.i18n.setStorage(e),
                t && t()
            }
            ))
        }
          , a = function(e, t) {
            for (var n in t)
                e = nge.Lib.Helper.strReplace("%(" + n + ")s", t[n], e);
            return e
        };
        o(e)
    }
    ...
    nge.Lib.Keyboard = Class.extend((function() {
        ...
        var n = function(e, n) {
            $(document)[e]((function(e) {
                ...
                i && (n(i),
                i = nge.Lib.Helper.browserDetect(),
                nge.game.scale.isFullScreen && -1 !== i.indexOf("Safari") && -1 === i.indexOf("Chrome") && e.preventDefault())
            }
            ))
        }
          , i = function(t) {
            return -1 === e.indexOf(t) && (e.push(t),
            nge.observer.fire("keyboard.KeyDown", t),
            nge.observer.fire("keyboard.KeyDown." + t)),
            !0
        }
          , o = function(t) {
    ...
    nge.Lib.Math = {
        ...
        bezier: function(e, t, n, i, o) {
            return {
                ...
                _moveTo: function(e) {
                    this.target.position = this._at(e),
                    this.onUpdate.dispatch(this._at(e))
                },
                start: function() {
                ...
                update: function(e) {
                    this.running && (this.current = nge.Lib.Math.clamp(this.current + e, 0, this.time),
                    this._moveTo(this.current / this.time),
                    this.current >= this.time && this.stop())
                }
            }
        },
        interpolateColor: function(e, t, n) {
            return e === t ? e : (e = nge.Lib.Math.getRGB(e),
            t = nge.Lib.Math.getRGB(t),
            16777215 + nge.Lib.Math.getColor32(255, (t.red - e.red) * n + e.red, (t.green - e.green) * n + e.green, (t.blue - e.blue) * n + e.blue))
        },
...
, function(e, t) {
    var n;
    nge.Lib.ModesManager = (n = {},
    function(e, t) {
        var i = nge.Lib.Random.uuid4()
          , o = !1
          , s = Class.extend((function() {
            this.constructor = function() {
                for (var s = t ? nge.App.getPath(e, !1, !0) : Class, a = 0; a < n[e].length; a++)
                    n[e][a].uid !== i && (s = s.extend(n[e][a].f));
                s = s.extend(o),
                this.__proto__ = new s
            }
        }
        ));
        return {
...
, function(e, t) {
    nge.Lib.Mouse = Class.extend((function() {
        ...
        var n = function(e, t) {
          ...
          , i = function(e) {
            t[e] = !0,
            nge.observer.fire("mouse.buttonDown", e),
            nge.observer.fire("mouse.buttonDown." + e)
        }
          , o = function(n) {
            e.check(n) && (t[n] = !1,
            nge.observer.fire("mouse.buttonUp", n),
            nge.observer.fire("mouse.buttonUp." + n))
        };
        this.subscribe = function() {
            n("mousedown", i),
...
, function(e, t) {
    nge.Lib.Observer = function() {
        ...
        this.add = function(i, s, r, l) {
            return "object" == typeof i && (i = (l = i).eventName,
            s = l.callback,
            r = l.name,
            l = l.global),
            n ? (o.push([i, s, r, l]),
            !1) : (l || (i += "_@" + a),
            r ? (void 0 === t[i] && (t[i] = {}),
            t[i][r] = s) : (void 0 === e[i] && (e[i] = []),
            e[i].push(s)),
            !0)
        }
        ,
        this.remove = function(n, i, s, r) {
            "object" == typeof n && (n = (r = n).eventName,
            i = r.callback,
            s = r.name,
            r = r.global);
            var l, c = [];
            ...
            r || (n += "_@" + a),
            s) {
                if (void 0 === t[n] || void 0 === t[n][s])
                    return !1;
                t[n][s] = void 0,
                delete t[n][s],
                0 === nge.Lib.Helper.getObjSize(t[n]) && delete t[n]
            } else {
                if (void 0 === e[n])
                    return !1;
                -1 !== (i = e[n].indexOf(i)) && e[n].splice(i, 1),
                0 === nge.Lib.Helper.getObjSize(e[n]) && delete e[n]
            }
            return !0
        }
        ,
        ...
        this.clearEventsQueue = function() {
            0 < s.length && console.warn("Lib.Observer _eventsQueue was not empty"),
            s = [],
            n = !1
        }
        ,
        ...
        this.fire = function(r, l, c, u) {
            ...
            if (!r)
                return console.error("nge.Lib.Observer error: no eventName. Check your code"),
                !1;
            if (u || (u = {
            ...
            c)
                return nge.rafSetTimeout((function() {
            ...
            0 === i.length) {
                ...
                g = o)
                    f = g[p],
                    this.add(f[0], f[1], f[2], f[3]);
                o = [],
                0 < s.length && (p = s.shift(),
                this.fire(p[0], p[1], p[2], p[3]))
            }
            return !0
        }
        ,
...
, function(e, t) {
    nge.Lib.RafSetTimeout = function() {
        ...
        ;
        var t = function() {
            var t, n = nge.Lib.Time.get(), i = {}, o = 0;
            for (t in e) {
                var s = e[t];
                s.callTime <= n && (i[1e3 * s.callTime + o] = s.callback,
                e[t] = null,
                delete e[t]),
                o++
            }
            for (n = Object.keys(i).sort(),
            o = 0; o < n.length; o++)
                i[n[o]]();
            return !0
        }
...
, function(e, t) {
    nge.Lib.Random = {
        ...
        findVariance: function(e) {
            for (var t = this.findAverage(e), n = 0, i = 0; i < e.length; i++)
                n += Math.pow(e[i] - t, 2);
            return n / e.length
        },
        findStandardDeviation: function(e) {
            return e = this.findVariance(e),
            Math.sqrt(e)
        },
        frac: function() {
            return Math.random()
...
, function(e, t) {
    nge.Lib.SelfCheckTools = {
        ...
        _windowKeys: [],
        saveState: function() {
            for (var e in this._len = nge.Lib.Helper.getObjSize(window),
            window)
                this._windowKeys.push(e);
            return !0
        },
        showChanges: function() {
            for (var e in console.log(this._len + " ~~ " + nge.Lib.Helper.getObjSize(window)),
            window)
                -1 === this._windowKeys.indexOf(e) && console.log("---" + e, window[e]);
            return !0
        },
        deepDiffMapper: {
            ...
            map: function(e, t, n, i) {
                if (void 0 === n && (n = 999),
                this.isFunction(e) || this.isFunction(t))
                ...
                for (o in e)
                    if (!this.isFunction(e[o])) {
                        ...
                        var r = n ? e[o] : "object";
                        r = this.map(r, a, n - 1, i),
                        s[o] = r
                    }
                for (o in t)
                    this.isFunction(t[o]) || void 0 !== s[o] || (r = n ? t[o] : "object",
                    r = this.map(void 0, r, n - 1, i),
                    s[o] = r);
                return i && this.removeUnchanged(s),
                s
            },
            removeUnchanged: function(e) {
                for (var t in e)
                    (e[t] && e[t].type === this.VALUE_UNCHANGED || e[t] && "object" == typeof e[t] && 0 === nge.Lib.Helper.getObjSize(e[t])) && delete e[t]
            },
        ...
        getNodeTree: function(e) {
            if (e.hasChildNodes())
                for (var t = [], n = 0; n < e.childNodes.length; n++)
                    t.push(this.getNodeTree(e.childNodes[n]));
            if (e.attributes && 0 < e.attributes.length) {
                n = 0;
                for (var i = e.attributes, o = i.length, s = {}; n < o; n++)
                    s[i[n].nodeName] = i[n].nodeValue
            }
            return {
                nodeName: e.nodeName || "",
...
, function(e, t) {
    nge.Lib.Time = {
        ...
        dateToDDMMYYYYHHMMSS: function(e, t) {
            ...
            return e = 10 > e.getSeconds() ? "0" + e.getSeconds() : e.getSeconds(),
            t ? {
                d: n,
                m: i,
                y: o,
...
, function(e, t) {
    nge.Lib.Timeline = function(e) {
        function t(t) {
            for (; i < o && (n = e.timePoints[i]).time <= t; i++)
                n.callback()
        }
        ...
        var n, i = 0, o = e.timePoints.length, s = nge.tween.add({
            x: 0
        });
        return s.to({
            x: e.duration
...
, function(e, t) {
    nge.Lib.Tweens = function() {
        ...
        this.add = function(i) {
            t || (t = !0,
            nge.observer.add("StatesManager.update.start", g, !1, !0),
            g());
            var s = f()
              , p = {
                id: s,
                ...
                set timeScale(e) {
                    if (this._timeScale === e || !this.points[0])
                        return this._timeScale;
                    var t = ~~(n - this.points[0].timeStart) * o.globalTimeScale * this._timeScale;
                    if (0 >= this.points[0].duration - t)
                        return this._timeScale;
                    for (var i in this.points[0].duration -= t,
                    this.points[0].timeStart = n,
                    this.points[0].propsTo)
                        this.points[0].propsFrom[i] = this.target[i];
                ...
                onComplete: {
                    addOnce: function(e) {
                        return p._functions.onCompleteOnce.push(e),
                        p
                    },
                    add: function(e) {
                        return p._functions.onComplete.push(e),
                        p
                    }
                },
                onStart: {
                    addOnce: function(e) {
                        return p._functions.onStartOnce.push(e),
                        p
                    },
                    add: function(e) {
                        return p._functions.onStart.push(e),
                        p
                    }
                },
                onUpdateCallback: function(e) {
                    return p._functions.onUpdate.push(e),
                    p
                }
            };
            return e[s] = p
        ...
        var a = function(e, t, i, o, s) {
          ...
          , r = function() {
            if (this.isRunning || !this.points || 0 === this.points.length && 0 === this._bkp.points.length)
                return this;
            ...
            for (this.points[0].timeStart = n + this.points[0].startDelay,
            this._bkp = {
            ...
            this._complete = !1,
            t = 0; t < this._functions.onStartOnce.length; t++)
                this._functions.onStartOnce[t]();
            for (t = 0; t < this._functions.onStart.length; t++)
                this._functions.onStart[t]();
            return 0 < this._timeBonus && p(this, !0),
            this
        }
          , l = function() {
          ...
          , c = function() {
            return this.points && this.points[0] && (this.points[0].timeStart += n - this._pauseTime),
            this._paused = !1,
            this.isRunning = !0,
            this._pauseTime = 0,
            this
          ...
          , g = function() {
            ...
            if (nge.game.paused) {
                for (var i in t -= n,
                e)
                    e[i].points && e[i].points[0] && (e[i].points[0].timeStart += t);
                return !0
            }
            for (i in n = t,
            e)
                e[i]._complete ? delete e[i] : e[i]._started && !e[i]._paused && p(e[i]);
            return !0
        }
          , f = function() {
            return i++,
          ...
          , p = function(e, t) {
            ...
            for (i = 0; i < e._functions.onUpdate.length; i++)
                e._functions.onUpdate[i](e, t, o);
            if (1 === t)
                if (e.points.shift(),
                0 === e.points.length) {
                    e._complete = !0,
                    ...
                    for (t = e._functions.onCompleteOnce,
                    e._functions.onStartOnce = [],
                    e._functions.onCompleteOnce = [],
                    e.enableUpdate || (e._functions.onStart = [],
                    e._functions.onUpdate = [],
                    e._functions.onComplete = []),
                    i = 0; i < t.length; i++)
                        t[i]();
                    for (i = 0; i < s.length; i++)
                        s[i]()
                } else {
                    for (s in i = e.points[0].startDelay,
                    e.points[0].timeStart = n + i,
                    e.points[0].propsTo)
                        e.points[0].propsFrom[s] = e.target[s];
          ...
          , b = function(e, t, i) {
            0 < e._timeBonus && (t.timeStart -= e._timeBonus,
            e._timeBonus = 0);
            var s = n
              , a = (s - t.timeStart) * e.timeScale * o.globalTimeScale / t.duration;
            for (var r in 1 <= a && i && (a = .99),
            1 < a && (a = 1,
            e._timeBonus = ~~(s - t.timeStart - t.duration / (e.timeScale * o.globalTimeScale))),
            t.propsTo)
                e.target[r] = t.propsFrom[r] + (t.propsTo[r] - t.propsFrom[r]) * a;
            return a
        }
    }
}
    ...
    nge.Lib.Uploader = function() {
        this.beforeSubmit = function() {
            if (!(window.File && window.FileReader && window.FileList && window.Blob))
                return alert("Please upgrade your browser, because your current browser lacks some new features we need!"),
                !1;
            ...
            case "video/mp4":
                break;
            default:
                return $("#output").html("<b>" + t + "</b> Unsupported file type!"),
                !1
            }
            return 5242880 < e ? (alert("<b>" + e + "</b> Too big file! <br />File is too big, it should be less than 5 MB."),
            !1) : void 0
        }
        ,
...
, function(e, t) {
    nge.Lib.Validator = {
        ...
        floatMoney: function(e, t) {
            for (var n = parseFloat(e).toFixed(2), i = [], o = 0, s = n.length - 1; 0 <= s; s--)
                s === n.length - 3 ? i.push(",") : (s < n.length - 4 && (0 == ++o % 3 && i.push(".")),
                i.push(n[s]));
        ...
        moneyWithPeriod: function(e) {
            var t;
            return 0 === e.length && (t = "000"),
            1 === e.length && (t = "00" + e),
            2 === e.length && (t = "0" + e),
            2 < e.length && (t = e),
            t.substring(0, t.length - 2) + "." + t.substring(t.length - 2, t.length)
        }
    }
}
, function(e, t, n) {
...
, function(e, t) {
    nge.Tpl.Groups.SettingsContent = function() {
        var e = 0
          ...
          , n = function(n) {
            var i = !1;
            return (n = nge.localData.get(n + ".cfg")) && 1 < n.length && (i = !0),
            i && (e += 200,
            t++),
            {
                visibility: i,
...
, function(e, t) {
    nge.App.Run = function() {
        this.run = function() {
            ...
            nge.audioInterfacesManager = nge.App.getInstance("Mlm.AudioInterfacesManager.Controller"),
            nge.audioInterfacesManager.init(),
            ...
            return nge.game.scale.onFullScreenChange.add(s),
            $(window).resize(s),
            $(window).on("orientationchange", s),
            ...
            o(),
            n ? n.run() : nge.statesManager.display("load"),
            !0
        }
        ;
        var e = function() {
            ...
            nge.observer.add("StatesManager.create.end", (function(e) {
                "demo" !== e && "load" !== e && (document.addEventListener("touchend", n, !1),
                nge.observer.remove("StatesManager.create.end", !1, "enableNoSleep", !0))
            }
            ), !1, "enableNoSleep", !0)
        }
          , t = function() {
            ...
            e.init(),
            nge.rafSetTimeoutLib = e,
            nge.rafSetTimeout = e.add,
            nge.rafClearTimeout = e.clear,
            nge.App.getInstance = function(e, t, n) {
                return i({
                    path: e,
                    appOnly: t,
                    callback: function(t) {
                        if ("function" != typeof t && (log("ERROR TYPE !!!"),
                        log(e, t)),
                        t._instance && t._instance.singleton)
                            return t._instance;
                        var i = new t(n);
                        return i.singleton && (t._instance = i),
                        i
                    }
                })
            }
            ...
            nge.App.addSysInstancesMode = function(e) {
                ...
                nge.localData.set("_sysInstancesModes", t))
            }
            ,
          ...
          , i = function(e) {
            ...
            if (t in n)
                return !!n[t] && e.callback(n[t]);
            n[t] = !1;
            var i = e.path.split(".")
              , o = nge.Lib.Helper.capitaliseFirstLetter(nge.Cfg.Main.project)
              , s = nge.App.getSysInstancesModes()
              , a = [];
            return o = nge.Lib.Helper.mergeArrs(["nge", "App", o], i),
            a.push(o),
            e.appOnlyFlag || (i = nge.Lib.Helper.mergeArrs(["nge"], i),
            a.push(i)),
            s = nge.App.getSysInstancesModes(),
            nge.Lib.Checker.paths(a, (function(i) {
                return n[t] = i,
                e.callback(i)
            }
            ), s)
...
, function(e, t) {
    nge.App.RunAppBase = Class.extend((function() {
        ...
        this.runDefault = function() {
            ...
            if (t = nge.Cfg[t],
            e.statesReplacements && (t = nge.Lib.Helper.jsObjClone(e.statesReplacements)),
            e.statesExtentions)
                for (var n in e.statesExtentions)
                    t[n] = t[n] ? nge.Lib.Helper.mergeArrs(t[n], e.statesExtentions[n]) : e.statesExtentions[n];
            return nge.localData.set("states", t),
            "test" !== (n = nge.Lib.Helper.parseGetParams("mode") || nge.Cfg.Main.mode) && ("history" === n ? nge.statesManager.display("historyDataCollector") : nge.statesManager.display("load")),
