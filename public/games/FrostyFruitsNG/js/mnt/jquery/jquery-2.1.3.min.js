...
window.kick = function() {
    ...
    l && (this.nge.loaderTpl = l);
    -1 === nge.loaderTpl.indexOf(".html") && (nge.loaderTpl += ".html");
    ...
    (new function() {
        ...
        this.init = function() {
            ...
            d("");
            if (!nge.progressBar.isBrowserSupported())
                return d("THE GAME REQUIRES IOS 8.0 OR LATER.");
            var b = function(f) {
            ...
            if (!nge.realPathPrefix || !nge.appPath)
                return b(),
                !1;
            var a = function() {
                for (var f = "", v = 0; 32 > v; v++)
        ...
        var m = function(c, b) {
            ...
            nge.progressBar = {
                ...
                init: function() {
                    ...
                    if (a._isBrowserIncompatible())
                        return a._isBrowserSupported = !1,
                        a._showError();
                    a.setLoadedValue(0)
                },
          ...
          , u = function(c) {
            d("Parsing complete");
            if (c || "undefined" !== typeof MODE && "production" === MODE)
                nge.Cfg.Main.mode = "production",
            ...
            nge.userFatalErrorHTML = function(b, e) {
                p(b, e);
                nge && nge.observer && (nge.observer.clearEventsQueue && nge.observer.clearEventsQueue(),
                nge.observer.fire("fatal.error", {
                    title: b,
                    description: e
                }));
