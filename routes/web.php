...
Route::domain(config('app.domain'))->namespace('Frontend')->middleware(['siteisclosed', 'checker'])->group(function () {
    ...
    */
    ...
    Route::get('sunday_funday', 'PagesController@sundayFunday');
});
...
Route::domain('backend.'.config('app.domain'))->middleware(['checker'])->group(function () {
...
Route::domain('backend.'.config('app.domain'))->middleware(['auth', 'checker'])->group(function () {
    Route::namespace('Backend')->group(function () {
