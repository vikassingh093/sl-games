...
namespace VanguardLTE
{
    class Game extends \Illuminate\Database\Eloquent\Model
    {
        ...
        {
            $shop = \VanguardLTE\Shop::find($this->shop_id);
            $shop_id = 1;
            if($shop->is_demo == 1)
        ...
        public function set_gamebank($balance, $type = 'update', $slotState = '')
        {
            if( $this->gamebank != null || $slotState == 'bonus' ) 
            {
                ...
                if($shop->is_demo == 1)
                    $shop_id = $this->shop_id;
                Lib\Banker::update_bank($shop_id, $gamebank, $balance, $type); //for universal bank 
            }
        }
