...
namespace VanguardLTE\Games\President45
{
    ...
    class SlotSettings extends BasicSlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->Paytable['0'] = [0, 0, 0, 4, 15, 50];  //J
            $this->Paytable['1'] = [0, 0, 0, 4, 20, 50];  //Q
            $this->Paytable['2'] = [0, 0, 0, 5, 20, 60];  //K
            $this->Paytable['3'] = [0, 0, 0, 5, 25, 75];  //4th5
            $this->Paytable['4'] = [0, 0, 0, 10, 50, 150];  //Newspaper
            $this->Paytable['5'] = [0, 0, 0, 15, 55, 175]; //Plane
            $this->Paytable['6'] = [0, 0, 0, 20, 60, 220];  //Flag
            $this->Paytable['7'] = [0, 0, 0, 25, 70, 250];  //Female
            $this->Paytable['8'] = [0, 0, 0, 0, 0, 0]; //Wild            
            $this->Paytable['9'] = [0, 0, 0, 0, 0, 0]; //Trumph     
            $this->Paytable['10'] = [0, 0, 0, 0, 0, 0]; //Scatter
        ...
        public function GetReelStrips($winType, $lines, $slotEvent = 'bet')        
        {
            ...
            else 
            {
                ...
                {
                    $r = rand(0, 3);
                    $reels['reel'.($r+1)][rand(0,2)] = $xSymbol;
                    $reels['reel'.($r+2)][rand(0,2)] = $xSymbol;
                }                
