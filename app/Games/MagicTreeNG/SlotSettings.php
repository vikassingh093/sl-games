    ...
    class SlotSettings extends BasicSlotSettings
    {
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            else
            {
                ...
                {
                    $prs[$reelsId[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $reelsId[$i]}, $rbs);                    
                }
            }
            $reel = [
                'rp' => []
        ...
        {
            $result_tmp[0] = '{"action":"SpinResponse","result":"true","sesId":"10000373695","data":{"spinResult":{"type":"SpinResult","rows":[["11","9","7","6","11"],["9","8","11","9","3"],["8","3","4","5","9"]]},"state":"Ready"}}';
