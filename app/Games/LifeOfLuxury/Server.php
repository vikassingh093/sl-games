    ...
    class Server
    {
        ...
        function doSpin($slotSettings, $data, $postData)
        {
            ...
            if($freespinsWon > 0)
            {
                ...
                $response['ResultData']['viewarray']['getFreeTime']['nFreeTime'] = 10;
        ...
        function doFreeSpin($slotSettings, $data, $postData)
        {
            ...
            $slotSettings->SetGameData($slotSettings->slotId . 'FreeDiamond', $slotSettings->GetGameData($slotSettings->slotId . 'FreeDiamond') + $diamond);
            $slotSettings->SetGameData($slotSettings->slotId . 'FreeMultiplier', $slotSettings->GetGameData($slotSettings->slotId . 'FreeDiamond') + 2);
