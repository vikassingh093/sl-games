                ...
                switch( $reqId ) 
                {
                    ...
                    case 'AuthRequest':
                        ...
                        if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') ) 
                        {
                            ...
                            $restoreString = ',"restoredGameCode":"121","lastResponse":{"spinResult":{"type":"SpinResult","rows":[' . $rp2 . ']},"freeSpinsTotal":"' . $fTotal . '","freeSpinRemain":"' . $fRemain . '","totalBonusWin":"' . $fBonusWin . '","state":"FreeSpins","expandingSymbols":["1"]}';
                        }
                    ...
                    case 'GambleRequest':
                        ...
                        $statBet = $totalWin;
                        $isGambleWin = 0;
                        if($totalWin * 2 < $slotSettings->user->spin_bank && rand(0, 100) < 50)
                        {
                            $isGambleWin = 1;
                        }
                        ...
                        $slotSettings->SaveLogReport($response, $statBet, $gambleWin, 'slotGamble');
                        $gambleHistory = $slotSettings->GetGameData($slotSettings->slotId . 'GambleHistory');
