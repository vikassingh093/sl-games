            ...
            try
            {
                ...
                switch( $reqId ) 
                {
                    ...
                    case 'PickBonusItemRequest':
                        ...
                        $result_tmp[] = '{"action":"PickBonusItemResponse","result":"true","sesId":"10000496067","data":{"state":"FreeSpins","lastPick":"true","bonusItem":{"type":"BonusItem","index":"' . $item0 . '","value":"0","picked":"true"},"items":[{"type":"BonusItem","index":"' . $item0 . '","value":"0","picked":"true"}],"params":{"freeSpins":"' . $fs . '","multipliersType":"'.$multipliersType.'"}}}';
                        break;
                    ...
                    case 'AuthRequest':
                        ...
                        if($gameState === 'PickBonus')
                        {
                            ...
                            $restoreString = ',"restoredGameCode":"241","lastResponse":{"params":{"pickedItems":"5","freeSpinsSeries":"1"},"expandingSymbol":"-1","state":"PickBonus","lastPick":"false","totalBonusWin":"'.$fBonusWin.'","spinResult":{"type":"SpinResult","rows":['.$rp2.']}}';
                        }
                    ...
                    case 'SpinRequest':
                        ...
                        else
                        {
                            ...
                            $multipliers = $slotSettings->GetGameData($slotSettings->slotId . 'Mpl');
