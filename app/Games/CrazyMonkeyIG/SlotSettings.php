    ...
    class SlotSettings extends BasicSlotSettings
    {
        ...
        public function UpdateJackpots($bet)
        {
...

            {
                ...
                if( $this->jpgs[$i]->balance < $this->jpgs[$i]->get_start_balance() ) 
                {
        ...
        public function SaveLogReports($spinSymbols, $bet, $lines, $win, $slotState)
        {
        ...
        public function GetSpinSettings($bet, $lines)
        {
            ...
            return $this->SpinSettings($garantType, $bet);
            /*$curField = 10;
            switch( $lines ) 
            {
                case 10:
