<?php 
namespace VanguardLTE\Games\FishHunterKingKongPGD
{
                ...
                }else if (\str_contains($request->getRequestUri(),"command3=game"))
                {
                    ...
                    switch($arkJson->cmd_id)
                    {
                        case "kiosk":
                            ...
                            {
                                case "KioskUrl":
                                    $output = "eyJjbWRfc24iOiIxNjQ3MjQ5NjY0MDAwIiwiY21kX2RhdGEiOnsic3RhdHVzIjowLCJ1cmwiOiIxNS4yMjMuMTMzLjIxOTo2MTEyIiwic3VybCI6ImZpc2gwMDguZ29sZGVuZHJhZ29uY2l0eS5jb206NTExMiJ9fQ==";
                                    break;
                            }
                            break;
                    }
