...
namespace VanguardLTE\Games\HitInVegasNG
{
    ...
    class SlotSettings extends BasicSlotSettings
    {
        ...
        public function GetRandomScatterPos($rp, $scatter)
        {
            $rpResult = [];            
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            else
            {
                ...
                foreach($arrReels as $index => $reelStrip ) 
                {
                    if( is_array($this->$reelStrip) && count($this->$reelStrip) > 0 ) 
                    {
                        $prs[$index + 1] = $this->GetRandomScatterPos($this->$reelStrip, $scatter);
                        $reelsId[] = $index + 1;
                    }
                }
                ...
                for( $i = 0; $i < 5; $i++ ) 
                {
                    $prs[$reelsId[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $reelsId[$i]}, $scatter);
                }
            }
            $reel = [
                'rp' => []
        ...
        public function GetPaylines()
        {
            ...
            $linesId[11] = [1, 2, 2, 2, 3];
            $linesId[12] = [3, 2, 2, 2, 1];
            $linesId[13] = [2, 2, 1, 2, 3];
            $linesId[14] = [2, 2, 3, 2, 1];
            $linesId[15] = [1, 2, 1, 2, 1];
            $linesId[16] = [3, 2, 3, 2, 3];
            $linesId[17] = [1, 1, 3, 1, 1];
            $linesId[18] = [3, 3, 1, 3, 3];
            $linesId[19] = [2, 1, 3, 1, 2];
            $linesId[20] = [2, 3, 1, 3, 2];
            $linesId[21] = [1, 3, 1, 3, 1];
            $linesId[22] = [3, 1, 3, 1, 3];
            $linesId[23] = [1, 3, 3, 3, 1];
            $linesId[24] = [3, 1, 1, 1, 3];
            $linesId[25] = [1, 3, 2, 3, 1];
            $linesId[26] = [3, 1, 2, 1, 3];
            $linesId[27] = [2, 2, 3, 2, 2];
            $linesId[28] = [2, 2, 1, 2, 2];
            $linesId[29] = [1, 3, 1, 2, 2];
            $linesId[30] = [3, 1, 3, 2, 2];
            $linesId[31] = [1, 1, 1, 2, 3];
            $linesId[32] = [3, 3, 3, 2, 1];
            $linesId[33] = [1, 2, 3, 3, 3];
            $linesId[34] = [3, 2, 1, 1, 1];
            $linesId[35] = [2, 1, 1, 2, 3];
            $linesId[36] = [2, 3, 3, 2, 1];
            $linesId[37] = [1, 1, 2, 1, 1];
            $linesId[38] = [3, 3, 2, 3, 3];
            $linesId[39] = [2, 1, 2, 3, 2];
            return $linesId;
        }
