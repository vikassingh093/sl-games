                    ...
                    case "spin":
                        ...
                        for($i = 0; $i <= 2000 ; $i++)
                        {
                            ...
                            }else if ($gameType == "freespin") 
                            {
                                ...
                                {
                                    $freeSpinTotalTimes += 2;
                                    $freeSpinAddTimes = 2;
                                }else if ($fsCnt >= 1)
                                {
                                    $freeSpinTotalTimes += 1;
                                    $freeSpinAddTimes = 1;
                                }
                            }
                            ...
                            if ($gameType == "normal" || $gameType == "freespin")   
                            {
                                ...
                                if ($gameType == "freespin" || $i > 1900 || ($i >= 1000 && $totalWin == 0) || $freeSpinAddTimes > 0 || ($totalWin <= $winTypeTmp[1] && $totalWin > 0.7 * $winTypeTmp[1]) || ( $winTypeTmp[1] == 0 && $totalWin == 0))
                                {
