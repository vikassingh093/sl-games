...
namespace VanguardLTE\Games\WildBuffaloNG
{
    ...
    class SlotSettings extends BasicSlotSettings
    {
        ...
        public function GetSpinSettings($garantType = 'bet', $bet, $lines)
        {
            ...
            //     }
            // }
            // else if( $spinWin <= $currentSpinWinChance / 100  ) 
            // {
            //     $winLimit = $this->GetBank($garantType);
            //     $return = [
            //         'win', 
        ...
        {
            $result_tmp[0] = '{"action":"SpinResponse","result":"true","sesId":"10000373695","data":{"spinResult":{"type":"SpinResult","rows":[["1","7","11","4","7"],["7","3","11","4","7"],["7","6","11","4","12"],["2","6","3","7","8"]]},"slotWin":{"totalWin":"0","lineWinAmounts":[],"canGamble":"false"},"state":"Ready"}}';
