                        ...
                        switch( $reqId ) 
                        {
                            ...
                            case 'AuthRequest':                                
                                ...
                                else
                                {
                                    ...
                                    $slotSettings->SetGameData($slotSettings->slotId . 'BetLine', 1);
                                ...
                                if($defaultBet == 0)
                                    $defaultBet = 1;
                                if($gameState === 'BigWheel')
                                {
                                    $fBonusWin = $slotSettings->GetGameData($slotSettings->slotId . 'BonusWin');
                                    $restoreString = ',"restoredGameCode":"190","lastResponse":{"params":{"pickedItems":"16","freeSpinsSeries":"1"},"expandingSymbol":"-1","state":"BigWheel","lastPick":"false","totalBonusWin":"'.$fBonusWin.'","spinResult":{"type":"SpinResult","rows":['.$rp2.']}}';
                                }
