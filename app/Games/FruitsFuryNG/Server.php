...
set_time_limit(5);
    class Server
    {
        public function get($request, $game)
        {
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        $debug = true;
			$userId = \Auth::id();
			#file_get_contents(storage_path('logs/') . $this->slotId . 'Internal.log');
			
			#file_get_contents(storage_path('logs/') . 'GameInternal.log', $userId); #vvvvvvvvvv
			#file_put_contents(storage_path('logs/') . 'GameInternal.log', "vvvvvvvvvvvvvvvvvvvvvvvvvv");
		        #exit();
                        if( $userId == null ) 
                        {
			...
			#file_get_contents(storage_path('logs/') . $game . 'Internal.log');
                        #file_get_contents(storage_path('logs/') . 'GameInternal.log', "vvvvvvvvvvvvvvvvvvvvvvvvvvkkkkkkkkk");
