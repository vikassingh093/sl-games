...
namespace VanguardLTE\Games\SquidSlotNG
{
    ...
    class SlotSettings extends BasicSlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->Paytable['SYM_0'] = [0, 0, 0, 750, 0, 0]; 
            $this->Paytable['SYM_1'] = [0, 0, 0, 200, 0, 0]; 
            $this->Paytable['SYM_2'] = [ 0, 0, 0, 60, 0, 0];
            $this->Paytable['SYM_3'] = [0, 0, 0, 40, 0, 0];
            $this->Paytable['SYM_4'] = [0, 0, 0, 40, 0, 0];
            $this->Paytable['SYM_5'] = [0, 0, 0, 40, 0, 0];
            $this->Paytable['SYM_6'] = [0, 0, 0, 40, 0, 0];
            $this->Paytable['SYM_7'] = [0, 0, 0, 5, 0, 0];
            $this->Paytable['SYM_9'] = [0, 0, 0, 0, 0, 0];
            ...
            $this->SymbolGame = [0,1,2,3,4,5,6,7,9];
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            {                
                if($winType == 'win')
                {
                    if( $slotEvent == 'holdnlink' )
                    {
                        for($r = 0; $r < 3; $r++)
                            for($c = 0; $c < 3; $c++)
                                $reels['reel'.($r+1)][$c] = rand(0, 7);
                        $cnt = rand(1,2);
                        for($i = 0; $i < $cnt; $i++)
                        {
                            if(rand(0, 100) < 50)
                    ...
                    else
                    {
                        ...
                        if(rand(0, 100) < 30)
                        {
                            $reels['reel1'] = [$sym, $sym, $sym];
                            $reels['reel2'] = [$sym, $sym, $sym];
                            $reels['reel3'] = [$sym, $sym, $sym];
                        }
                        else
                        {
                            $paylines = $this->GetPaylines();
                            $activeLine = $paylines[rand(0, 4)];                    
        
                            for($r = 0; $r < 3; $r++)
                            {
                                $reels['reel'.($r+1)][$activeLine[$r]] = $sym;
                            }
                            for($r = 0; $r < 3; $r++)
                                for($c = 0; $c < 3; $c++)
        ...
        {
            $linesId = [[0,0,0],[1,1,1],[2,2,2],[0,1,2],[2,1,0]];
            return $linesId;
        }
