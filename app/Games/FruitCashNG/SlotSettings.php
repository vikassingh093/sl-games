    ...
    class SlotSettings extends BasicSlotSettings
    {
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            foreach( $prs as $index => $value ) 
            {
                ...
                //check 1 value for holdnLink
                if($reel['reel' . $index][0] == '1')
                    $reel['reel' . $index][0] = strval(rand(101, 105));
                if($reel['reel' . $index][1] == '1')
                    $reel['reel' . $index][1] = strval(rand(101, 105));
                if($reel['reel' . $index][2] == '1')
                    $reel['reel' . $index][2] = strval(rand(101, 105));
        ...
        {
            $bets = ["4","5","10","20","30","40","50","100","150"];            
            return $bets;
        }        
    }
