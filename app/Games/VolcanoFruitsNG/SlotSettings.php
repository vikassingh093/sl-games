...
namespace VanguardLTE\Games\VolcanoFruitsNG
{
    ...
    class SlotSettings extends BasicSlotSettings
    {
        ...
        public function GetPayLines()
        {
            ...
            $linesId[8] = [1,1,1,1,2];
            $linesId[9] = [2,2,2,2,1];
            $linesId[10] = [3,3,3,3,4];
            $linesId[11] = [4,4,4,4,3];
            $linesId[12] = [1,2,2,2,2];
            $linesId[13] = [2,2,2,2,3];
            $linesId[14] = [3,3,3,3,2];
            $linesId[15] = [4,3,3,3,3];
            $linesId[16] = [2,1,1,1,1];
            $linesId[17] = [2,3,3,3,3];
            $linesId[18] = [3,2,2,2,2];
            $linesId[19] = [3,4,4,4,4];
            $linesId[20] = [1,1,1,2,3];
            $linesId[21] = [2,2,2,3,4];
            $linesId[22] = [3,3,3,2,1];
            $linesId[23] = [4,4,4,3,2];
            $linesId[24] = [1,2,3,3,3];
            $linesId[25] = [2,3,4,4,4];
            $linesId[26] = [3,2,1,1,1];
            $linesId[27] = [4,3,2,2,2];
            $linesId[28] = [1,1,2,1,1];
            $linesId[29] = [2,2,1,2,2];
            $linesId[30] = [3,3,4,3,3];
            $linesId[31] = [4,4,3,4,4];
            $linesId[32] = [1,2,2,2,1];
            $linesId[33] = [2,2,3,2,2];
            $linesId[34] = [3,3,2,3,3];
            $linesId[35] = [4,3,3,3,4];
            $linesId[36] = [2,1,1,1,2];
            $linesId[37] = [2,3,3,3,2];
            $linesId[38] = [3,2,2,2,3];
            $linesId[39] = [3,4,4,4,3];
            $linesId[40] = [2,1,2,1,2];
            $linesId[41] = [3,2,3,2,3];
            $linesId[42] = [4,3,4,3,4];
            $linesId[43] = [1,2,1,2,1];
            $linesId[44] = [2,3,2,3,2];
            $linesId[45] = [3,4,3,4,3];
            $linesId[46] = [2,1,2,3,2];
            $linesId[47] = [3,2,3,4,3];
            $linesId[48] = [2,3,2,1,2];
            $linesId[49] = [3,4,3,2,3];
            return $linesId;
        }
                ...
                {                    
                    for( $j = 0; $j < count($this->SymbolGame); $j++ ) 
                    {
                        ...
                        else
                        {
                            ...
                            {
                                $tmpWin = $this->Paytable['SYM_' . $csym][1];                                
                            }
                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                            {
                                $tmpWin = $this->Paytable['SYM_' . $csym][2];
                            }
