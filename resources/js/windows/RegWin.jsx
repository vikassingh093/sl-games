		...
		return (
			<div className="modal-window-reg">
				<div className="modal-window-reg__scale-cont">
					...
					<img className="modal-window-reg__close game-button" onClick={this.onClose} src="/images/screens/elements/buttons/close.png" alt=""/>
					<img className="modal-window-reg__get game-button" onClick={this.onRegistration} src="/images/screens/elements/buttons/bget.png" alt=""/>
					<img className="modal-window-reg__back" src="/images/screens/reg_back.png" alt=""/>
				</div>
			</div>
		)
	}
