		...
		return (
			<div className="modal-window-rules">
				<div className="modal-window-rules__scale-cont">
					...
					<img className="modal-window-rules__close game-button" onClick={this.onClose} src="/images/screens/elements/buttons/close.png" alt=""/>

					<img className="modal-window-rules__back" src="/images/screens/rules_back.png" alt=""/>
				</div>
			</div>
		)
	}
