		...
		return (
			<div className="modal-window-bonus">
				<div className="modal-window-bonus__scale-cont">
					...
					<img className="modal-window-bonus__back" src="/images/screens/bonus_back.png" alt=""/>
				</div>
			</div>
		)
	}
			...
			<div id={`bonus__card${this.props.card}`} className="bonus__card-wrapper" onClick={()=>{
				...
				<div className="bonus__card-body" id={`bonus__card${this.props.card}-body-cont`}>
					<div className="bonus-card-face bonus-card-front">
						<img id={`bonus__card${this.props.card}-pic`} className="bonus__card" src={`/images/screens/elements/bonus/card${this.props.card}.png`} alt=""/>
					</div>
					<div className="bonus-card-face bonus-card-back">
						...
						<img id={`bonus__card${this.props.card}-win`} className="bonus__card" src="/images/screens/elements/bonus/bonus_card.png" alt=""/>
						<img id={`bonus__card${this.props.card}-lose`} className="bonus__card" src="/images/screens/elements/bonus/empy_card.png" alt=""/>
					</div>
				</div>
			</div>
		)
