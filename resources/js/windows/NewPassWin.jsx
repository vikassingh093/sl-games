			...
			<div className="modal-window-npass">
				<div className="modal-window-npass__scale-cont">
					...
					<div className="modal-window-npass__error">
						...
						<img  src="/images/screens/elements/passerr.png" alt=""/>
					</div>
					<img className="modal-window-npass__close game-button" onClick={this.onClose} src="/images/screens/elements/buttons/close.png" alt=""/>
					<img className="modal-window-npass__ok game-button" onClick={this.onChange} src="/images/screens/elements/buttons/changepass.png" alt=""/>
					<img className="modal-window-npass__back" src="/images/screens/newpass_back.png" alt=""/>
				</div>
			</div>
		)
	}
