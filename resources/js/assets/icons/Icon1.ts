...
export class Icon1 extends PIXI.Sprite{
	...
	constructor(data:any) {
		...
		this.cont.addChild(new PIXI.Graphics()).beginFill(0x2A0D47, 1)
			.moveTo(7,56).lineTo(19,46).lineTo(345,46).lineTo(359,61)
			.lineTo(359,667).lineTo(345,676).lineTo(16,676).lineTo(7,662)
			.lineTo(7,56).endFill();
		//
		this.piccont = this.cont.addChild(new PIXI.Sprite());
		this.piccont.mask =
			this.cont.addChild(new PIXI.Graphics()).beginFill(0x0000ff, 1).moveTo(7,56).lineTo(19,46).lineTo(345,46).lineTo(359,61)
				.lineTo(359,667).lineTo(345,676).lineTo(16,676).lineTo(7,662)
				.lineTo(7,56).endFill();
		...
		//
		const json0 = PIXI.Loader.shared.resources["/images/anim/icon1b.json"].spritesheet;
		const array0:any = [];
		if(json0) {
