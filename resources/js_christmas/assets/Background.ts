...
export class Background extends PIXI.Sprite{
	...
	constructor() {
		...
		//head background
		this.back1 = this.cont.addChild(new PIXI.Sprite(PIXI.Texture.from("/images_christmas/back.jpg")));
		//extra background for wide screen
		this.back2 = this.cont.addChild(new PIXI.Sprite(PIXI.Texture.from("/images_christmas/back2.png")));
