...
export class GameButton extends PIXI.Sprite{
	...
	constructor(idd:number) {
		...
		this.state1 = this.pic.addChild(new PIXI.Sprite(PIXI.Texture.from(`/images_christmas/screens/elements/buttons/g${idd}btn1.png`)));
		this.state2 = this.pic.addChild(new PIXI.Sprite(PIXI.Texture.from(`/images_christmas/screens/elements/buttons/g${idd}btn2.png`)));
