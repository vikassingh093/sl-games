		...
		return (
			<div className="error-window-cont" style={this.state.SHOW?this.showStyle:this.hideStyle}>
				<div className="error-window-elem">
					...
					<img className="error-window__close game-button" onClick={this.onClose} src="/images_christmas/screens/elements/buttons/close.png" alt=""/>
					<img className="error-window__back" src="/images_christmas/screens/popup_bg.png" alt=""/>
				</div>
			</div>
		)
	}
