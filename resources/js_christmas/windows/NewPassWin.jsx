...
const errorPassLength = "Input password must be 5-10 chars";
			...
			<div className="modal-window-npass">
				<div className="modal-window-npass__scale-cont">
					...
					<div className="modal-window-npass__error">
						...
						<img  src="/images_christmas/screens/elements/passerr.png" alt=""/>
					</div>
					<img className="modal-window-npass__close game-button" onClick={this.onClose} src="/images_christmas/screens/elements/buttons/close.png" alt=""/>
					<img className="modal-window-npass__ok game-button" onClick={this.onChange} src="/images_christmas/screens/elements/buttons/changepass.png" alt=""/>
					<img className="modal-window-npass__back" src="/images_christmas/screens/newpass_back.png" alt=""/>
				</div>
			</div>
		)
	}
