		...
		return (
			<div className="modal-window-lucky">
				<div className="modal-window-lucky__scale-cont">
					<img className="modal-window-lucky__ok game-button" onClick={this.onAccept} src="/images_christmas/screens/elements/buttons/lucky_ok.png" alt=""/>
					<img className="modal-window-lucky__close game-button" onClick={this.onDecline} src="/images_christmas/screens/elements/buttons/lucky_close.png" alt=""/>

					<img className="modal-window-lucky__back" src="/images_christmas/screens/lucky_back.png" alt=""/>
				</div>
			</div>
		)
	}
