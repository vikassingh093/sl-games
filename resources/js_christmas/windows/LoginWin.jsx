		...
		return (
			<div className="modal-window-login">
				<div className="modal-window-login__logo">
					<img src="/images_christmas/screens/logo.png" alt=""/>
				</div>
				<div className="modal-window-login__down">
					<div className="modal-window-login__scale-cont">
						...
						<img className="modal-window-login__check" onClick={this.checkRem} src="/images_christmas/screens/check.png" alt=""/>
						<img className="modal-window-login__login game-button" onClick={this.goLogin} src="/images_christmas/screens/log_btn.png" alt=""/>
						<img className="modal-window-login__back" src="/images_christmas/screens/login.png" alt=""/>
					</div>
				</div>
			</div>
		)
