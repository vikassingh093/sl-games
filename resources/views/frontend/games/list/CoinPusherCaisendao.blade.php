...
@section('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var url;
            url = '/games/CoinPusherCaisendao/index.html?access_token=(*--)dd12f3635bc9599ca58012601d07197c&lang=eng&ccy=NON&sm=00&subid=0&fullscr=1&lc=en-US&pm=1&ns=0&anal=10&lb=1&stf=1';
