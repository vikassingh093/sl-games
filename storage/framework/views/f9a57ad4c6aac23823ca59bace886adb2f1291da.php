...
<?php $__env->startSection('scripts'); ?>
    <script type="text/javascript">        
        ...
        $(document).ready(function() {
            ...
            var url;
            if(isMobile)
                url = '/games/MagicTreeNG/index.html';
            else
                url = '/games/MagicTreeNG/index.html';
            url += qstr;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.games.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/RiverDragon/resources/views/frontend/games/list/MagicTreeNG.blade.php ENDPATH**/ ?>