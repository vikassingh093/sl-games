...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
        <?php if( Auth::user()->hasRole('agent') || Auth::user()->hasRole('admin') ): ?>
        <div id="main-content" class="for-print">
            <form class="form-horizontal" id="yw0" action="<?php echo e(route('backend.user.create')); ?>" method="post">
                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="controls">
                                        <select class="input-xxlarge" name="Users[rtp]" id="Users_rtp">
                                            <?php if(Auth::user()->hasRole('admin')): ?>
                                                <option value="70" <?php echo e(auth()->user()->percent == 70 ? 'selected' : ''); ?>>70</option>
                                                <option value="80" <?php echo e(auth()->user()->percent == 80 ? 'selected' : ''); ?>>80</option>
                                                <option value="87" <?php echo e(auth()->user()->percent == 87 ? 'selected' : ''); ?>>87</option>
                                                <option value="90" <?php echo e(auth()->user()->percent == 90 ? 'selected' : ''); ?>>90</option>
                                                <option value="95" <?php echo e(auth()->user()->percent == 95 ? 'selected' : ''); ?>>95</option>
                                            <?php else: ?>
                                                <option value="<?php echo e(auth()->user()->percent); ?>" selected><?php echo e(auth()->user()->percent); ?></option>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/RiverDragon/resources/views/backend/user/add.blade.php ENDPATH**/ ?>