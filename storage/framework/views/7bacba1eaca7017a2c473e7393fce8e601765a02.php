	...
	<section class="content">		
        <div id="main-content" class="for-print">            
            ...
            <div id="modal-usersetting" class="modal hide fade">
                <form class="form-horizontal" id="yw1" action="<?php echo e(route('backend.user.updateprofile')); ?>" method="post">
                    <input id="modal-profile-user-id" name="user-id" type="hidden" value="<?php echo e($user->id); ?>">
                    <?php echo csrf_field(); ?>
            ...
            <div id="modal-deposite" class="modal hide fade">
                <form class="form-horizontal" id="yw1" action="<?php echo e(route('backend.user.balance.update')); ?>" method="post"><input id="modal-deposite-id" name="DepositeForm[id]" type="hidden" value="<?php echo e($user->id); ?>"><input name="DepositeForm[type]" id="DepositeForm_type" type="hidden" value="add">
                    <?php echo csrf_field(); ?>
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            ...
            <div id="modal-withdrawal" class="modal hide fade">
                <form class="form-horizontal" id="yw2" action="<?php echo e(route('backend.user.balance.update')); ?>" method="post"><input id="modal-withdrawal-id" name="DepositeForm[id]" type="hidden" value="<?php echo e($user->id); ?>"><input name="DepositeForm[type]" id="DepositeForm_type" type="hidden" value="out">
                    <?php echo csrf_field(); ?>
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            ...
            <div class="row">
                <form action="/user/player_create" method="get" class="form-search pull-right">
                    ...
                    <div class="input-append">
                        <input id="search_value" class="input-large search-query" name="search" type="text" placeholder="Account # or Username" value="<?php echo e($search); ?>">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/RiverDragon/resources/views/backend/user/add_player.blade.php ENDPATH**/ ?>