...
<?php $__env->startSection('scripts'); ?>
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            url = '/games/FireFly1x2/index.html';
            $('#mainframe').attr('src', url);
        });
    </script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.games.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/RiverDragon/resources/views/frontend/games/list/FireFly1x2.blade.php ENDPATH**/ ?>