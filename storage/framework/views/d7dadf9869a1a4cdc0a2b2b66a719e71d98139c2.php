...
<head lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="/frontend/Default/css/main.css?v=<?php echo e(time()); ?>" />
...
<body style="margin:0px; background-color:black">
    ...
    <div class="home-btn" style="display: <?php echo e($game->category_temp == 2 ? 'none' : 'block'); ?>"></div>
...
<?php /**PATH /var/www/RiverDragon/resources/views/frontend/games/layouts/app.blade.php ENDPATH**/ ?>