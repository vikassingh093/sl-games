...
<?php $__env->startSection('scripts'); ?>
	<script>
        ...
        function addNews()
        {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo route("backend.post.addnotification"); ?>',
                cache: false,
                contentType: false,
                processData: false,
                headers: {
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/RiverDragon/resources/views/backend/post/notification.blade.php ENDPATH**/ ?>