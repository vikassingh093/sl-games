...
<section class="content">
    <div id="main-content" class="for-print">
        <form class="form-horizontal form-vertical" id="yw0" action="<?php echo e(route('backend.user.daily_report')); ?>" method="get">
            <?php echo csrf_field(); ?>
            ...
            <table class="table table-striped table-hover">
                <tbody>
                    ...
                    <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo $__env->make('backend.user.partials.row_daily_report', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php if(count($total) > 0): ?>
                    <td>Total : <?php echo e($total[0]->bet); ?></td>
                    <td>Total : <?php echo e($total[0]->win); ?></td>
                    <td>Total : <?php echo e($total[0]->bet - $total[0]->win); ?></td>
                    <td>Total : <?php echo e($total[0]->bet == 0 ? '0.00' : number_format($total[0]->win / $total[0]->bet * 100, 2)); ?></td>
                    <?php endif; ?>
                </tbody>
            </table>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/RiverDragon/resources/views/backend/user/report_daily.blade.php ENDPATH**/ ?>